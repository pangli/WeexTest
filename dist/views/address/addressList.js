...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/address/addressList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3af6e230"
...
exports.default = {
  ...
  created: function created() {
    ...
    _BroadcastChannel2.default.addressGet(function (event) {
      _this.getMbAddressByRelationId();
    });
    this.getMbAddressByRelationId();
  },
  data: function data() {
    return {
      lists: []
  ...
  methods: {
    ...
    getMbAddressByRelationId: function getMbAddressByRelationId() {
      var _this2 = this;

      _api2.default.getMbAddressByRelationId({
        "memberCode": weexParams.memberCode
      }, function (res) {
        if (res.res.code === 10000) {
          _this2.lists = res.body.list;
        }
      });
    },
    goAddAddress: function goAddAddress(address) {
      if (this.lists.length === 0) {
        var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/address/addAddress.js?address=new');
      } else if (address === ' ') {
        var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/address/addAddress.js');
      } else {
        var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/address/addAddress.js?address=' + encodeURI(JSON.stringify(address)));
      }
    ...
    activeAddress: function activeAddress(address) {
      if (_global2.default.getParams(weex.config.bundleUrl).buying == 'true') {
        _BroadcastChannel2.default.shoppingSend(address);
        this.goBack();
      }
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), (_vm.lists.length === 0) ? _c('myDefault', {
    attrs: {
      "text": "还没有收货地址"
    },
    on: {
    ...
    }, [_vm._v(_vm._s(list.sendeeName))]), _c('text', {
      staticClass: ["phone"]
    }, [_vm._v(_vm._s(list.sendeeTel))]), (list.status == '0') ? _c('text', {
      staticClass: ["pretermission"]
    }, [_vm._v("默认")]) : _vm._e()]), _c('text', {
      staticClass: ["address"]
    }, [_vm._v(_vm._s(list.sendeeAddress))])]), _c('image', {
      staticClass: ["edit"],
      attrs: {
