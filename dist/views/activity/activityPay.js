...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/activity/activityPay.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0c274e98"
...
exports.default = {
  ...
  methods: {
    ...
    changeChoosePay: function changeChoosePay(param) {
      if (param == '微信') {
        this.choosePay = '0';
      } else if (param == '支付宝') {
        this.choosePay = '1';
    ...
    getParams: function getParams() {
      ...
      this.getUnpaidOrderInfoByOrderId();
    },
    getUnpaidOrderInfoByOrderId: function getUnpaidOrderInfoByOrderId() {
      var _this2 = this;

      toast.showLoadingMessage("获取订单信息中...");
      this.result = '789';
      var param = _global2.default.getParams(weex.config.bundleUrl);
      var params = {
      ...
      _api2.default.getUnpaidOrderInfoByOrderId(params, function (ret) {
        toast.close();
        _this2.result = ret;

        if (!ret.res) {
          // modal.toast({message: '服务异常',duration: 1});
          toast.showErrorMessage('服务异常');
          return;
        }
        if (ret.res.code == '10000' && ret.body) {
          var date = _global2.default.formatTime(ret.body.orderInfo.lastPayTime - Date.parse(new Date()), '', 's');
          _this2.leftTimer(date);
          if (ret.body.orderInfo && ret.body.activeReg) {
            _this2.orderInfo = ret.body.orderInfo;
            _this2.activeReg = ret.body.activeReg;
          } else {
            // modal.toast({message: '暂无数据',duration: 1});
            toast.showErrorMessage('暂无数据');
          }
        } else {
          // modal.toast({message: ret.res.msg,duration: 1});
    ...
    getActivePayOrder: function getActivePayOrder() {
      ...
      _api2.default.getActivePayOrder(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          toast.close();
          _this3.payResult = ret;

          if (_this3.choosePay === '0') {
            pay.wxPay(ret.body, function (result) {
              _this3.final = result;
              if (result.status == 1) {
                _this3.getOrderStatusByOrderNo();
              } else {
                toast.showMessage(result.message);
              }
            });
          } else if (_this3.choosePay === '1') {
      ...
      _api2.default.getOrderStatusByOrderNo(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.status == 2) {
            var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/activity/activityResult.js' + '?actId=' + _this4.actId + '&orderId=' + _this4.orderId + '&listgo=3');
            navigator.push({
              url: url,
              animated: 'true'
            });
    ...
    leftTimer: function leftTimer(leftTime) {
      var _this5 = this;
      ...
      if (myTime >= 0) {
        //days + "天" + hours + "小时" +
        this.expiryTime = minutes + "分" + seconds + "秒";
        myTime = myTime - 1;
        var timeout = setTimeout(function () {
          _this5.leftTimer(myTime);
        }, 1000);
      }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
    staticClass: ["card_title"]
  }, [_vm._v(_vm._s(_vm.orderInfo.actTitle))]), _c('text', {
    staticClass: ["card_address"]
  }, [_vm._v(_vm._s(_vm.orderInfo.actAddress))]), _c('div', {
    staticClass: ["card_price_box"]
  }, [_c('text', {
    staticClass: ["card_price"]
  }, [_vm._v("￥" + _vm._s(_vm.orderInfo.payAmount))])]), (_vm.status !== "2") ? _c('div', {
    staticClass: ["card_time_box"]
  }, [_c('text', {
    staticClass: ["pay_time"]
  }, [_vm._v(_vm._s(_vm._f("toTime")(_vm.orderInfo.actBegTime)) + "—" + _vm._s(_vm._f("toTime")(_vm.orderInfo.actEndTime)))])]) : _vm._e()])]), (_vm.activeReg.length == 0) ? _c('div', [_c('div', {
    staticClass: ["customer_box"]
  }, [_c('div', {
    staticClass: ["customer_box_list"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("姓名")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.orderInfo.userName))])]), _c('div', {
    staticClass: ["customer_box_list"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("手机号码")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.orderInfo.phone))])])])]) : _vm._e(), (_vm.activeReg.length > 0) ? _c('div', [_c('div', {
    staticClass: ["customer_box"]
  }, _vm._l((_vm.activeReg), function(item) {
    return _c('div', {
      staticClass: ["customer_box_list"]
    }, [_c('text', {
      staticClass: ["list_key"]
    }, [_vm._v(_vm._s(item.regDicName))]), _c('text', {
      staticClass: ["list_val"]
    }, [_vm._v(_vm._s(item.regDicValue))])])
  ...
  }, [_vm._v("￥" + _vm._s(_vm.orderInfo.payAmount))])]), _c('div', {
    staticClass: ["apply_box"]
  }, [(_vm.expiryTime !== '00分00秒' && _vm.status !== '2') ? _c('text', {
    staticClass: ["apply_title"],
    on: {
      "click": _vm.confirmPay
    }
  }, [_vm._v("确定支付")]) : _vm._e(), (_vm.expiryTime === '00分00秒' && _vm.status !== '2') ? _c('text', {
    staticClass: ["apply_title"]
  }, [_vm._v("已过期")]) : _vm._e(), (_vm.status === '2') ? _c('text', {
    staticClass: ["apply_title"]
  }, [_vm._v("已支付")]) : _vm._e()])])], 1)
},staticRenderFns: []}
