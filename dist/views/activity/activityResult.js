...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/activity/activityResult.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-91957446"
...
exports.default = {
  ...
  filters: {
    toTime: function toTime(value) {
      return value ? _global2.default.formatTime(value) : '';
    }
  },
  ...
  methods: {
    ...
    goToDetail: function goToDetail() {
      // var url = configObj.getUrl(weex.config.bundleUrl, 'views/activity/activityDetail.js' + '?actId=' + this.activeId);
      // navigator.push({
      //   url: url,
      //   animated: 'true'
      // });
    ...
    getParams: function getParams() {
      var param = _global2.default.getParams(weex.config.bundleUrl);
      this.activeId = param.actId;
      this.orderId = param.orderId;
      this.getRegisteredActiveDetailById();
      this.getActiveDetailById();
    },
    getRegisteredActiveDetailById: function getRegisteredActiveDetailById() {
      var _this2 = this;
      ...
      _api2.default.getRegisteredActiveDetailById(params, function (ret) {
        if (!ret.res) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.orderInfo) {
            _this2.orderInfo = ret.body.orderInfo;
            _this2.refund = ret.body.isRefund;
            _this2.getQRCode();
          } else {
    ...
    getOrderRefundRequest: function getOrderRefundRequest() {
      var _this3 = this;

      _api2.default.getOrderRefundRequest({
      ...
      _api2.default.getActiveDetailById(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.activeInfo) {
            _this5.activeRules = ret.body.activeRules;
          } else {
            // modal.toast({message: '暂无数据',duration: 1});
            toast.showErrorMessage('暂无数据');
          }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.orderInfo.refundTime) ? _c('div', {
    staticClass: ["tkjd"]
  }, [_vm._m(0), _c('div', {
    staticClass: ["jindu"]
  }, [_vm._m(1), _c('div', {
    ...
    staticClass: ["status"]
  }, [_vm._v("退款申请已提交")]), _c('text', {
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm._f("toTime")(_vm.orderInfo.refundTime)))])])]), (_vm.orderInfo.refundUpdTime) ? _c('div', {
    staticClass: ["jindu"]
  }, [_vm._m(2), _c('div', {
    staticClass: ["jinduright"]
  }, [_c('text', {
    staticClass: ["status"]
  }, [_vm._v("退款处理中")]), _c('text', {
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm._f("toTime")(_vm.orderInfo.refundUpdTime)))])])]) : _vm._e(), (_vm.orderInfo.refundSucTime) ? _c('div', {
    staticClass: ["jindu"]
  }, [_vm._m(3), _c('div', {
    staticClass: ["jinduright"]
  }, [_c('text', {
    ...
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm._f("toTime")(_vm.orderInfo.refundSucTime)))])])]) : _vm._e()]) : _vm._e(), _c('div', [(_vm.orderInfo.hxType === 2 && !_vm.orderInfo.verificationType && !_vm.orderInfo.refundTime && _vm.orderInfo.status !== 5) ? _c('div', {
    ...
    staticClass: ["code_order"]
  }, [_vm._v("订单号：" + _vm._s(_vm.orderInfo.orderNo))])]) : _vm._e()]), _c('div', [_c('div', {
    staticClass: ["active_message"]
  }, [_c('view', {
    staticClass: ["activity_title"]
  }, [_c('text', {
    staticClass: ["activity_title_left"]
  }, [_vm._v(_vm._s(_vm.orderInfo.actTitle))]), (_vm.refund) ? _c('text', {
    staticClass: ["refund"],
    on: {
      "click": _vm.getOrderRefundRequest
    }
  }, [_vm._v("退款")]) : _vm._e()]), _c('div', {
    staticClass: ["activity_list_box"]
  }, [_c('text', {
    ...
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm._f("toTime")(_vm.orderInfo.actBegTime)) + "——" + _vm._s(_vm._f("toTime")(_vm.orderInfo.actEndTime)))])]), _c('div', {
    staticClass: ["activity_list_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("使用方法")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.orderInfo.usageMethod))])]), (_vm.activeRules.length !== 0) ? _c('div', {
    staticClass: ["activity_list_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("退改规则")]), _c('div', _vm._l((_vm.activeRules), function(item, index) {
    return _c('div', {
  ...
  }))]) : _vm._e(), (_vm.orderInfo.isFree === 2) ? _c('div', {
