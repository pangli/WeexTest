...
var activityBC = new BroadcastChannel('activitySendMsg'); //活动通知
...
var activitySend = function activitySend(sendMsg) {
  activityBC.postMessage(sendMsg);
};

var activityGet = function activityGet(callback) {
  activityBC.onmessage = function (event) {
    callback(event);
  };
};
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/activity/payCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6de3ee5c"
...
var _base64MeetingRoom = __webpack_require__(42);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      alipayImg: (0, _base64MeetingRoom.alipayImg)(),
      choosePay: '0',
      orderNo: '',
      payAmount: 0
    };
  ...
  created: function created() {
    ...
    this.orderNo = _global2.default.getParams(weex.config.bundleUrl).orderNo;
    this.payAmount = _global2.default.getParams(weex.config.bundleUrl).payAmount;
        ...
        if (ret.res.code == '10000' && ret.body) {
          ...
          if (_this2.choosePay === '0') {
            pay.wxPay(ret.body, function (result) {
              if (result.status == 1) {
                _this2.getOrderStatusByOrderNo();
              } else {
      ...
      _api2.default.getOrderStatusByOrderNo({
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.status == 2) {
            _BroadcastChannel2.default.activitySend('refresh');
            navigator.pop();
          } else {
