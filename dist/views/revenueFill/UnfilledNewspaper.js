...
/* styles */
__vue_styles__.push(__webpack_require__(647)
)

/* script */
__vue_exports__ = __webpack_require__(648)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/revenueFill/UnfilledNewspaper.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-58f5b83f"
...
exports.default = {
  ...
  created: function created() {
    ...
    this.activeDate = _global2.default.getParams(weex.config.bundleUrl).date;
  ...
  methods: {
    goBack: function goBack() {
      ...
      Steve.postMessage(this.activeDate);
      navigator.pop();
    },
    ...
    goUpdate: function goUpdate(date) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/revenueFill/update.js?value=' + this.yingShe[this.shopText] + '&date=' + date);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    getContractList: function getContractList() {
      ...
      _api2.default.getContractList({
        ...
        if (ret.res.code === 10000) {
          ...
          _this3.items = items;
          _this3.shopText = decodeURI(_global2.default.getParams(weex.config.bundleUrl).value);
