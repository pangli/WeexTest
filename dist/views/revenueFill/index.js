...
/* styles */
__vue_styles__.push(__webpack_require__(651)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/revenueFill/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2545e5da"
...
exports.default = {
  ...
  created: function created() {
    ...
    Stack.onmessage = function (event) {
      if (event.data !== true) {
        _this.activeDate = event.data;
      }
      _this.getContractList();
    };
    this.getContractList();
    if (myDate.getMonth() + 1 < 10) {
      this.activeDate = myDate.getFullYear() + '-0' + (myDate.getMonth() + 1);
    } else {
      this.activeDate = myDate.getFullYear() + '-' + (myDate.getMonth() + 1);
    }
  },
  ...
  methods: {
    ...
    goSearch: function goSearch() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/revenueFill/search.js');
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    pickItem: function pickItem() {
      ...
      normalPicker.openDialog(params, function (src) {
        _this2.shopText = src;
        _this2.getRevenueList();
      });
    },
    getContractList: function getContractList() {
      var _this3 = this;

      toast.showLoadingMessage("获取合同中...");
      var yingShe = {};
      _api2.default.getContractList({
        "userId": weexParams.userId,
        "permissionType": 'REVENUE'
      }, function (ret) {
        toast.close();
        if (ret.res.code === 10000) {
          console.log(ret);
          var items = [];
          var contractList = ret.body.contractList;
          for (var i = 0; i < contractList.length; i++) {
            items.push(contractList[i].contractName);
            yingShe[contractList[i].contractName] = contractList[i].contNo;
          }
          _this3.yingShe = yingShe;
          _this3.items = items;
          _this3.shopText = items[0];
          _this3.getRevenueList();
        } else {
          toast.showMessage("获取合同失败！");
        }
      });
    },
    pickDate: function pickDate() {
      ...
      timePicker.openTimePicker(params, function (src) {
        _this4.activeDate = src;
        _this4.getRevenueList();
      });
    },
    getRevenueList: function getRevenueList() {
      var _this5 = this;

      var activeDate = this.activeDate.replace('-', '');
      toast.showLoadingMessage("获取报表中...");
      _api2.default.getRevenueList({
        "userId": weexParams.userId,
        "yearMonth": activeDate,
        "contractNo": this.yingShe[this.shopText]
      }, function (ret) {
        toast.close();
        if (ret.res.code === 10000) {
          _this5.details = ret.body;
        } else {
          toast.showMessage("获取报表失败！");
        }
      });
    },
    UnfilledNewspaper: function UnfilledNewspaper() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/revenueFill/UnfilledNewspaper.js?value=' + encodeURI(this.shopText) + '&date=' + this.activeDate);
      navigator.push({
        url: url,
        animated: 'true'
      });
    },
    goUpdate: function goUpdate(date, jine) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/revenueFill/update.js?value=' + this.yingShe[this.shopText] + '&date=' + date + '&jine=' + jine);
      navigator.push({
        url: url,
        animated: 'true'
      });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["shop", "border-right"],
    on: {
      "click": _vm.pickItem
    }
  }, [_c('text', {
    staticClass: ["shopText"]
  }, [_vm._v(_vm._s(_vm.shopText))]), _c('image', {
    staticClass: ["xsj"],
    attrs: {
      "src": _vm.xsj
    }
    ...
    staticClass: ["shopText"]
  }, [_vm._v(_vm._s(_vm.activeDate))]), _c('image', {
    staticClass: ["xsj"],
    attrs: {
      "src": _vm.xsj
    }
    ...
    staticClass: ["h3"]
  }, [_vm._v(_vm._s(_vm.shopText))]), _c('text', {
    staticClass: ["h2"]
  }, [_vm._v(_vm._s(_vm._f("weishu")(_vm.details.amount)))]), _c('text', {
    staticClass: ["h4"]
  }, [_vm._v("月销售总额 (元)")])]), (_vm.details.unTurnoveCou === 0) ? _c('text', {
    staticClass: ["titleBox"]
  }, [_vm._v("销售记录")]) : _c('div', {
    staticClass: ["titleBox"],
    on: {
      "click": _vm.UnfilledNewspaper
    }
  }, [_c('text', {
    staticClass: ["red"]
  }, [_vm._v("当前月有未填营报")]), _c('div', {
    staticClass: ["rightBox"]
  }, [_c('text', {
    staticClass: ["month"]
  }, [_vm._v(_vm._s(_vm.details.unTurnoveCou))]), _c('image', {
    staticClass: ["yjt"],
    attrs: {
      "src": _vm.yjt
    }
  ...
  }, _vm._l((_vm.details.turnoveList), function(item) {
    return (item.statue === '1') ? _c('cell', {
      staticClass: ["cell"],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      on: {
        "click": function($event) {
          _vm.goUpdate(item.time, item.amount)
        }
      }
    }, [_c('div', {
      staticClass: ["leftBox"]
    ...
    }, [_vm._v(_vm._s(_vm.details.brandName))]), _c('text', {
      staticClass: ["cell-arr"]
    }, [_vm._v(_vm._s(item.time))])]), _c('text', {
      staticClass: ["jine"]
    }, [_vm._v(_vm._s(_vm._f("weishu")(item.amount)) + "元")])]) : _vm._e()
  }))], 1)
},staticRenderFns: []}
