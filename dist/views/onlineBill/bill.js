...
/* styles */
__vue_styles__.push(__webpack_require__(579)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/onlineBill/bill.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5217c866"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            right: (0, _base.yjt)(),
            billImg: (0, _base.billImg)(),
            billTotal: 0,
            unpaidHydropower: 0, //待缴水电费
            unpaidOther: 0, //待缴其他费用
            unpaidProperty: 0, //待缴物业费
            totalAmount: 0, //累计待缴金额
            unpaidRent: 0, //待缴租金
            normalBillList: [], //待缴账单
            arrearsList: [], //欠费账单
            result: '',
    ...
    created: function created() {
        ...
        // 返回广播
        var backBillDetails = new BroadcastChannel("backBillDetails");
        backBillDetails.onmessage = function (event) {
            if (event.data == '1') {
    ...
    methods: {
        ...
        goPage: function goPage(name, id) {
            var url = url = _global2.default.getUrl(weex.config.bundleUrl, 'views/onlineBill/' + name + '.js?billHistory=1&id=' + id);
            navigator.push({
                url: url,
                animated: 'true'
            });
        },
        getBillData: function getBillData() {
            var _this2 = this;
            ...
            this.result = params;
            _api2.default.getOnlineBillingByParam(params, function (ret) {
                _toast2.default.close();
                //下拉复位
                ...
                if (ret.res.code == '10000' && ret.body) {
                    var data = ret.body;
                    _this2.totalAmount = data.totalAmount;
                    _this2.unpaidRent = data.unpaidRent;
                    _this2.unpaidProperty = data.unpaidProperty;
                    _this2.unpaidHydropower = data.unpaidHydropower;
                    _this2.unpaidOther = data.unpaidOther;

                    _this2.arrearsList = data.arrearsBill;
                    _this2.normalBillList = data.normalBill;
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.goPage('billHistory')
      }
    }
  }, [_c('text', {
    staticClass: ["ttl-right-text"]
  }, [_vm._v("历史账单")])])]), _c('text', {
    staticClass: ["text-money"]
  }, [_vm._v(_vm._s(_vm.totalAmount.toFixed(2)))]), _c('text', {
    staticClass: ["text-ext"]
  }, [_vm._v("累计待缴金额（元）")])]), _c('scroller', [_c('downLoading', {
    ref: "refresh",
    on: {
    ...
    attrs: {
      "type": "待缴账单",
      "billList": _vm.normalBillList
    }
  }), _c('billList', {
    attrs: {
      "type": "欠费账单",
      "billList": _vm.arrearsList
    }
  })], 1)], 1), _c('image', {
    class: ['bill-details-img', _vm.isiPhoneX ? 'bill-details-img-x' : ''],
    attrs: {
      "src": _vm.billImg,
      "resize": "stretch"
    }
  }), _c('div', {
    class: ['bill-details', _vm.isiPhoneX ? 'bill-details-x' : '']
  }, [_c('div', {
    staticClass: ["flex-1"]
  }, [_vm._m(0), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.unpaidRent.toFixed(2)))]), _c('text', {
    staticClass: ["bill-money"]
  }, [_vm._v(_vm._s(_vm.unpaidProperty.toFixed(2)))])])]), _c('div', {
    staticClass: ["flex-1"]
  }, [_vm._m(1), _c('div', {
    staticClass: ["flex-dir-row"]
  }, [_c('text', {
    staticClass: ["bill-money", "item-mar2"]
  }, [_vm._v(_vm._s(_vm.unpaidHydropower.toFixed(2)))]), _c('text', {
    staticClass: ["bill-money", "item-mar2"]
  }, [_vm._v(_vm._s(_vm.unpaidOther.toFixed(2)))])])])])])
  ...
  return _c('div', {
    ...
    staticClass: ["bill-item", "item-mar1"]
  }, [_vm._v("待缴水电费")]), _c('text', {
    staticClass: ["bill-item", "item-mar1"]
  }, [_vm._v("待缴其他费用")])])
}]}
module.exports.render._withStripped = true
