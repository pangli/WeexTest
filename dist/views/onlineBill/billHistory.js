...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/onlineBill/billHistory.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7bdc9637"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var contractNoitems = ['全部合同'];
var billDatetems = ['2018', '2017', '2016', '2015'];
...
exports.default = {
  ...
  filters: {
    checkMath: function checkMath(val) {
  ...
  created: function created() {
    ...
    if (param && param.billHistory) {
      this.title = '历史账单';
    }
    this.getBillHistory();
    this.getContractList();

    storage.getItem('contractList', function (e) {
      if (e.result == 'success' && e.data) {
        var data = JSON.parse(e.data);
        _this.contractListHandle(data);
      }
    });
  ...
  methods: {
    ...
    goPage: function goPage(id) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/onlineBill/billDetails.js?id=' + id);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    selectContract: function selectContract() {
      ...
      if (normalPicker) {
        ...
        params.options = contractNoitems;
        normalPicker.openDialog(params, function (src) {
          _this2.contractNo = src;
          _this2.getBillHistory();
        });
        return;
      }
      picker.pick({
        index: this.indexC,
        items: contractNoitems,
        confirmTitle: '确认',
        cancelTitle: '取消'
        // textColor: 'rgb(0,189,255)'
      }, function (event) {
        if (event.result === 'success') {
          _this2.contractNo = contractNoitems[event.data];
          _this2.indexC = event.data;
          _this2.getBillHistory();
        }
      });
    },
    selectDate: function selectDate() {
      ...
      if (normalPicker) {
        var params = { "options": ["1", "2", "3", "全部"] };
        params.options = billDatetems;
        normalPicker.openDialog(params, function (src) {
          _this3.year = src;
          _this3.getBillHistory();
        });
        return;
      }
      ...
      picker.pick({
        ...
        if (event.result === 'success') {
          _this3.billDate = billDatetems[event.data];
          _this3.indexD = event.data;
          _this3.getBillHistory();
        }
      });
    },
    loadData: function loadData() {
      ...
      modal.toast({ message: '请稍候...', duration: 1 });
    },
    getBillHistory: function getBillHistory() {
      var _this4 = this;
      ...
      var params = {
        ...
        "year": this.year,
        "contractNo": this.contractMap[this.contractNo]
        // this.result = params;
      };_toast2.default.showLoadingMessage("加载中…");
      _api2.default.geHistoryBillingByParam(params, function (ret) {
        //下拉复位
        var $refresh = _this4.$refs.refresh;
        if ($refresh) $refresh.update(false);
        // this.result = ret;
        _this4.pageShow = true;
        if (!ret.res) {
          _this4.pageType = 'noNetwork';
          _toast2.default.showErrorMessage('服务异常');
          return;
        }
        if (ret.res.code == '10000' && ret.body) {
          var data = ret.body;
          _this4.billList = data.billList;
          // const clipboard = weex.requireModule('clipboard');
          // clipboard.setString(JSON.stringify(ret));
          _toast2.default.close();
        } else {
    ...
    getContractList: function getContractList() {
      ...
      this.result = params;
      _api2.default.getContractList(params, function (ret) {
        if (ret.res && ret.res.code == '10000' && ret.body) {
          var data = ret.body;
          _this5.result = data;
          _this5.contractListHandle(data);

          if (data.contractList.length > 0) {
            storage.setItem('contractList', JSON.stringify(data));
          }
        } else {
    ...
    contractListHandle: function contractListHandle(data) {
      var _this6 = this;

      contractNoitems = ['全部合同'];
      data.contractList.forEach(function (item) {
        contractNoitems.push(item.contractName);
        // this.contractMap[item.contractName] = item.contNo;
        _this6.contractMap[item.contractName] = item.contractName;
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["menu", "borderr"],
    on: {
      "click": _vm.selectContract
    }
  }, [_c('text', {
    staticClass: ["f-size-30", "t-color-333", "menu-text"]
  }, [_vm._v(_vm._s(_vm.contractNo))]), _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": _vm.xsj
    }
    ...
    staticClass: ["menu"],
    on: {
      "click": _vm.selectDate
    }
  }, [_c('text', {
    staticClass: ["f-size-30", "t-color-333", "menu-text"]
  }, [_vm._v(_vm._s(_vm.year))]), _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": _vm.xsj
    }
  })])]), (_vm.billList.length > 0) ? _c('list', [_c('downLoading', {
    ref: "refresh",
    on: {
    ...
    return _c('cell', {
    ...
    }, [_vm._v(_vm._s(_vm._f("checkMath")(item.month)) + "月")])])]), _c('div', {
      staticClass: ["cell-center"]
    }, [_c('div', {
      staticClass: ["flex-dir-row"]
    }, [_c('text', {
      staticClass: ["f-size-26", "t-color-333"]
    }, [_vm._v("合同名称")]), _c('text', {
      staticClass: ["f-size-26", "t-color-999", "m-left-20", "tx-elp"]
    }, [_vm._v(_vm._s(item.contractNo))])]), _c('div', {
      staticClass: ["flex-dir-row"]
    }, [_c('text', {
      staticClass: ["f-size-26", "t-color-333"]
    }, [_vm._v("账单编号")]), _c('text', {
      staticClass: ["f-size-26", "t-color-999", "m-left-20"]
      ...
      staticClass: ["f-size-26", "t-color-999", "m-left-20"]
    }, [_vm._v(_vm._s(item.costAmount.toFixed(2)) + "元")])])]), _c('div', {
