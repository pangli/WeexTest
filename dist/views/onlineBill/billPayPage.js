...
/* styles */
__vue_styles__.push(__webpack_require__(594)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/onlineBill/billPayPage.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-66308b7a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      srcUrl: "http://www.sfssdfsgergrhtyrhtyhyt.com/",
      orderNo: "",
      // 终端环境信息
      platform: '',
      osVersion: '',
  ...
  created: function created() {
    ...
    this.getActivePayOrder(self.orderNo);
    ...
    if ((typeof WXEnvironment === 'undefined' ? 'undefined' : _typeof(WXEnvironment)) === 'object') {
      ...
      this.osVersion2 = this.osVersion.split('.')[1];
    }
    // modal.alert({
    //   message:"222"+this.platform
    // })
  },
  ...
  methods: {
    goBack: function goBack() {
      ...
      backBillDetails.postMessage(encodeURI(encodeURI('1')));
    ...
    getActivePayOrder: function getActivePayOrder(orderNo) {
      //生成支付订单 
      var self = this;
      var param = _global2.default.getParams(weex.config.bundleUrl);
      var weexParams = weex.config.params || {};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["web_wrap"]
  }, [(_vm.platform != 'android') ? _c('web', {
    ref: "webview",
    staticClass: ["webview"],
    attrs: {
      "src": _vm.srcUrl
    }
  }) : _vm._e(), (_vm.platform == 'android') ? _c('file-web', {
    ref: "webview",
    staticClass: ["webview"],
    attrs: {
      "src": _vm.srcUrl
