...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/MyRevision/evaluate.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2bb84cb2"
...
exports.default = {
  ...
  methods: {
    ...
    getEvaluateList: function getEvaluateList() {
      ...
      _api2.default.getEvaluateList({
        ...
        if (res.res.code === 10000) {
          ...
          _this2.ext1 = res.body.template.ext1;
          _this2.ext2 = res.body.template.ext2;
          _this2.ext3 = res.body.template.ext3;
        }
      });
    },

    activeUnLike: function activeUnLike() {
      var detailsOutputList = this.detailsOutputList;
      for (var i = detailsOutputList.length; i--;) {
        if (detailsOutputList[i].evaluateType === 1 && detailsOutputList[i].sortOrder === 1) {
          detailsOutputList[i].number = 1;
        }
        if (detailsOutputList[i].evaluateType === 1 && detailsOutputList[i].sortOrder === 2) {
          detailsOutputList[i].number = 0;
        }
      }
      this.detailsOutputList = detailsOutputList;
    },
    activeLike: function activeLike() {
      var detailsOutputList = this.detailsOutputList;
      for (var i = detailsOutputList.length; i--;) {
        if (detailsOutputList[i].evaluateType === 1 && detailsOutputList[i].sortOrder === 1) {
          detailsOutputList[i].number = 0;
    ...
    changeStar: function changeStar(id, index, activeLength) {
      var detailsOutputList = this.detailsOutputList;

      for (var i = detailsOutputList.length; i--;) {
        if (detailsOutputList[i].id === id) {
          if (activeLength) {
            detailsOutputList[i].number = index + activeLength;
          } else {
            detailsOutputList[i].number = index;
          }
        }
      }
      this.detailsOutputList = detailsOutputList;
    ...
    upload: function upload() {
      var params = {
        ...
        "templateList": this.detailsOutputList,
      ...
      if (this.openComment) {
        ibpParams.evaluateDesc = this.comment;
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["h1"]
  }, [_vm._v(_vm._s(_vm.ext1))]), _c('div', {
    staticClass: ["satisfactionArticle"]
  }, [_vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 1 && item.sortOrder === 1) ? _c('div', {
      staticClass: ["noBox"],
      on: {
        "click": _vm.activeUnLike
      }
    }, [(item.number === 0) ? _c('image', {
      staticClass: ["likeIcon"],
      attrs: {
        "src": "data:image/png;base64,",
        "alt": ""
      }
    }) : _c('image', {
      staticClass: ["likeIcon"],
      attrs: {
        "src": "data:image/png;base64,",
        "alt": ""
      }
    }), _c('text', {
      class: ['likeText', item.number ? 'unLikeActive' : '']
    }, [_vm._v(_vm._s(item.items))])]) : _vm._e()
  }), _vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 1 && item.sortOrder === 2) ? _c('div', {
      staticClass: ["yesBox"],
      on: {
        "click": _vm.activeLike
      }
    }, [(item.number === 0) ? _c('image', {
      staticClass: ["likeIcon"],
      attrs: {
        "src": "data:image/png;base64,",
        "alt": ""
      }
    }) : _c('image', {
      staticClass: ["likeIcon"],
      attrs: {
        "src": "data:image/png;base64,",
        "alt": ""
      }
    }), _c('text', {
      class: ['likeText', item.number ? 'likeActive' : '']
    }, [_vm._v(_vm._s(item.items))])]) : _vm._e()
  })], 2)]) : _vm._e(), (_vm.ext2 !== '') ? _c('div', {
    staticClass: ["fiveStar"]
  }, [_c('text', {
    staticClass: ["fiveStarH2"]
  }, [_vm._v(_vm._s(_vm.ext2))]), _vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 2) ? _c('div', {
      staticClass: ["fiveStarArticle"]
    }, [_c('text', {
      staticClass: ["fiveStarLabel"]
    }, [_vm._v(_vm._s(item.items))]), _vm._l((item.number), function(i) {
      return _c('image', {
        staticClass: ["starIcon"],
        attrs: {
          "src": "data:image/png;base64,",
          "alt": ""
        },
        on: {
          "click": function($event) {
            _vm.changeStar(item.id, i)
          }
        }
      })
      ...
      return _c('image', {
        staticClass: ["starIcon"],
        attrs: {
          "src": "data:image/png;base64,",
          "alt": ""
        },
        on: {
          "click": function($event) {
            _vm.changeStar(item.id, i, item.number)
          }
        }
      })
    }), _c('text', {
      staticClass: ["fiveStari"]
    }, [_vm._v(_vm._s(_vm._f("starText")(item.number)))])], 2) : _vm._e()
  })], 2) : _vm._e(), (_vm.ext3 !== '') ? _c('div', {
    staticClass: ["fiveStar"]
  }, [_c('text', {
    staticClass: ["fiveStarH2"]
  }, [_vm._v(_vm._s(_vm.ext3))]), _c('div', {
    staticClass: ["labelBoxArticle"]
  }, _vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 3) ? _c('text', {
  ...
  }))]) : _vm._e(), (_vm.openComment) ? _c('div', {
    staticClass: ["textareaBox"]
  }, [_c('text', {
    staticClass: ["fiveStarH2"]
  }, [_vm._v("请分享你的感受")]), _c('textarea', {
    staticClass: ["details"],
    attrs: {
    ...
    on: {
      "input": function($event) {
        _vm.comment = $event.target.attr.value
      }
    }
  })]) : _vm._e()]), _c('text', {
