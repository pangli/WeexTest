...
var _MyRevisionListTitle = __webpack_require__(109);

var _MyRevisionListTitle2 = _interopRequireDefault(_MyRevisionListTitle);

var _MyRevisionListButtom = __webpack_require__(110);

var _MyRevisionListButtom2 = _interopRequireDefault(_MyRevisionListButtom);
...
exports.default = {
  ...
  created: function created() {
    ...
    Steve.onmessage = function (event) {
      _this.getEstateRepairListByUserId();
    };
    this.getEstateRepairListByUserId();
  },

  methods: {
    goDetails: function goDetails(id) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/MyRevision/details.js?id=' + id);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    getEstateRepairListByUserId: function getEstateRepairListByUserId() {
      var _this2 = this;
      ...
      _api2.default.getProRepairListByUserId({
        "status": activeTab,
        "pageNo": this.index,
        "pageSize": 10
      }, function (res) {
        _this2.$emit('close');
        if (res.code === 10000) {
          var estateRepairList = res.body.PropertyRepairVoList;
          for (var i = 0; i < estateRepairList.length; i++) {
            estateRepairList[i].hopeTime = _global2.default.formatTime(new Date(estateRepairList[i].hopeTime));
          }
          _this2.getTpye(estateRepairList);
          if (_this2.index === 1) {
            _this2.lists = estateRepairList;
          } else {
            _this2.lists = _this2.lists.concat(estateRepairList);
          }
        } else {
    ...
    getTpye: function getTpye(estateRepairList) {
      _api2.default.repairTypeList({
        ...
        if (res.code === 10000) {
          ...
          for (var i = sysCfgCodeList.length; i--;) {
            for (var j = estateRepairList.length; j--;) {
              if (estateRepairList[j].repairType == sysCfgCodeList[i].repair_type_id) {
                estateRepairList[j].repairType = sysCfgCodeList[i].repair_type_name;
              }
            }
          }
        }
  ...
  components: {
    MyRevisionListTitle: _MyRevisionListTitle2.default,
    MyRevisionListButtom: _MyRevisionListButtom2.default,
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/MyRevisionListTitle.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6aff69ce"
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/MyRevisionListButtom.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-072dbc40"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.goDetails(list.id)
        }
      }
    }, [_c('MyRevisionListTitle', {
      attrs: {
        "title": list.repairType,
        "status": list.status,
        "icon": _vm.banshou
      }
    }), _c('div', {
      ...
      staticClass: ["address"]
    }, [_vm._v(_vm._s(list.unitId ? list.unitId : '' + ' ' + list.repairAddress))])]), _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("报修时间")]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(list.hopeTime))])])]), _c('MyRevisionListButtom', {
      attrs: {
        "list": list
      }
    })], 1)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/MyRevision/list.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-00e5eeb7"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _MyRevisionList = __webpack_require__(211);

var _MyRevisionList2 = _interopRequireDefault(_MyRevisionList);
...
exports.default = {
  ...
  components: {
    ...
    MyRevisionList: _MyRevisionList2.default
  },
  data: function data() {
    return {
      tabs: [{
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/MyRevisionList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-490d70f5"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    postscript: function postscript() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/MyRevision/postscript.js?id=' + this.list.id);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    evaluate: function evaluate() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/MyRevision/evaluate.js?id=' + this.list.id + '&come=2');
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["title"]
  }, [(_vm.list.status === 4 && _vm.list.isEvaluate === 0 && _vm.list.hasTemp) ? _c('text', {
    staticClass: ["dpj"],
    on: {
      "click": _vm.evaluate
    }
  }, [_vm._v("待评价")]) : _vm._e(), (_vm.list.status === 4 && _vm.list.isEvaluate === 1) ? _c('text', {
    staticClass: ["ypj"]
  }, [_vm._v("已评价")]) : _vm._e()])
},staticRenderFns: []}
module.exports.render._withStripped = true
