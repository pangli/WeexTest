...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/MyRevision/postscript.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-339ddc44"
...
exports.default = {
  ...
  methods: {
    ...
    getEstateRepairById: function getEstateRepairById() {
      ...
      _api2.default.getEstateRepairById({
        ...
        toast.close();
        if (ret.body) {
          _this2.details = ret.body.estateRepair;
          _this2.details.createTime = _global2.default.formatTime(new Date(ret.body.estateRepair.createTime));
          _this2.details.repairTime = _global2.default.formatTime(new Date(ret.body.estateRepair.repairTime));
          for (var key in ret.body.estateRepair.imageList) {
            _this2.imageList.push(ret.body.estateRepair.imageList[key]);
          }
          for (var key in ret.body.estateRepair.communicateList) {
            for (var index in ret.body.estateRepair.communicateList[key].imageList) {
              _this2.imageList.push(ret.body.estateRepair.communicateList[key].imageList[index]);
            }
          }
        } else {
    ...
    insertEstateRepairCommunicate: function insertEstateRepairCommunicate() {
      var _this3 = this;

      _api2.default.insertEstateRepairCommunicate({
        "marketId": weexParams.marketId,
        "userId": weexParams.userId,
        "estateRepairContent": this.miaoshu,
        "estateRepairId": this.id,
    ...
    uploadImage: function uploadImage() {
      ...
      if (this.photos.length === 0) {
        this.insertEstateRepairCommunicate();
      } else {
        toast.close();
        toast.showLoadingMessage("上传留言中...");
        var params = {
        ...
        (0, _uploadService2.default)(params, function (ret) {
          if (ret.res && ret.returnJson && ret.returnJson.res && ret.returnJson.res.code == 10000 && ret.returnJson.body) {
            if (_this4.updatePic === '') {
              _this4.updatePic = ret.returnJson.body.imgId;
            } else {
              _this4.updatePic = _this4.updatePic + ',' + ret.returnJson.body.imgId;
            }
            _this4.count = _this4.count + 1;
            if (_this4.count >= _this4.photos.length) {
              _this4.insertEstateRepairCommunicate();
            } else {
              _this4.uploadImage();
            }
          } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "label5": "维修工",
      "label6": "维修工电话",
      "address": _vm.details.repairAddress,
      "date": _vm.details.repairTime,
      "id": _vm.details.repairNo,
      "details": _vm.details.detail,
      "name": _vm.details.name,
    ...
    on: {
      "input": function($event) {
        _vm.miaoshu = $event.target.attr.value
      }
    }
  }), _c('div', {
    staticClass: ["border10"]
