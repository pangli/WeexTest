...
/* styles */
__vue_styles__.push(__webpack_require__(449)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/invoice/invoiceApplication.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c147fd78"
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      param: {
        ...
        userId: '', // 用户编号
        orderNo: '', //订单编号
        receiptType: 2, //1个人，2企业
        receiptTitle: '', //抬头
        ratepayingNumber: '', //税号
        receiptContent: '会务费用', //开票内容
        receiptAmount: '', //开票金额
        // sendeeEmail:'',//收件邮箱
        sendeeName: '', //收件人
        sendeeTel: '', //收件人联系方式
  ...
  created: function created() {
    ...
    this.param.userId = weexParams.userId;
    this.param.marketId = weexParams.marketId;
    this.price = _global2.default.getParams(weex.config.bundleUrl).price;
    this.param.receiptAmount = _global2.default.getParams(weex.config.bundleUrl).price;
    this.param.orderNo = _global2.default.getParams(weex.config.bundleUrl).orderNo;
    this.param.userId = weexParams.userId;
    this.param.marketId = weexParams.marketId;
    // 判断是否iphonex
  ...
  methods: {
    ...
    focus: function focus() {
      if (this.param.receiptType == '2') {
        highL(this.param, this);
      } else {
        delete this.param.ratepayingNumber;
        highL(this.param, this);
      }
    },
    inputBlur: function inputBlur() {
      if (!this.param.receiptTitle) {
        toast.showMessage("请输入发票抬头", 0.5);
      }
    },
    inputBlurSh: function inputBlurSh() {
      if (this.param.ratepayingNumber.length < 15) {
        toast.showMessage("请输入正确的税号", 0.5);
      }
    },
    blurName: function blurName(e) {
      if (!this.param.sendeeName) {
        toast.showMessage("请输入收件姓名", 0.5);
      }
    },
    blurConnet: function blurConnet() {
      if (!/^1\d{10}$/.test(this.param.sendeeTel)) {
        toast.showMessage("请输入正确的联系方式", 0.5);
      }
    },
    blurAdd: function blurAdd() {
      if (!this.param.sendeeAddress) {
        toast.showMessage("请输入邮寄地址", 0.5);
      }
    },
    pick: function pick() {
      var _this2 = this;
      ...
      picker.pick({
        ...
        if (event.result === 'success') {
          _this2.value = _this2.items[event.data];
          // 0 企业 1 个人
          _this2.index = event.data;
          _this2.show = event.data == '1' ? false : true;
          _this2.param.receiptType = event.data == '1' ? "1" : '2';
        }
      });
    },
    submit_apply: function submit_apply() {
      var _this3 = this;

      if (!this.allInput) {
        return false;
      }
      if (this.param.receiptType == '1') {
        this.param.ratepayingNumber = ''; //如果是个人，清空税号
      } else {
        if (this.param.ratepayingNumber.trim() && this.param.ratepayingNumber.length < 15) {
          toast.showMessage("请输入正确的税号", 0.5);
          return false;
        }
      }
      if (!this.param.receiptTitle.trim()) {
        toast.showMessage("请输入发票抬头", 0.5);
        return false;
      }

      if (!this.param.sendeeName.trim()) {
        toast.showMessage("请输入收件姓名", 0.5);
        return false;
      }
      if (!/^1\d{10}$/.test(this.param.sendeeTel)) {
      ...
      if (!this.param.sendeeAddress.trim()) {
        toast.showMessage("请输入邮寄地址", 0.5);
        return false;
      }
      _api2.default.addReceiptInvoice(this.param, function (res) {
        toast.showMessage("开票成功", 1);
        if (res.res.code == '10000') {
          var invoiceStatus = new BroadcastChannel('invoiceStatus');
          invoiceStatus.postMessage("success");
          _this3.goBack();
        }
      });
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: ['list_container', _vm.isiPhoneX ? 'marginBtn' : '']
  }, [_c('div', {
    staticClass: ["common_div"]
  }, [_c('div', {
    staticClass: ["common_list"]
  }, [_vm._m(0), _c('div', {
    staticClass: ["common_list_right"],
    on: {
      "click": _vm.pick
    }
  }, [_c('text', {
    ...
    attrs: {
      "type": "text",
      "placeholder": "请输入名称",
      "value": (_vm.param.receiptTitle)
    },
    on: {
      "blur": _vm.inputBlur,
      "input": [function($event) {
        _vm.$set(_vm.param, "receiptTitle", $event.target.attr.value)
      }, _vm.focus]
    }
  })])]), (_vm.show) ? _c('div', {
    staticClass: ["common_list"]
    ...
    attrs: {
      "type": "text",
      "placeholder": "15-20位(企业报销必备)",
      "maxlength": "20",
      "value": (_vm.param.ratepayingNumber)
    },
    on: {
      "blur": _vm.inputBlurSh,
      "input": [function($event) {
        _vm.$set(_vm.param, "ratepayingNumber", $event.target.attr.value)
      }, _vm.focus]
    }
  })])]) : _vm._e()]), _c('div', {
    staticClass: ["common_div"]
    ...
    attrs: {
      ...
      "maxlength": "15",
      "value": (_vm.param.sendeeName)
    },
    on: {
      "blur": _vm.blurName,
      "input": [function($event) {
        _vm.$set(_vm.param, "sendeeName", $event.target.attr.value)
      }, _vm.focus]
    }
  })])]), _c('div', {
    staticClass: ["common_list"]
    ...
    attrs: {
      ...
      "maxlength": "11",
      "value": (_vm.param.sendeeTel)
    },
    on: {
      "blur": _vm.blurConnet,
      "input": [function($event) {
        _vm.$set(_vm.param, "sendeeTel", $event.target.attr.value)
      }, _vm.focus]
    }
  })])]), _c('div', {
    staticClass: ["common_list"]
    ...
    attrs: {
      ...
      "maxlength": "40",
      "value": (_vm.param.sendeeAddress)
    },
    on: {
      "blur": _vm.blurAdd,
      "input": [function($event) {
        _vm.$set(_vm.param, "sendeeAddress", $event.target.attr.value)
      }, _vm.focus]
    }
  })])])]), _c('div', {
    staticClass: ["common_div"]
    ...
    staticClass: ["input"]
  }, [_vm._v(_vm._s(_vm.param.receiptContent))])])]), _c('div', {
    staticClass: ["common_list"]
  }, [_vm._m(7), _c('div', {
    staticClass: ["common_list_right"]
  }, [_c('text', {
    ...
    class: ['footer', _vm.isiPhoneX ? 'iphonex' : '', _vm.allInput ? '' : 'allInput'],
    on: {
      "click": _vm.submit_apply
    }
  }, [_c('text', {
