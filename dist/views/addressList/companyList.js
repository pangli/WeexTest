...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/addressList/companyList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-44a760af"
...
exports.default = {
  ...
  methods: {
    ...
    department: function department(id, companyName) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/addressList/department.js?id=' + id + '&companyName=' + encodeURI(companyName));
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("公司")])]) : _vm._e(), (_vm.searchValue.length === 0) ? _c('div', {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.department(item.companyId, item.company)
        }
      }
    }, [_c('text', {
      staticClass: ["companyName"]
    }, [_vm._v(_vm._s(item.company))]), _c('image', {
      staticClass: ["yjt"],
      attrs: {
        "src": _vm.yjt
      }
