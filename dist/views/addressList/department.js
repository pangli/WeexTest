...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/addressList/department.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-95166ee4"
...
module.exports = {
  ...
  "personMsgBox": {
    ...
    "boxShadow": "inset 0px -1px 0px 0px #e5e5e5",
    "height": "120"
  },
  "personMsgTop": {
    "flexDirection": "row"
...
exports.default = {
  ...
  data: function data() {
    return {
      inputSearch: (0, _base.inputSearch)(),
      yjt: (0, _base.yjt)(),
      searchValue: '',
      lists: '',
      id: '',
  ...
  created: function created() {
    ...
    this.companyName = decodeURI(_global2.default.getParams(weex.config.bundleUrl).companyName);
    this.getMailListByUserId();
  },
  ...
  methods: {
    ...
    getMailListByUserId: function getMailListByUserId() {
      var _this2 = this;

      toast.showLoadingMessage("获取通讯录...");
      _api2.default.getMailListByUserId({
        ...
        if (res.res.code === 10000) {
          _this2.lists = res.body.mailList.departmentList;
          _this2.userTenantList = res.body.mailList.userTenantList;
        }
      });
    },
    department: function department(_department) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/addressList/personList.js?department=' + encodeURI(_department) + '&id=' + this.id + '&companyName=' + encodeURI(this.companyName));
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    goDetail: function goDetail(index, status) {
      var userInfo = void 0;
      if (status === 'user') {
        userInfo = this.userTenantList;
      } else {
        userInfo = this.personList;
      }
      userInfo = userInfo[index];
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/addressList/detail.js?userHead=' + userInfo.photoPath + '&phone=' + userInfo.phone + '&userName=' + encodeURI(userInfo.userName) + '&email=' + userInfo.email + '&company=' + encodeURI(userInfo.company) + '&department=' + encodeURI(userInfo.department));
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    getMailListByWhere: function getMailListByWhere() {
      var _this3 = this;

      _api2.default.getMailListByWhere({
        "userId": weexParams.userId,
        "userName": this.searchValue,
        "companyId": this.id
      }, function (res) {
        _this3.personList = res.body.userTenantList;
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "type": "text",
      "placeholder": "搜索姓名",
      "placeholderColor": "#bec0c8",
      "returnKeyType": "search",
      "value": (_vm.searchValue)
    },
    on: {
      "return": _vm.getMailListByWhere,
      "input": function($event) {
        _vm.searchValue = $event.target.attr.value
      }
    }
  }), _c('image', {
  ...
  }), (_vm.searchValue.length !== 0) ? _c('text', {
    staticClass: ["cancel"],
    on: {
      "click": _vm.cancel
    }
  }, [_vm._v("取消")]) : _vm._e()]), (_vm.searchValue.length === 0) ? _c('div', {
    staticClass: ["titleBox"]
  }, [_c('text', {
    staticClass: ["lastLabel"]
  }, [_vm._v("公司")]), _c('text', {
    staticClass: ["lastLabel", "activeTitle"]
  }, [_vm._v(_vm._s(_vm.companyName))])]) : _vm._e(), (_vm.searchValue.length === 0) ? _c('div', {
    staticClass: ["scroller"]
  }, [(_vm.lists.length != 0) ? _c('text', {
    staticClass: ["searchText"]
  }, [_vm._v("下级部门")]) : _vm._e(), _c('list', [_vm._l((_vm.lists), function(item, index) {
    return (_vm.lists.length != 0) ? _c('cell', {
      class: ['cell', index == 0 ? '' : 'btw2'],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      },
  ...
  }), (_vm.userTenantList.length !== 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["searchText"]
  }, [_vm._v("部门成员")])]) : _vm._e(), _vm._l((_vm.userTenantList), function(item, index) {
    return (_vm.userTenantList.length !== 0) ? _c('cell', {
      ...
      staticClass: ["personMsgBox"]
    }, [_c('div', {
      staticClass: ["personMsgBoxLeft"]
    }, [_c('div', {
      staticClass: ["personMsgTop"]
    }, [_c('text', {
      staticClass: ["userName"]
    }, [_vm._v(_vm._s(item.userName))])]), _c('text', {
      staticClass: ["tel"]
    }, [_vm._v(_vm._s(item.phone))])]), _c('image', {
      staticClass: ["yjt"],
      attrs: {
        "src": _vm.yjt
      }
    ...
    staticClass: ["searchText"]
  }, [_vm._v("搜索结果")]), _c('list', _vm._l((_vm.personList), function(item, index) {
    return _c('cell', {
      staticClass: ["personBox"],
      appendAsTree: true,
      attrs: {
    ...
    }, [_vm._v(_vm._s(item.department || item.company))])]), _c('text', {
      staticClass: ["tel"]
    }, [_vm._v(_vm._s(item.phone))])]), _c('image', {
      staticClass: ["yjt"],
      attrs: {
