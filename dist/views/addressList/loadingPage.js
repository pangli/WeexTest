...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/addressList/loadingPage.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-004127df"
  ...
  methods: {
    getUserTenantListByUserId: function getUserTenantListByUserId() {
      _api2.default.getUserTenantListByUserId({
        ...
        if (ret.body) {
          var url = void 0,
              userTenantList = ret.body.userTenantList;
          switch (userTenantList.length) {
            case 0:
              url = _global2.default.getUrl(weex.config.bundleUrl, 'views/myMessage/tenementForm.js?goBack=2');
              break;
            case 1:
              url = _global2.default.getUrl(weex.config.bundleUrl, 'views/addressList/department.js?id=' + userTenantList[0].companyId + '&companyName=' + encodeURI(userTenantList[0].company) + '&goBack=2');
              break;
            default:
              url = _global2.default.getUrl(weex.config.bundleUrl, 'views/addressList/companyList.js?goBack=2');
          }
          navigator.push({
            url: url,
            animated: 'false'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["wrapper"],
    class: [_vm.isiOS7 ? 'iOS7' : '', _vm.isiPhoneX ? 'IOSX' : '']
  }, [_c('div', {
