...
/* styles */
__vue_styles__.push(__webpack_require__(678)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/serviceProvider/detail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-52885a0e"
...
exports.default = {
  ...
  created: function created() {
    ...
    globalEvent.addEventListener("clickEvent", function (e) {
      if (e.backKey && e.backKey == 'keyPress') {
        var data = new BroadcastChannel('curData');
        data.postMessage(_this.providerData);
        _this.goBack();
      }
    });
    var iPhoneXHeight = 2436;
    ...
    var come = new BroadcastChannel('come');
  ...
  methods: {
    goBack: function goBack() {
      var data = new BroadcastChannel('curData');
      data.postMessage(this.providerData);
    ...
    getData: function getData() {
      ...
      _api2.default.getProviderData(params, function (res) {
        console.log(res);
        _toast2.default.close();
        if (res.res.code == 10000) {
          var data = res.body.provider;
          if (data.providerLabel) {
            data.providerLabel = data.providerLabel.split(",");
          }
          that.providerData = data;
        }
      });
    },
    ...
    clickZan: function clickZan(id) {
      ...
      _api2.default.insertProviderGreat(params, function (res) {
        if (res.res.code == 10000) {
          that.providerData.count = res.body.count;
          that.providerData.isGreat = res.body.isGreat;
        }
      });
    },
    ...
    myApply: function myApply(id, isApply) {
      if (isApply == 1) {
        _global2.default.jump("views/serviceProvider/applyDetail.js", "?id=" + id);
      } else {
        _global2.default.jump("views/serviceProvider/apply.js", "?id=" + id);
      }
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.providerData.images) ? _c('div', {
    staticClass: ["swiper"]
  }, [_c('slider', {
    staticClass: ["slider"],
    attrs: {
  ...
  }, _vm._l((_vm.providerData.images), function(img) {
    return _c('div', {
      staticClass: ["frame"]
    }, [_c('image', {
      staticClass: ["image"],
  ...
  })), (_vm.providerData.images && _vm.providerData.images.length > 1) ? _c('div', {
    staticClass: ["indicator"]
  }, [_c('div', {
    staticClass: ["indicator_main"]
  }, _vm._l((_vm.providerData.images), function(img, index) {
    return _c('text', {
      class: ['indicator_text', _vm.cur == index ? 'cur' : '']
    })
    ...
    attrs: {
      "resize": "cover",
      "src": _vm.providerData.providerImgUrl
    }
  }), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.providerData.providerName))])]), _c('div', {
    staticClass: ["discount"]
  }, [(_vm.providerData.providerDiscount) ? _c('text', {
    staticClass: ["discount_list"]
  }, [_vm._v(_vm._s(_vm.providerData.providerDiscount))]) : _vm._e()]), _c('div', {
    staticClass: ["label"]
  }, _vm._l((_vm.providerData.providerLabel), function(i) {
    return _c('text', {
    ...
    on: {
      "click": function($event) {
        _vm.clickZan(_vm.providerData.id)
      }
    }
  }, [_c('text', {
    class: ['count_text', _vm.providerData.isGreat == 0 ? '' : 'count_high']
  }, [_vm._v(_vm._s(_vm.providerData.count))]), _c('image', {
    staticClass: ["count_icon"],
    attrs: {
      "resize": "cover",
      "src": _vm.providerData.isGreat == 0 ? _vm.icon.zanGray : _vm.icon.zanHigh
    }
  })])]), _c('div', {
    ...
    staticClass: ["basic_mess_list"]
  }, [_vm._v("所属行业:" + _vm._s(_vm.providerData.providerTypeName))]), _c('text', {
    staticClass: ["basic_mess_list"],
    on: {
      "longpress": function($event) {
        _vm.setContent(_vm.providerData.providerWebSite)
      }
    }
  }, [_vm._v("网址:" + _vm._s(_vm.providerData.providerWebSite))]), _c('text', {
    staticClass: ["basic_mess_list"],
    on: {
      "click": function($event) {
        _vm.call(_vm.providerData.phone)
      }
    }
  }, [_vm._v("联系电话:" + _vm._s(_vm.providerData.phone))])]), _c('div', {
    staticClass: ["detail_mess"]
  }, [_c('text', {
    staticClass: ["common_title"]
  }, [_vm._v("服务商详情")]), _c('vk-wx-richtext', {
    ref: "richtext",
    style: {
      width: _vm.width,
      height: _vm.height
    ...
    attrs: {
      "src": _vm.providerData.providerMemo
    },
    on: {
  ...
  }, [(_vm.providerData.isDetail == 1) ? _c('text', {
    staticClass: ["footer_btn"],
    on: {
      "click": function($event) {
        _vm.myApply(_vm.providerData.detailId, _vm.providerData.isDetail)
      }
    }
  }, [_vm._v("已申请，查看进度")]) : _c('text', {
    staticClass: ["footer_btn"],
    on: {
      "click": function($event) {
        _vm.myApply(_vm.providerData.id, _vm.providerData.isDetail)
      }
    }
  }, [_vm._v("申请合作")])])], 1)
},staticRenderFns: []}
