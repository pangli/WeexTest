...
exports.default = {
  ...
  methods: {
    goActivityDetail: function goActivityDetail(id) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/activity/activityDetail.js?actId=' + id);
      _analytics2.default.event('open_active_detail');
      navigator.push({
        url: url,
        animated: 'true'
      });
    },
    goActivityForm: function goActivityForm() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/activity/activityForm.js');
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.lists.length === 0 && _vm.lists !== '') ? _c('myDefault', {
    attrs: {
      "type": "noData"
    },
    on: {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.goActivityDetail(list.actId)
        }
      }
    }, [_c('div', {
      staticClass: ["topBox"]
    }, [_c('image', {
      staticClass: ["topLeftBox"],
      attrs: {
        "src": list.actImg
      }
    }), _c('div', {
      staticClass: ["topRightBox"]
    }, [_c('text', {
      staticClass: ["h2"]
    }, [_vm._v(_vm._s(list.actTitle))]), _c('text', {
      staticClass: ["address"]
    }, [_vm._v(_vm._s(list.actAddress))]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(list.actBegTime))]), (list.isFree === 1) ? _c('text', {
      staticClass: ["jiage"]
    }, [_vm._v("免费")]) : _c('text', {
      staticClass: ["jiage"]
    }, [_vm._v("￥" + _vm._s(list.actPrice))])])]), _c('div', {
      staticClass: ["bottomBox"]
    }, [_c('div', {
      staticClass: ["bottomLeftBox"]
    }, _vm._l((list.actLabel), function(item) {
      return _c('text', {
        staticClass: ["biaoqian"]
      }, [_vm._v("#" + _vm._s(item))])
    })), _c('div', {
      staticClass: ["bottomRightBox"]
    }, [_c('text', {
      staticClass: ["buttom"]
    }, [_vm._v("立刻报名")])])])])
  }))
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/findSearch/search.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e31b1972"
...
var _activity = __webpack_require__(428);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      deleteIcon: (0, _base.deleteIcon)(),
      searchData: '',
      lajitong: (0, _base.lajitong)(),
  ...
  created: function created() {
    ...
    this.config = JSON.stringify(weex.config);
    storage.getItem('findSearchData', function (e) {
      if (e.data) {
        _this.hisData = _this.hisData.concat(e.data.split(','));
      }
    });
  ...
  methods: {
    ...
    keyB: function keyB(e) {
      var hisDataString = void 0;
      if (e.value !== '') {
        this.searchBool = true;
        this.searchList();
        this.hisData.unshift(e.value);
        if (this.hisData.length > 10) {
          this.hisData.splice(-1, 1);
        }
        storage.setItem('findSearchData', this.hisData.join(','));
      } else {
    ...
    searchList: function searchList() {
      ...
      var that = this;
      toast.showLoadingMessage("搜索中...");
      _api2.default.getActiveListByMarketId({
        "marketId": weexParams.marketId,
        "userId": weexParams.userId,
        "actName": that.searchData,
        "pageNo": 1,
        "pageSize": 10
      }, function (ret) {
        toast.close();
        if (ret.body) {
          var lists = ret.body.activeList;
          for (var i = 0; i < lists.length; i++) {
            lists[i].actBegTime = _global2.default.formatTime(new Date(lists[i].actBegTime));
            if (lists[i].actLabel) {
              lists[i].actLabel = lists[i].actLabel.split(';');
            }
          }
          _this2.lists = lists;
        } else {
          toast.showMessage("搜索失败！");
        }
      });
    },
    ...
    deleteHis: function deleteHis() {
      ...
      storage.removeItem('findSearchData', function () {
        _this3.hisData = [];
      });
    },
    changeSearch: function changeSearch(item) {
      this.searchBool = true;
      this.searchData = item;
      this.searchList();
    },
    showToast: function showToast() {
      toast.showAlertMessage("该功能暂未开通\n敬请期待");
    }
  }
};
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/activity.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2acb0dff"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: ['search', _vm.isiOS7 ? 'iOS7' : '', _vm.isiPhoneX ? 'IOSX' : '']
  }, [_c('div', {
  ...
  }, [_vm._v("积分商城")])]), (!_vm.searchBool) ? _c('div', {
    staticClass: ["searchHistory"]
  }, [_c('text', {
    staticClass: ["h3"]
  }, [_vm._v("历史搜索")]), _c('image', {
    staticClass: ["lajitong"],
    attrs: {
      "src": _vm.lajitong
    },
    on: {
  ...
  })]) : _vm._e(), (!_vm.searchBool) ? _c('div', {
    staticClass: ["historyBox"]
  }, _vm._l((_vm.hisData), function(item) {
    return (item !== 'undefined') ? _c('text', {
      staticClass: ["box"],
      on: {
        "click": function($event) {
          _vm.changeSearch(item)
        }
      }
