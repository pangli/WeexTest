...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/coupon/myCoupon.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5c66450c"
...
module.exports = {
  ...
  "activeType": {
    "borderTopColor": "rgba(0,189,255,0.3)",
    "borderTopWidth": "1",
    "borderBottomColor": "rgba(0,189,255,0.3)",
    "borderBottomWidth": "1",
    "borderLeftColor": "rgba(0,189,255,0.3)",
    "borderLeftWidth": "1",
    "borderRightColor": "rgba(0,189,255,0.3)",
    "borderRightWidth": "1",
  ...
  "couponCenter": {
    "width": "290",
    "height": "76",
    "backgroundImage": "linear-gradient(315deg, rgba(255, 59, 55, 1), rgba(255, 118, 64, 1))",
    "borderRadius": "44",
    "position": "absolute",
    "right": "28",
    "bottom": "28",
...
var _myCouponList = __webpack_require__(415);

var _myCouponList2 = _interopRequireDefault(_myCouponList);
...
exports.default = {
  ...
  created: function created() {
    ...
    var getCoupon = new BroadcastChannel('couponSendMsg');
    getCoupon.onmessage = function (event) {
      _this.getMbBondCountByUserId();
    };
    this.getMbBondCountByUserId();
  },
  ...
  methods: {
    ...
    getBondDict: function getBondDict() {
      var _this2 = this;

      _api2.default.getBondDict({}, function (res) {
        if (res.res.code === 10000) {
          _this2.dictList = res.body.dictList;
        }
      });
    },
    getMbBondCountByUserId: function getMbBondCountByUserId() {
      var _this3 = this;

      _api2.default.getMbBondCountByUserId({
        "memberCode": weexParams.memberCode,
        "marketId": weexParams.marketId,
        "type": this.activeType
      }, function (res) {
        if (res.res.code === 10000) {
          _this3.tabs[1].title = '使用记录(' + res.body.output.usedCount + ')';
          _this3.tabs[2].title = '已过期(' + res.body.output.expiredCount + ')';
          _this3.tabs[0].title = '未使用(' + res.body.output.notUsedCount + ')';
        }
      });
    },
    goVoucherCenter: function goVoucherCenter() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/coupon/VoucherCenter.js');
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
  ...
  components: {
    myCouponList: _myCouponList2.default
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["couponCenter"],
    on: {
      "click": _vm.goVoucherCenter
    }
  }, [_c('image', {
    staticClass: ["couponCenterIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
    staticClass: ["couponCenterText"]
  }, [_vm._v("领券中心")]), _c('image', {
    staticClass: ["couponCenterGo"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  })]), (_vm.changeType) ? _c('div', {
    staticClass: ["bg"],
    on: {
      "click": function($event) {
    ...
    class: ['typeText', _vm.activeType === '' ? 'activeType' : ''],
    on: {
      "click": function($event) {
        _vm.typeChange('')
      }
    }
  }, [_vm._v("全部")]), _vm._l((_vm.dictList), function(item, index) {
    return _c('text', {
      class: ['typeText', _vm.activeType === item.dictValue ? 'activeType' : ''],
      on: {
        "click": function($event) {
          _vm.typeChange(item.dictValue)
        }
      }
