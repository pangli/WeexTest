...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/coupon/exchangeDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ca748e16"
...
exports.default = {
  ...
  created: function created() {
    ...
    this.code = _global2.default.getParams(weex.config.bundleUrl).code;
    this.templateId = _global2.default.getParams(weex.config.bundleUrl).templateId;
    this.getMbBondTemplateById();
  ...
  methods: {
    ...
    getMbBondTemplateById: function getMbBondTemplateById() {
      var _this2 = this;

      _api2.default.getMbBondTemplateById({
        "templateId": this.templateId
      }, function (res) {
        if (res.res.code === 10000) {
          _this2.details = res.body.MbBondTemplate;
        }
        _this2.getBondDict();
      });
    },
      ...
      _api2.default.getBondDict({}, function (res) {
        if (res.res.code === 10000) {
          ...
          for (var index in dictList) {
            if (dictList[index].dictValue == _this3.details.type) {
              _this3.details.type = dictList[index].dictName;
            }
          }if (_this3.details.type === '返金券') {
            var content = {
              'itemId': _this3.id,
              'itemCode': _this3.code,
              'orderType': 3
            };
            var param = {
              "width": "320",
    ...
    goUse: function goUse() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, decodeURIComponent(_global2.default.getParams(weex.config.bundleUrl).link));
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["code"]
  }, [_vm._v(_vm._s(_vm.code))]), _c('text', {
    staticClass: ["tishi"]
  }, [_vm._v("请到店出示券码")])]), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("有效期")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm._f("date")(_vm.details.beginTime)) + "-" + _vm._s(_vm._f("date")(_vm.details.endTime)))]), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("使用条件")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.details.descr))]), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("使用说明")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v("券类型: " + _vm._s(_vm.details.type))]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v("适用城市: " + _vm._s(_vm.details.cityName))]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v("适用项目: " + _vm._s(_vm.details.marketName))])]), _c('div', {
    class: ['cardBox', _vm.isiOS7 ? 'iOS7Top' : '', _vm.isiPhoneX ? 'iPhoneXTop' : '']
  }, [_c('div', {
    staticClass: ["cellLeft"]
  }, [(_vm.details.discountMode == '1') ? _c('div', {
    staticClass: ["cellLeftTop"]
  }, [_c('text', {
    staticClass: ["yuan"]
  }, [_vm._v("¥")]), _c('text', {
    staticClass: ["nub"]
  }, [_vm._v(_vm._s(_vm.details.amountDiscount))])]) : _c('div', {
    staticClass: ["cellLeftTop2"]
  }, [_c('text', {
    staticClass: ["nub"]
  }, [_vm._v(_vm._s(_vm.details.amountDiscount / 10))]), _c('text', {
    staticClass: ["dian"]
  }, [_vm._v("." + _vm._s(_vm.details.amountDiscount % 10))]), _c('text', {
    staticClass: ["yuan"]
  }, [_vm._v("折")])]), _c('text', {
    staticClass: ["condition"]
  }, [_vm._v(_vm._s(_vm.details.descr))])]), _c('div', {
    staticClass: ["cellRight"]
  }, [_c('text', {
    staticClass: ["couponType"]
  }, [_vm._v(_vm._s(_vm.details.type))]), _c('text', {
    staticClass: ["cardTitle"]
  }, [_vm._v(_vm._s(_vm.details.name))]), _c('text', {
    staticClass: ["time"]
  }, [_vm._v(_vm._s(_vm._f("date")(_vm.details.beginTime)) + "-" + _vm._s(_vm._f("date")(_vm.details.endTime)))])])])])
},staticRenderFns: []}
