...
exports.default = {
  ...
  methods: {
    goDetails: function goDetails(id, createTime, userName, phone, email, company, status, photoPath, department) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/approval/approvalDetail.js?id=' + id + '&createTime=' + createTime + '&userName=' + encodeURI(userName) + '&phone=' + phone + '&email=' + email + '&company=' + encodeURI(company) + '&status=' + status + '&photoPath=' + photoPath);
      if (department) {
    ...
    goVisitorReservation: function goVisitorReservation(id) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/approval/VisitorReservationDetail.js?id=' + id);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    getUserTenantList: function getUserTenantList() {
      var _this2 = this;

      _api2.default.getUserTenantList({
        ...
        if (ret.body) {
          console.log(ret);
          var userTenantList = ret.body.userTenantList;
          if (_this2.index === 1) {
            _this2.lists = userTenantList;
          } else {
            _this2.lists = _this2.lists.concat(userTenantList);
          }
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('cell', {
    ...
    }, [(list.tenType == 0) ? _c('div', {
      staticClass: ["mainBox"],
      on: {
        "click": function($event) {
          _vm.goDetails(list.id, list.createTime, list.userName, list.phone, list.email, list.company, list.status, list.photoPath, list.department)
        }
      }
    }, [_c('image', {
      staticClass: ["leftImg"],
      ...
      staticClass: ["date"]
    }, [_vm._v(_vm._s(_vm._f("date")(list.createTime)))])]), _c('text', {
      staticClass: ["rightBottom"]
    }, [_vm._v(_vm._s(list.userName) + " - " + _vm._s(list.company))])])]) : _c('div', {
      staticClass: ["mainBox"],
      on: {
        "click": function($event) {
          _vm.goVisitorReservation(list.id)
        }
      }
    }, [_c('image', {
      staticClass: ["leftImg"],
      ...
      staticClass: ["rightBottom"]
    }, [_vm._v(_vm._s(list.visitorUserName) + " - " + _vm._s(list.visitorCompany))])])])])
  })], 2)], 1)
},staticRenderFns: []}
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/approval/approvalList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-20062a5e"
...
var _ApprovalList = __webpack_require__(318);

var _ApprovalList2 = _interopRequireDefault(_ApprovalList);
...
exports.default = {
  ...
  components: {
    ...
    ApprovalList: _ApprovalList2.default
  },
  data: function data() {
    return {
      tabs: [{
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/ApprovalList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-12cc48de"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
