...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/orderDate.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-00187494"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports = {
  ...
  "submit-text": {
    "width": "220",
    "height": "76",
    "backgroundImage": "linear-gradient(270deg, rgba(0, 154, 255, 1), rgba(0, 189, 255, 1))",
    "borderRadius": "38",
    "marginTop": 0,
    "marginRight": "28",
    "marginBottom": 0,
...
var _header3 = __webpack_require__(8);
...
exports.default = {
  ...
  components: {
    ...
    Headers: _header4.default
  },
  filters: {},
  data: function data() {
    return {
      value: '请选择日期',
      iconr: 'data:image/png;base64,',
  ...
  mounted: function mounted() {
    // 获取当前星期
    this.day_week = [];
    this.day_week = _global2.default.getWeekDay();
    for (var i = 0; i < this.dateList.length; i++) {
      this.dateList[i].date = _global2.default.getDay(i).split('-')[1] + '-' + _global2.default.getDay(i).split('-')[2];
      if (this.day_week[i] == 0) {
        this.dateList[i].week = '周日';
      } else if (this.day_week[i] == 1) {
        this.dateList[i].week = '周一';
      } else if (this.day_week[i] == 2) {
        this.dateList[i].week = '周二';
      } else if (this.day_week[i] == 3) {
        this.dateList[i].week = '周三';
      } else if (this.day_week[i] == 4) {
        this.dateList[i].week = '周四';
      } else if (this.day_week[i] == 5) {
        this.dateList[i].week = '周五';
      } else if (this.day_week[i] == 6) {
        this.dateList[i].week = '周六';
      }
    }
    var currentDate = new Date().getFullYear() + "-" + this.dateList[0].date;
    this.value = currentDate;
    this.getMeetingRoomPriceList(currentDate);
  },
  ...
  methods: {
    ...
    selectDay: function selectDay(currentDate) {
      this.currentDate = currentDate;
      this.betweenArray = [];
      this.selectStart = 9999;
      this.selectEnd = 9999;
      this.jisuanStr = "00:00-00:00/0小时  合计0￥";
      this.totalPrice = "";
      this.minPrice = 0;
      this.timeList = '';
      this.getMeetingRoomPriceList(currentDate);
    },
    selectBetween: function selectBetween(index, status, statusPre) {
      var self = this;
      var len = self.betweenArray.length;
      // length小于2   push
      // length大于等于2  取最大和最小
      if (status == '1' || index > 0 && statusPre == '1' && statusPre != undefined) {
        if (len == 0) {
          self.betweenArray.push(index);
          self.selectStart = index;
        } else if (len == 1 && index != self.betweenArray[0]) {
          self.betweenArray.push(index);
          if (self.betweenArray[0] < index) {
            self.selectStart = self.betweenArray[0];
            self.selectEnd = index;
          } else {
            self.selectStart = index;
            self.selectEnd = self.betweenArray[0];
          }
          self.jisuanPrice();
        } else if (len == 2) {
          self.betweenArray = [];
          self.selectStart = 9999;
          self.selectEnd = 99999;
          self.betweenArray.push(index);
          self.selectStart = index;
        } else {}
      } else {
        _toast2.default.showMessage('当前时间不可预定', 2);
      }
    },
    submitOrder: function submitOrder() {
      var self = this;
      if (self.selectStart == 9999 && self.selectEnd == 9999) {
        modal.alert({
          message: '请选择预定的时间'
        });
        return;
      } else if (self.selectEnd == 9999 && self.selectStart != 9999) {
        modal.alert({
          message: '请选择结束的时间'
        });
        return;
      }
      var lenTimeList = self.timeList.length;
      for (var i = 0; i < lenTimeList; i++) {
        if (i > self.selectStart - 1 && i < self.selectEnd) {
          if (self.timeList[i].status != '1') {
            modal.alert({
              message: '当前选择包含不可预定时段'
            });
            return;
          }
        }
      }
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/meetingRoom/confirmInfo.js' + '?id=' + param.id + '&jisuanStr=' + encodeURI(this.jisuanStr) + '&minPrice=' + this.minPrice + '&totalPrice=' + this.totalPrice + '&timeList=' + encodeURI(JSON.stringify(this.timeList)) + '&selectStart=' + this.selectStart + '&selectEnd=' + this.selectEnd);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    getMeetingRoomPriceList: function getMeetingRoomPriceList(currentDate) {
      var self = this;
      _toast2.default.showLoadingMessage("加载中…");
      var weexParams = weex.config.params || {};
      var params = {
        'userId': weexParams.userId,
        "meetingRoomId": param.id,
        "date": currentDate
      };
      _api2.default.getMeetingPriceList(params, function (ret) {
        _toast2.default.close();
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.respOutputs) {
            self.priceDataList = ret.body.respOutputs;
            self.timeList = ret.body.respOutputs;
            self.dayTime = ret.body.dayTime;
          } else {
            _toast2.default.showMessage("当前没有可预定时段", 2);
          }
          // self.canOrderTime();
        } else {
    ...
    onrefresh: function onrefresh(event) {
      this.getMeetingRoomPriceList();
    },

    // 遍历设置可预定时间
    jisuanPrice: function jisuanPrice() {
      var self = this;
      // 计算价格
      var hourCount1 = (self.selectEnd - self.selectStart) / 2;
      var jisuanStr = (self.timeList[self.selectStart].time ? self.timeList[self.selectStart].time : '') + "-" + (self.timeList[self.selectEnd].time ? self.timeList[self.selectEnd].time : '') + "/" + hourCount1 + "小时";
      var jisuanStr2 = (self.timeList[self.selectStart].time ? self.timeList[self.selectStart].time : '') + "-" + (self.timeList[self.selectEnd].time ? self.timeList[self.selectEnd].time : '');
      var totalPrice = 0;
      var lenJ = self.timeList.length;
      var priceArray = [];
      if (hourCount1 < self.dayTime || !self.timeList[self.selectStart].dayPrice) {
        for (var i = 0; i < lenJ; i++) {
          if (i > self.selectStart - 1 && i < self.selectEnd) {
            totalPrice = _global2.default.add(totalPrice, self.timeList[i].unitPrice ? self.timeList[i].unitPrice : 0);
            priceArray.push(self.timeList[i].unitPrice ? self.timeList[i].unitPrice : 0);
          }
        }
      } else {
        for (var _i = 0; _i < lenJ; _i++) {
          if (_i > self.selectStart - 1 && _i < self.selectEnd) {
            priceArray.push(self.timeList[_i].unitPrice ? self.timeList[_i].unitPrice : 0);
          }
        }
        totalPrice = self.timeList[self.selectStart].dayPrice;
      }
      self.jisuanStr = jisuanStr;
      self.jisuanStr2 = jisuanStr2;
      self.totalPrice = totalPrice;
      self.hourCount = hourCount1;
      self.minPrice = Math.min.apply(null, priceArray) * 2;
    },
    pickDate: function pickDate() {
      ...
      var params = {
        ...
        "beginMonth": _global2.default.formatNumber(new Date().getMonth() + 1),
        "beginDay": _global2.default.formatNumber(new Date().getDate())
      };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["list_value", "data"]
  }, [_vm._v(_vm._s(_vm.value))])]), _c('image', {
    staticClass: ["list_arror"],
    staticStyle: {
      width: "11px",
      height: "20px"
    },
    ...
    staticClass: ["date-select-form"]
  }, _vm._l((_vm.timeList), function(item, index) {
    return _c('div', {
      class: ['date-select-form-row']
    }, [_c('div', {
      class: ['betweenBg', (_vm.selectStart < index && _vm.selectEnd > index) ? 'between' : '']
    }, [(_vm.selectStart == index && _vm.selectStart != _vm.selectEnd) ? _c('div', {
      staticClass: ["right"]
    }) : _vm._e(), (_vm.selectEnd == index && _vm.selectStart != _vm.selectEnd) ? _c('div', {
      staticClass: ["left"]
    }) : _vm._e(), _c('div', {
      class: ['date-select-form-item', _vm.selectStart == index ? 'start' : '', _vm.selectEnd == index ? 'end' : ''],
      on: {
        "click": function($event) {
          _vm.selectBetween(index, item.status, index > 0 ? _vm.timeList[index - 1].status : '')
        }
      }
    }, [(_vm.selectStart != index && _vm.selectEnd != index) ? _c('text', {
      class: ['time', item.status == '1' || (index > 0 && _vm.timeList[index - 1].status == '1') ? 'keyi' : '']
    }, [_vm._v(_vm._s(item.time))]) : _vm._e(), (_vm.selectStart == index && _vm.selectStart != _vm.selectEnd) ? _c('text', {
      staticClass: ["timeText"]
    }, [_vm._v(_vm._s(item.time))]) : _vm._e(), (_vm.selectStart == index && _vm.selectStart != _vm.selectEnd) ? _c('text', {
      staticClass: ["timeTextS"]
    }, [_vm._v(_vm._s("开始"))]) : _vm._e(), (_vm.selectEnd == index && _vm.selectStart != _vm.selectEnd) ? _c('text', {
      staticClass: ["timeText"]
    }, [_vm._v(_vm._s(item.time))]) : _vm._e(), (_vm.selectEnd == index && _vm.selectStart != _vm.selectEnd) ? _c('text', {
      staticClass: ["timeTextE"]
    }, [_vm._v(_vm._s("结束"))]) : _vm._e()])])])
  })), _c('div')]), (_vm.selectEnd !== 9999) ? _c('div', {
    staticClass: ["cardBox"]
  }, [_c('div', {
    staticClass: ["msgBox"]
  }, [_c('text', {
    ...
    staticClass: ["chinese"]
  }, [_vm._v(_vm._s(_vm.jisuanStr))])]), _c('div', {
    staticClass: ["msgBox"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("单价")]), _c('div', {
    ...
    staticClass: ["msgNum"]
  }, [_vm._v("￥" + _vm._s(_vm.minPrice))]), _c('text', {
    staticClass: ["chinese"]
  }, [_vm._v("/小时")])])]), _c('div', {
    staticClass: ["msgBox"]
  }, [_c('text', {
    ...
    staticClass: ["msgNum"]
  }, [_vm._v("￥" + _vm._s(_vm.totalPrice))])])]) : _vm._e(), (_vm.selectEnd !== 9999) ? _c('div', {
    staticClass: ["submit-bottom"]
  }, [_c('div', {
    staticClass: ["submitLeft"]
  }, [_c('text', {
    staticClass: ["submitSumText"]
  }, [_vm._v("合计: ")]), _c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v("¥")]), _c('text', {
    staticClass: ["submitNum"]
  }, [_vm._v(_vm._s(_vm.totalPrice))])]), _c('text', {
