...
exports.default = {
  ...
  created: function created() {
    ...
    Stack.onmessage = function (event) {
      _this.getMeetingRoomListByUserId();
    };
    this.getMeetingRoomListByUserId();
  },

  methods: {
    goDetail: function goDetail(id) {
      var jumpPage = 'views/meetingRoom/roomInfo.js?id=' + id;
      var url = _global2.default.getUrl(weex.config.bundleUrl, jumpPage);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    getMeetingRoomListByUserId: function getMeetingRoomListByUserId() {
      var _this2 = this;
      ...
      _api2.default.getMeetingRoomListByUserId(params, function (ret) {
        toast.close();
        //上拉复位
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.meetingRoomList) {
            if (_this2.index == 1) {
              _this2.meetingRoomList = ret.body.meetingRoomList;
            } else {
              _this2.meetingRoomList = _this2.meetingRoomList.concat(ret.body.meetingRoomList);
            }
          }
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["list"]
  }, [(_vm.meetingRoomList.length === 0) ? _c('myDefault', {
    attrs: {
      "type": "noData"
    },
    on: {
  ...
  }), _vm._l((_vm.meetingRoomList), function(item, index) {
    return _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      staticClass: ["center_right_area"]
    }, [_vm._v("面积" + _vm._s(item.area) + "㎡  座位" + _vm._s(item.meetingRoomNum) + "人")]), _c('text', {
      staticClass: ["center_right_address"]
    }, [_vm._v(_vm._s(item.address))]), _c('div', {
      staticClass: ["center_right_time"]
    }, [_c('text', {
      staticClass: ["time_date"]
    }, [_vm._v("￥" + _vm._s(item.unitPrice - 0 > 0 ? _vm.returnFloat(item.unitPrice) : "0.00") + "/小时")])])])])])])
  })], 2)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/meetingRoomList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7b170fec"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _roomList = __webpack_require__(479);
...
exports.default = {
  ...
  components: {
    ...
    roomList: _roomList2.default
  },
  data: function data() {
    return {
      xsj: (0, _base64MeetingRoom.xsj)(),
      tabs: [{
        title: '全部商铺',
        tabIndex: 0
      }, {
  ...
  methods: {
    ...
    goPicker: function goPicker(tabIndex) {
      var _this2 = this;

      if (tabIndex == 0) {
        var params = { "options": ["商铺1", "商铺2", "商铺3", "商铺4", "全部商铺"] };
        normalPicker.openDialog(params, function (src) {
          _this2.postResult = src;
        });
      } else if (tabIndex == 1) {
        var params = { "options": ["价格1", "价格2", "价格3", "价格4", "全部价格"] };
        normalPicker.openDialog(params, function (src) {
          _this2.postResult = src;
        });
      } else if (tabIndex == 2) {
        var params = { "options": ["座位1", "座位2", "座位3", "座位4", "全部座位"] };
        normalPicker.openDialog(params, function (src) {
          _this2.postResult = src;
        });
      }
    ...
    myOrder: function myOrder() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/meetingRoom/orderList.js');
      navigator.push({
        url: url,
        animated: 'true'
      });
      return;
      toast.showErrorMessage('订单');
    }
  }
};
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/roomList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-27054609"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
