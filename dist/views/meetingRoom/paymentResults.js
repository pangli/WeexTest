...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/paymentResults.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3e41e9c8"
...
module.exports = {
  ...
  "order_status_img_box": {
    "width": "168",
    "flexDirection": "row",
    "justifyContent": "center",
    "alignItems": "center"
  },
  "order_status_text_box": {
    "paddingTop": "60"
  },
  "order_status_title": {
    "color": "#FFFFFF",
  ...
  "cancel": {
    ...
    "borderRadius": "5",
    "borderTopWidth": "1",
    "borderTopColor": "rgb(0,189,255)",
    "borderBottomWidth": "1",
    "borderBottomColor": "rgb(0,189,255)",
    "borderLeftWidth": "1",
    "borderLeftColor": "rgb(0,189,255)",
    "borderRightWidth": "1",
    "borderRightColor": "rgb(0,189,255)",
...
exports.default = {
  data: function data() {
    ...
    return _ref = {
      weChatImg: (0, _base64MeetingRoom.weChatImg)(),
      choosePay: true,
      choosePayImg: (0, _base64MeetingRoom.choosePay)()
    }, _defineProperty(_ref, 'weChatImg', (0, _base64MeetingRoom.weChatImg)()), _defineProperty(_ref, 'alipayImg', (0, _base64MeetingRoom.alipayImg)()), _defineProperty(_ref, 'payResult', (0, _base64MeetingRoom.payResult)()), _defineProperty(_ref, 'overTime', (0, _base64MeetingRoom.overTime)()), _defineProperty(_ref, 'payEd', (0, _base64MeetingRoom.payEd)()), _defineProperty(_ref, 'tuikuan', (0, _base64MeetingRoom.tuikuan)()), _defineProperty(_ref, 'payResultTimeIcon', (0, _base64MeetingRoom.payResultTimeIcon)()), _defineProperty(_ref, 'result', '123'), _defineProperty(_ref, 'lastPayTime', ''), _defineProperty(_ref, 'statusIcon', ""), _defineProperty(_ref, 'orderId', ''), _defineProperty(_ref, 'orderNo', ''), _defineProperty(_ref, 'actId', ''), _defineProperty(_ref, 'status', ''), _defineProperty(_ref, 'choosePay', '0'), _defineProperty(_ref, 'icon', _icon.icon), _defineProperty(_ref, 'receiptStatus', 0), _defineProperty(_ref, 'invoiceStatus', false), _defineProperty(_ref, 'receiptSucTime', null), _defineProperty(_ref, 'receiptCreateTime', null), _defineProperty(_ref, 'courierService', ''), _defineProperty(_ref, 'courierNumber', ''), _ref;
  },
  ...
  created: function created() {
    ...
    // 判断是否开发票成功
    var invoiceStatus = new BroadcastChannel('invoiceStatus');
    invoiceStatus.onmessage = function (event) {
  ...
  methods: {
    ...
    goPage: function goPage(path) {
      ...
      var price = this.orderInfo.payAmount;
      var orderNo = this.orderInfo.orderNo;
      navigator.push({
        url: url + '?price=' + price + '&orderNo=' + orderNo,
        animated: 'true'
      });
    },
    ...
    getParams: function getParams() {
      ...
      this.getMeetingOrderDetailById();
    },
    getMeetingOrderDetailById: function getMeetingOrderDetailById() {
      var self = this;
      toast.showLoadingMessage('加载中...');

      _api2.default.getMeetingOrderDetailById({
        ...
        if (ret.res.code == '10000' && ret.body) {
          self.receiptStatus = ret.body.receiptStatus;
          if (ret.body.receiptCreateTime) {
            self.receiptCreateTime = _global2.default.formatTime(ret.body.receiptCreateTime, '/', 'yyyymmdd hhmm');
          }
          if (ret.body.receiptSucTime) {
            self.receiptSucTime = _global2.default.formatTime(ret.body.receiptSucTime, '/', 'yyyymmdd hhmm');
          }
          // 快递公司
          if (ret.body.courierService) {
            self.courierService = ret.body.courierService;
          }
          // 快递单号
          if (ret.body.courierNumber) {
            self.courierNumber = ret.body.courierNumber;
          }
          self.result = ret.body.order;
          self.orderInfo = ret.body.order;
          var date = _global2.default.formatTime(self.result.lastPayTime - Date.parse(new Date()), '-', 's');
          self.iconPic(self.result.status);
    ...
    leftTimer: function leftTimer(leftTime) {
      ...
      if (myTime >= 0) {
        //days + "天" + hours + "小时" +
        this.lastPayTime = minutes + "分" + seconds + "秒";
        myTime = myTime - 1;
        var timeout = setTimeout(function () {
          _this2.leftTimer(myTime);
        }, 1000);
      }
    },
    ...
    iconPic: function iconPic(value) {
      var self = this;
      if (value == 0) {
        self.statusIcon = self.payResult;
      } else if (value == 2) {
        self.statusIcon = self.payEd;
      } else if (value == 3) {
        self.statusIcon = self.overTime;
      } else if (value == 4) {
        self.statusIcon = self.tuikuan;
      } else if (value == 5) {
        self.statusIcon = self.payEd;
      }
    },
      ...
      _api2.default.getOrderStatusByOrderNo(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.status == 2) {
            var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/meetingRoom/roomOrderDetails.js' + '?orderNo=' + _this4.orderInfo.orderNo + "&comeFrom=1");
            navigator.push({
              url: url,
              animated: 'true'
            });
    ...
    cancelMeetingOrder: function cancelMeetingOrder() {
      var _this5 = this;

      _api2.default.cancelMeetingOrder({
        "orderNo": param.orderNo
      }, function (res) {
        if (res.res.code === 10000) {
          var Steve = new BroadcastChannel('refresh');
          Steve.postMessage(123);
          _this5.goBack();
        }
      });
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["list_contener"]
  }, [_c('div', [_c('div', {
    staticClass: ["order_status_box"]
  }, [_c('div', {
    staticClass: ["order_status_img_box"]
  }, [_c('image', {
    staticStyle: {
      width: "88px",
      height: "88px"
    ...
    staticClass: ["order_status_text_box"]
  }, [_c('text', {
    staticClass: ["order_status_title"]
  }, [_vm._v(_vm._s(_vm._f("numToText")(_vm.result.status)))]), _c('text', {
    staticClass: ["order_status_hint"]
  }, [_vm._v(_vm._s(_vm._f("tishi")(_vm.result.status)))])])])]), _c('div', [_c('div', {
    staticClass: ["list_box"]
  }, [_c('div', {
    staticClass: ["list_box_top"]
  }, [_c('div', {
    staticClass: ["left_title_box"]
  }, [_c('image', {
    staticClass: ["left_title_icon"],
    staticStyle: {
      width: "28px",
      height: "28px"
    },
    attrs: {
      "src": _vm.payResultTimeIcon
    }
  }), _c('text', {
    ...
    staticClass: ["list_detail_title"]
  }, [_vm._v(_vm._s(_vm.result.marketName) + "——" + _vm._s(_vm.result.meetingRoomName))]), (!_vm.result.status) ? _c('text', {
    staticClass: ["cancel"],
    on: {
      "click": _vm.cancelMeetingOrder
    }
  }, [_vm._v("取消")]) : _vm._e()]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("面积" + _vm._s(_vm.result.area) + "m²")]), _c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("座位" + _vm._s(_vm.result.meetingRoomNum) + "人")])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("会议地址")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.result.address))])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("参会时间")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.result.orderDate))])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("预定人")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.result.userName))])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("联系电话")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.result.phone))])])]), _c('div', {
    staticClass: ["list_box_bottom"]
  }, [_c('div', {
    staticClass: ["total_box"]
  }, [_c('text', {
    staticClass: ["total_title"]
  }, [_vm._v("共" + _vm._s(_vm.result.meetingPayTime) + "小时")])]), (_vm.result.status === 0) ? _c('div', {
    staticClass: ["time_box"]
  }, [_c('text', {
    staticClass: ["time_title"]
  }, [_vm._v("剩余支付时间：")]), _c('text', {
    staticClass: ["time_last"]
  }, [_vm._v(_vm._s(_vm.lastPayTime))])]) : _vm._e()])])]), _c('div', [(_vm.receiptStatus == 0 && _vm.result.status == 5) ? _c('div', {
    staticClass: ["list_box", "invoice"],
    on: {
      "click": function($event) {
        _vm.goPage('views/invoice/invoiceApplication.js')
      }
    }
  }, [_c('text', {
    staticClass: ["invoice_text"]
  }, [_vm._v("申请发票")])]) : _vm._e(), (_vm.invoiceStatus || _vm.receiptStatus != 0) ? _c('div', {
    staticClass: ["const"]
  }, [_vm._m(0), (_vm.receiptCreateTime) ? _c('div', {
    staticClass: ["jindu"]
  }, [_vm._m(1), _c('div', {
    staticClass: ["jinduright"]
  }, [_c('text', {
    staticClass: ["status"]
  }, [_vm._v("发票申请已提交")]), _c('text', {
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm.receiptCreateTime))])])]) : _vm._e(), (_vm.receiptCreateTime) ? _c('div', {
    staticClass: ["jindu"]
  }, [_c('div', {
    staticClass: ["jinduleft"]
  }, [_c('div', {
    staticClass: ["white"]
  }), (_vm.receiptSucTime) ? _c('div', {
    staticClass: ["blueBox"]
  }) : _vm._e()]), _c('div', {
    staticClass: ["jinduright"]
  }, [_c('text', {
    staticClass: ["status"]
  }, [_vm._v("发票申请处理中")]), _c('text', {
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm.receiptCreateTime))])])]) : _vm._e(), (_vm.receiptSucTime) ? _c('div', {
    staticClass: ["jindu"]
  }, [_vm._m(2), _c('div', {
    staticClass: ["jinduright"]
  }, [_c('text', {
    staticClass: ["status"]
  }, [_vm._v("发票申请成功")]), _c('text', {
    staticClass: ["invoiceStatus"]
  }, [_vm._v("快递公司：" + _vm._s(_vm.courierService) + "  快递单号:" + _vm._s(_vm.courierNumber))]), _c('text', {
    staticClass: ["jinduDate"]
  }, [_vm._v(_vm._s(_vm.receiptSucTime))])])]) : _vm._e()]) : _vm._e()]), (_vm.result.status === 0) ? _c('div', [_c('div', {
    staticClass: ["pay_box"]
  }, [_c('text', {
  ...
  }) : _vm._e()])])])]) : _vm._e()]), (_vm.result.status === 0) ? _c('div', {
    staticClass: ["bottom_box"]
  }, [_c('div', {
    staticClass: ["ask_box"]
  }, [_c('text', {
    staticClass: ["ask_title"]
  }, [_vm._v("￥" + _vm._s(_vm.result.payAmount))])]), _c('div', {
    staticClass: ["apply_box"]
  }, [_c('text', {
    staticClass: ["apply_title"],
    on: {
      "click": function($event) {
        _vm.getActivePayOrder()
      }
    }
  }, [_vm._v("确定支付")])])]) : _vm._e()], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["activity_title"]
  }, [_c('div', {
    staticClass: ["activity_title_left"]
  }, [_c('text', [_vm._v("发票申请进度")])])])
