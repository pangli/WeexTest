...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/payCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ef0479d6"
...
var orderNo = _global2.default.getParams(weex.config.bundleUrl).orderNo;
      ...
      _api2.default.getOrderStatusByOrderNo({
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.status == 2) {
            var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/meetingRoom/roomOrderDetails.js' + '?orderNo=' + _this3.orderInfo.orderNo + "&comeFrom=" + '2');
            navigator.push({
              url: url,
              animated: 'true'
            });
