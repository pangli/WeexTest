...
/* styles */
__vue_styles__.push(__webpack_require__(469)
)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/confirmInfo.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3d6abf06"
...
exports.default = {
  data: function data() {
    return {
      ...
      expiryTime: '',
      metingRoom: '',
      weexParams: weexParams,
      param: '',
      lists: [],
      showList: false,
      listsLength: 0,
      activeDiscountMode: '1',
      activeAmountDiscount: 0,
      totalPrice: 0,
      bondItemId: ''
    };
  },
  ...
  created: function created() {
    ...
    this.param = _global2.default.getParams(weex.config.bundleUrl);
    this.weexParams = weex.config.params;
  ...
  methods: {
    ...
    getMeetingRoomById: function getMeetingRoomById() {
      ...
      _api2.default.getMeetingRoomById({
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.metingRoom) {
            _this2.metingRoom = ret.body.metingRoom;
          } else {
    ...
    getMbBondListByUserId: function getMbBondListByUserId() {
      ...
      _api2.default.getMbBondListByUserId({
        ...
        "type": '1',
        "payAmount": param.totalPrice
      }, function (res) {
        console.log(res);
        _this3.$emit('close');
        if (res.res.code === 10000) {
          _this3.lists = res.body.mbBondItemList;
          if (res.body.mbBondItemList.length !== 0) {
            var mbBondItemList = res.body.mbBondItemList;
            for (var i = mbBondItemList.length; i--;) {
              if (mbBondItemList[i].itemIsAvailable) {
                _this3.listsLength = _this3.listsLength + 1;
              }
            }
          }
        }
    ...
    confirmPay: function confirmPay() {
      var self = JSON.parse(decodeURI(param.timeList));
      var beginTime = self[param.selectStart].time;
      var endTime = self[param.selectEnd].time;
      var payDate = self[param.selectStart].date;
      var payTime = ((param.selectEnd - param.selectStart) / 2).toFixed(1);
      ...
      var params = {
        ...
        "bondItemAmount": param.totalPrice - this.totalPrice
      };
      if (this.bondItemId !== '') {
        _BroadcastChannel2.default.coupon('refresh');
      }
      toast.showLoadingMessage("正在创建订单...");
      _api2.default.insertMeetingOrder(params, function (ret) {
        toast.close();
        if (!ret.res) {
          toast.showErrorMessage('服务异常');
          return;
        ...
        if (ret.res.code == '10000' && ret.body) {
          var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/meetingRoom/payCenter.js' + '?orderNo=' + ret.body.orderNo);
          navigator.push({
            url: url,
            animated: 'true'
          });
        } else {
          toast.showMessage(ret.res.msg, 2);
        }
      });
    },
    activeCoupon: function activeCoupon(list) {
      if (list.itemIsAvailable) {
        this.activeDiscountMode = list.discountMode;
        this.activeAmountDiscount = list.amountDiscount;
        this.bondItemId = list.id;
        if (list.discountMode == '1') {
          this.totalPrice = _global2.default.accSubtr(param.totalPrice, list.amountDiscount);
        } else {
          console.log(Number(param.totalPrice - param.totalPrice * list.amountDiscount / 100) + '    ' + Number(list.maxDiscountAmount));
          if (Number(param.totalPrice - param.totalPrice * list.amountDiscount / 100) < Number(list.maxDiscountAmount)) {
            this.totalPrice = (param.totalPrice * list.amountDiscount / 100).toFixed(2);
          } else {
            this.totalPrice = param.totalPrice - list.maxDiscountAmount;
          }
        }
        this.showList = false;
      }
    },
    noneCoupon: function noneCoupon() {
      this.showList = false;
      this.activeAmountDiscount = 0;
      this.bondItemId = '';
      this.totalPrice = param.totalPrice;
    }
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.metingRoom.meetingRoomName))])]), _c('div', {
    staticClass: ["adress"]
  }, [_c('text', {
    staticClass: ["adress-text"]
  }, [_vm._v(_vm._s(_vm.metingRoom.address))])]), _c('div', {
    staticClass: ["area"]
  }, [_c('text', {
    staticClass: ["area-text"]
  }, [_vm._v("面积" + _vm._s(_vm.metingRoom.area) + "㎡    座位" + _vm._s(_vm.metingRoom.meetingRoomNum) + "人")])])]), _c('div', {
    staticClass: ["userInfo-item"]
  }, [_vm._m(0), _c('div', {
    staticClass: ["item-right"]
  }, [_c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.weexParams.userTrueName))])])]), _c('div', {
    staticClass: ["userInfo-item"]
  }, [_vm._m(1), _c('div', {
    staticClass: ["item-right"]
  }, [_c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.weexParams.phone))])])]), _c('div', {
    staticClass: ["userInfo-List"]
  }, [_c('div', {
    staticClass: ["userInfo-item"]
  }, [_vm._m(2), _c('div', {
    staticClass: ["item-right"]
    ...
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(decodeURI(_vm.param.jisuanStr)))])])]), _c('div', {
    staticClass: ["userInfo-item"]
  }, [_vm._m(3), _c('div', {
    staticClass: ["item-right"]
  }, [_c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v("¥" + _vm._s(_vm.param.minPrice))]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v("/小时")])])]), _c('div', {
    staticClass: ["userInfo-item"],
    on: {
  ...
  }, [_vm._m(4), (_vm.activeAmountDiscount === 0) ? _c('div', {
    staticClass: ["item-right"]
  }, [(_vm.listsLength === 0) ? _c('text', {
    staticClass: ["none"]
  }, [_vm._v("无可用")]) : _c('text', {
    staticClass: ["amount"]
  }, [_vm._v(_vm._s(_vm.listsLength) + "张可用")]), _c('image', {
    staticClass: ["yjt"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  })]) : _c('div', {
    staticClass: ["item-right"]
  }, [(_vm.activeDiscountMode == '1') ? _c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v("-¥" + _vm._s(_vm.activeAmountDiscount))]) : _c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v(_vm._s(parseInt(_vm.activeAmountDiscount / 10)) + "折")]), _c('image', {
    staticClass: ["yjt"],
    attrs: {
      "src": "data:image/png;base64,"
    }
    ...
    staticClass: ["right-text"]
  }, [_vm._v("¥" + _vm._s(_vm.param.totalPrice))])]), _c('div', {
    staticClass: ["moneyBox"]
  }, [_c('text', {
    staticClass: ["left-text"]
  }, [_vm._v("已优惠")]), (_vm.activeDiscountMode == '1') ? _c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v("-¥" + _vm._s(_vm.activeAmountDiscount))]) : _c('text', {
    staticClass: ["msgNum"]
  }, [_vm._v("-¥" + _vm._s(_vm.param.totalPrice - this.totalPrice))])])])]), _c('div', {
  ...
  }, [_vm._v("提交订单")])]), (_vm.showList) ? _c('div', {
    staticClass: ["bg"],
    on: {
      "click": function($event) {
        _vm.showList = false
    ...
    staticClass: ["couponListHeader"]
  }, [_c('div', {
    staticClass: ["couponListHeaderLeft"]
  }), _c('text', {
    staticClass: ["couponListHeaderTitle"]
  }, [_vm._v("可用优惠券")]), _c('text', {
    staticClass: ["couponListHeaderRight"],
    on: {
      "click": function($event) {
        _vm.showList = false
      }
    ...
    staticClass: ["noneCoupon"],
    on: {
      "click": _vm.noneCoupon
    }
  }, [_c('text', {
    staticClass: ["noneCouponText"]
  }, [_vm._v("不使用优惠券")]), _c('div', {
    staticClass: ["noneCouponBtn"]
  })])])]) : _vm._e(), (_vm.showList) ? _c('list', {
    staticClass: ["list"]
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.activeCoupon(list)
        }
      }
    }, [_c('div', {
      class: ['cellLeft', list.itemIsAvailable ? '' : 'opacity']
      ...
      class: ['cellRight', list.itemIsAvailable ? '' : 'opacity']
    }, [_c('div', {
      ...
      staticClass: ["time"]
    }, [_vm._v(_vm._s(_vm._f("date")(list.beginTime)) + "-" + _vm._s(_vm._f("date")(list.endTime)))])])])])])
  })) : _vm._e()], 1)
