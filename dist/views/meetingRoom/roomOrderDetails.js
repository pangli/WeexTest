...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/meetingRoom/roomOrderDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-81166272"
...
exports.default = {
  ...
  methods: {
    ...
    goPage: function goPage(path) {
      ...
      var price = this.orderInfo.payAmount || '10';
    ...
    getOrderInfo: function getOrderInfo() {
      var self = this;
      toast.showLoadingMessage("正在获取订单详情...");
      var param = _global2.default.getParams(weex.config.bundleUrl);
      var id = param.orderNo ? param.orderNo : weexParams.id;
      var params = {
        "orderNo": id
      };
      _api2.default.getMeetingOrderDetailById(params, function (ret) {
        toast.close();
        if (!ret.res) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          ...
          if (ret.body.order) {
            ...
            self.marketId = ret.body.order.marketId;
            self.rules = ret.body.rules;
            self.isRefund = ret.body.isRefund;
            self.getQRCode();
          } else {
    ...
    refund: function refund() {
      ...
      //退款
      var self = this;
      toast.showLoadingMessage("正在退款...");
      var param = _global2.default.getParams(weex.config.bundleUrl);
      var id = param.orderNo ? param.orderNo : weexParams.id;
      var params = {
        "orderNo": id
      };
      _api2.default.getOrderRefundRequest(params, function (ret) {
        toast.close();
        if (!ret.res) {
          toast.showErrorMessage('服务异常');
          return;
  ...
  filters: {
    refund: function refund(orderInfo) {
      if (orderInfo.refundSucTime) {
        return '退款成功';
      } else if (orderInfo.refundUpdTime) {
        return '退款处理中';
      } else if (orderInfo.refundTime) {
        return '退款申请已提交';
      }
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm.icon.succIcon
    }
  })]), _c('div', {
    staticClass: ["order_status_text_box"]
  }, [(_vm.orderInfo.refundTime) ? _c('text', {
    staticClass: ["order_status_title"]
  }, [_vm._v(_vm._s(_vm._f("refund")(_vm.orderInfo)))]) : _c('text', {
    staticClass: ["order_status_title"]
  }, [_vm._v("预定成功")]), _c('text', {
    staticClass: ["order_status_hint"]
  }, [_vm._v("请确保您在规定时间内使用会议室")])])])]), (!_vm.orderInfo.verificationType && !_vm.orderInfo.refundTime && _vm.orderInfo.status !== 5) ? _c('div', [_c('div', {
    staticClass: ["list_box_scancode"]
  }, [_vm._m(0), _c('div', {
    staticClass: ["img_box"]
  }, [_c('image', {
    staticStyle: {
    ...
    staticClass: ["right_title_box"]
  }, [(_vm.isRefund && !_vm.invoiceStatus && _vm.receiptStatus == 0) ? _c('text', {
    staticClass: ["right_btn"],
    on: {
      "click": _vm.refund
    }
  }, [_vm._v("退款")]) : _vm._e()])]), _c('div', {
    staticClass: ["list_box_center"]
  }, [_c('text', {
    staticClass: ["list_detail_title"]
  }, [_vm._v(_vm._s(_vm.orderInfo.meetingRoomName))]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("面积 " + _vm._s(_vm.orderInfo.area) + "m²")]), _vm._v("    \n            "), _c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("座位 " + _vm._s(_vm.orderInfo.meetingRoomNum) + " 人")])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("会议地址")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.orderInfo.address))])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("参会时间")]), _c('text', {
    ...
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.orderInfo.phone))])])]), _c('div', {
    staticClass: ["list_box_bottom"]
  }, [_c('div', {
    staticClass: ["time_box"]
  }, [_c('text', {
    staticClass: ["total_title"]
  }, [_vm._v("共" + _vm._s(_vm.orderInfo.meetingPayTime) + "小时")])]), _c('div', {
    staticClass: ["total_box"]
  }, [_c('text', {
    staticClass: ["total_title"]
  }, [_vm._v("总计：")]), _c('text', {
    staticClass: ["total_price"]
  }, [_vm._v(_vm._s(_vm.orderInfo.payAmount))])])])])]), _c('div', [_c('div', {
    staticClass: ["list_box"]
  }, [_c('div', {
    staticClass: ["list_box_center"]
  }, [_vm._m(1), _vm._l((_vm.rules), function(item, index) {
    return _c('div', {
      staticClass: ["list_detail_box"]
    }, [(index == 0) ? _c('text', {
      staticClass: ["list_key"]
    }, [_vm._v("退款规则")]) : _vm._e(), (index != 0) ? _c('text', {
      staticClass: ["list_key"]
    }) : _vm._e(), _c('text', {
      staticClass: ["list_val"]
    }, [_vm._v(_vm._s(index + 1) + ".截至会议室使用前开始前" + _vm._s(item.ruleTime) + "天取消订单，退还该订单总金额的" + _vm._s(item.refundRatio) + "%")])])
  })], 2)])])])], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["img_box"]
  }, [_c('div', {
    staticClass: ["security_box"]
  }, [_c('text', {
    staticClass: ["scancode_key"]
  }, [_vm._v("会议室二维码")])])])
