...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/evaluate/evaluate.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-96458d40"
...
module.exports = {
  ...
  "labelBoxActive": {
    ...
    "borderLeftWidth": "1",
    "borderLeftColor": "rgba(0,189,255,0.1)",
    "borderTopWidth": "1",
    "borderTopColor": "rgba(0,189,255,0.1)",
    "borderRightWidth": "1",
    "borderRightColor": "rgba(0,189,255,0.1)",
    "borderBottomWidth": "1",
...
// "evaluateItemType" //1产品2服务
// "evaluateGroup" //几颗星下的标签
// "evaluateType" //1非此即彼2五星3标签
...
exports.default = {
  ...
  created: function created() {
    ...
    if (_global2.default.getParams(weex.config.bundleUrl).length !== 0) {
      this.beEvaluatedId = _global2.default.getParams(weex.config.bundleUrl).id;
      this.marketId = _global2.default.getParams(weex.config.bundleUrl).marketId;
      this.come = Number(_global2.default.getParams(weex.config.bundleUrl).come);
    }
    this.getEvaluateList(); //获取评分列表
  ...
  methods: {
    ...
    getEvaluateList: function getEvaluateList() {
      ...
      _api2.default.getEvaluateList({
        "templateType": this.come,
        "marketId": this.marketId
      }, function (res) {
        if (res.res.code === 10000) {
          _this2.id = res.body.template.id;
          _this2.openProject = res.body.template.openProject;
          _this2.projectTitle = res.body.template.projectTitle;
          _this2.openComment = res.body.template.openComment;
          _this2.detailsOutputList = res.body.template.detailsOutputList;
          if (!_this2.openComment || !_this2.openProject) {
            _this2.cantEvaluate = '请选取服务评价';
          } else {
            _this2.cantEvaluate = '请选取' + _this2.projectTitle;
          }
        }
      });
    },

    changeLabel: function changeLabel(id) {
      var detailsOutputList = this.detailsOutputList;
    ...
    upload: function upload() {
      ...
      try {
        for (var _iterator = detailsOutputList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var params = {
        ...
        "marketId": this.marketId,
        "evaluateTemplateId": this.id,
        "userId": weexParams.userId,
        "beEvaluatedId": this.beEvaluatedId,
        "evaluateType": this.come,
        "templateList": templateList,
        "userName": weexParams.userName,
        "referenceNo": _global2.default.getParams(weex.config.bundleUrl).referenceNo
      };
      if (this.activeComment) {
        params.projectComment = this.activeComment;
      }
      if (this.serviceComment) {
        params.comment = this.serviceComment;
      }
      switch (this.come) {
        case 2:
          params.referenceName = '物业报修';
          break;
        case 4:
          params.referenceName = '投诉建议';
          break;
        case 5:
          params.referenceName = '访客预约';
          break;
        default:
          params.referenceName = decodeURI(_global2.default.getParams(weex.config.bundleUrl).referenceName);
      }
      _api2.default.saveEvaluate(params, function (ret) {
        toast.close();
        if (ret.res.code === 10000) {
          var Steve = new BroadcastChannel('refresh');
          Steve.postMessage(true);
          _BroadcastChannel2.default.evaluateSend('refresh');
          navigator.pop();
        } else {
      ...
      if (this.come == 2) {
        ...
        if (this.activeComment) {
          ibpParams.evaluate.projectComment = this.activeComment;
        }
        if (this.serviceComment) {
          ibpParams.evaluate.serviceComment = this.serviceComment;
        }
        if (this.openProject) {
          ibpParams.evaluate.projectTitle = this.projectTitle;
        }
        _api2.default.IBPsaveEvaluate(ibpParams, function (res) {
          console.log(res);
        });
      }
    }
  ...
  filters: {
    starText: function starText(value) {
      switch (value) {
        case 1:
          return '非常差';
          break;
  ...
  watch: {
    serviceEvaluateStar: function serviceEvaluateStar() {
      ...
      try {
        for (var _iterator2 = detailsOutputList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    satisfaction: function satisfaction() {
      ...
      try {
        for (var _iterator3 = detailsOutputList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.openProject) ? _c('div', {
    staticClass: ["activeEvaluate"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v(_vm._s(_vm.projectTitle))]), _c('div', {
    staticClass: ["satisfactionArticle"]
  }, [_c('div', {
    staticClass: ["noBox"],
    on: {
  ...
  }, [(_vm.satisfaction === 1) ? _c('image', {
    staticClass: ["likeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _c('image', {
    staticClass: ["likeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
    class: ['likeText', _vm.satisfaction === 1 ? 'likeActive' : '']
  }, [_vm._v("不满意")])]), _c('div', {
    staticClass: ["yesBox"],
    on: {
      "click": function($event) {
  ...
  }, [(_vm.satisfaction === 2) ? _c('image', {
    staticClass: ["likeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _c('image', {
    staticClass: ["likeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
    class: ['likeText', _vm.satisfaction === 2 ? 'likeActive' : '']
  }, [_vm._v("满意")])])]), _c('div', {
    staticClass: ["labelBoxArticle"]
  }, _vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 3 && item.evaluateItemType == 1 && (item.evaluateGroup == _vm.satisfaction || item.evaluateGroup == 0) && _vm.satisfaction !== 0) ? _c('text', {
      class: ['labelBoxText', item.number ? 'labelBoxActive' : ''],
      on: {
        "click": function($event) {
          _vm.changeLabel(item.id)
        }
      }
    }, [_vm._v(_vm._s(item.items))]) : _vm._e()
  })), (_vm.openComment) ? _c('textarea', {
    staticClass: ["details"],
    attrs: {
      "placeholder": "请输入评价，不超过100个字",
      "maxlength": "100",
      "value": (_vm.activeComment)
    },
    on: {
      "input": function($event) {
        _vm.activeComment = $event.target.attr.value
      }
    }
  }) : _vm._e()]) : _vm._e(), _c('div', {
    staticClass: ["serviceEvaluate"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("服务评价")]), _c('div', {
    staticClass: ["starBox"]
  }, [_vm._l((_vm.serviceEvaluateStar), function(i) {
    return _c('image', {
      staticClass: ["starIcon"],
      attrs: {
        "src": "data:image/png;base64,"
      },
      on: {
        "click": function($event) {
          _vm.serviceEvaluateStar = i
        }
      }
    })
  }), _vm._l((5 - _vm.serviceEvaluateStar), function(i) {
    return _c('image', {
      staticClass: ["starIcon"],
      attrs: {
        "src": "data:image/png;base64,"
      },
      on: {
        "click": function($event) {
          _vm.serviceEvaluateStar = i + _vm.serviceEvaluateStar
        }
      }
    })
  })], 2), _c('text', {
    staticClass: ["fiveStari"]
  }, [_vm._v(_vm._s(_vm._f("starText")(_vm.serviceEvaluateStar)))]), _c('div', {
    staticClass: ["labelBoxArticle"]
  }, _vm._l((_vm.detailsOutputList), function(item) {
    return (item.evaluateType === 3 && item.evaluateItemType == 2 && (item.evaluateGroup == _vm.serviceEvaluateStar || item.evaluateGroup == 0) && _vm.serviceEvaluateStar !== 0) ? _c('text', {
      class: ['labelBoxText', item.number ? 'labelBoxActive' : ''],
      on: {
        "click": function($event) {
          _vm.changeLabel(item.id)
    ...
    on: {
      "input": function($event) {
        _vm.serviceComment = $event.target.attr.value
      }
    }
  })])]), _c('div', {
    staticClass: ["bottomButton"]
  }, [(((_vm.openProject && _vm.satisfaction) || !_vm.openProject) && _vm.serviceEvaluateStar) ? _c('text', {
    ...
    staticClass: ["cantGo"]
  }, [_vm._v(_vm._s(_vm.cantEvaluate))])])], 1)
},staticRenderFns: []}
