...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/msgCenter/messageDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-20008db3"
...
exports.default = {
  ...
  filters: {
    formatTime: function formatTime(val) {
      return _global2.default.formatTime(new Date(val));
    }
  },
  data: function data() {
    return {
      ...
      msg: {
        // createTime: 0,
        // title: '系统升级',
        // img: 'http://www.xinhuanet.com/photo/2018-04/18/1122704373_15240653272481n.jpg',
        // message: '习近平主席将于4月12日考察上海万科各个园区！'
      },
      result: ''
    };
  },
  ...
  methods: {
    ...
    getMsgDetails: function getMsgDetails() {
      var _this2 = this;
      ...
      _api2.default.getMsgDetailById(params, function (ret) {
        _toast2.default.close();
        _this2.result = ret;
        ...
        if (ret.res.code == '10000' && ret.body) {
          var data = ret.body;
          if (data.msg) _this2.msg = data.msg;
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), (_vm.msg.message) ? _c('scroller', [_c('div', {
    staticClass: ["subTitle"]
  }, [_c('text', {
    staticClass: ["subTitle-text"]
  }, [_vm._v(_vm._s(_vm.msg.title))]), _c('text', {
    staticClass: ["subTitle-time"]
  }, [_vm._v(_vm._s(_vm._f("formatTime")(_vm.msg.createTime)))])]), (_vm.msg.img) ? _c('image', {
    staticClass: ["image"],
    attrs: {
      "src": _vm.msg.img
    }
    ...
    staticClass: ["text"]
  }, [_vm._v(_vm._s(_vm.msg.message))])])]) : (_vm.pageShow) ? _c('defaultView', {
    attrs: {
      "type": _vm.pageType
    },
    on: {
