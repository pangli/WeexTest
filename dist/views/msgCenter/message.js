...
module.exports = {
  ...
  "label-gray": {
    "backgroundColor": "rgb(210,217,220)"
  }
}
...
exports.default = {
  ...
  filters: {
    formatTime: function formatTime(val) {
      return val ? _global2.default.formatTime(new Date(val)) : '';
    },
    formatType: function formatType(val) {
      ...
      val += '';
      return val ? map[val] : map[this.type];
    }
  },
  data: function data() {
    return {
      ...
      pageType: 'noData',
      msgList0: [{
        "id": "6BC02ECF1ACA49198A9A4306B6DB5637",
        "createTime": 1527219526000,
        "isDrop": 0,
        "message": "物业报修单的状态更新为已派单，点击查看详情",
        "title": "物业报修处理进度",
        "isRead": 0,
        "contentType": 1,
        "msgType": 2,
        "options": "{\"ibp_user_id\":\"AC2A04DFDD344D81835C77C279C96965\",\"ibp_id\":\"BD505D505BBA4C3DA7226DE44D6B54AC\",\"ibp_repair_status\":2,\"ibp_notification_type\":2,\"type\":\"infomation\"}"
      }, {
        "id": "B10E95819B4246159B546CCC020D4D49",
        "createTime": 1527155796000,
        "isDrop": 0,
        "message": "《唐诗三百首》是一部流传很广的唐诗选集。唐朝（618年~907年）二百八十九年间，是中国诗歌发展的黄金时代，云蒸霞蔚，名家辈出，唐诗数量多达五万余首。孙琴安《唐诗选本六百种提要·自序》指出，“唐诗选本经大量散佚，至今尚存三百余种。当中最流行而家传户晓的，要算《唐诗三百首》。",
        "title": "《唐诗三百首》",
        "isRead": 1,
        "contentType": 2,
        "msgType": 0
  ...
  methods: {
    ...
    //   let path = 'views/msgCenter/messageDetails.js?id=' + id;
    //
    //   switch (options.ibp_notification_type) {
    //     case 1:
    //       path = 'views/onlineBill/billDetails.js?id=' + options.ibp_id;
    //       break;
    //     case 2:
    //       path = 'views/MyRevision/details.js?id=' + options.ibp_id;
    //       break;
    //     case 3:
    //       path = 'views/ComplaintOpinion/details.js?id=' + options.ibp_id;
    //       break;
    //     case 4:
    //       path = 'views/activity/activityDetail.js?id=' + options.ibp_id + '&actId=' + options.ibp_id;
    //       break;
    //     case 5:
    //       //if(options.ibp_status==1) path='views/myMessage/tenementStatus.js?tenementStatus=0';
    //       break;
    //     default:
    //       path = 'views/msgCenter/messageDetails.js?id=' + id;
    //   }
    //   // let url = configObj.getUrl(weex.config.bundleUrl, appUrl.split('dist/')[1]);
    //   let url = configObj.getUrl(weex.config.bundleUrl, path);
    //   navigator.push({
    //     url: url,
    //     animated: 'true'
    //   })
    // },
    goPage: function goPage(appUrl) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, appUrl.split('dist/')[1]);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    getMsgList: function getMsgList() {
      ...
      var params = {
        ...
        'pageSize': 10
        //this.result = params;
      };if (this.showToast) _toast2.default.showLoadingMessage("加载中…");
      _api2.default.getMsgByUserId(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          ...
          if (_this.pageNo == 1) _this.msgList = data.msgList;else _this.msgList = _this.msgList.concat(data.msgList);

          if (data.msgList.length < 10) _this.pageMore = false;

          // const $loading = this.$refs.loading;
          // if(this.msgList.length>9 || this.pageNo>1){
    ...
    loadmore: function loadmore() {
      if (this.msgList.length > 9 && this.pageMore) this.onloading(0);
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.msgList.length > 0) ? _c('list', {
    staticClass: ["panel"],
    attrs: {
      "loadmoreoffset": "50"
    },
    ...
    }, [_vm._v(_vm._s(_vm._f("formatType")(item.contentType)))])])]), _c('div', {
      staticClass: ["cell-right"]
    }, [_c('div', {
      staticClass: ["flex-dir-row"]
    }, [_c('text', {
      staticClass: ["t-color-666", "flex-1", "f-size-30"]
    }, [_vm._v(_vm._s(item.title))]), _c('text', {
      staticClass: ["t-color-999", "f-size-22"]
    }, [_vm._v(_vm._s(_vm._f("formatTime")(item.createTime)))])]), _c('div', {
      staticClass: ["flex-dir-row"]
    }, [_c('text', {
      staticClass: ["t-color-666", "f-size-26", "flex-1", "describe"]
    }, [_vm._v(_vm._s(item.message))])])]), _c('div', {
      staticClass: ["cell-line"]
    })])
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/msgCenter/message.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a5f45282"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _msgList = __webpack_require__(521);
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/msgList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-adceb8f6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
