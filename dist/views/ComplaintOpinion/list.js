...
var _ComplaintOpinionTitle = __webpack_require__(103);

var _ComplaintOpinionTitle2 = _interopRequireDefault(_ComplaintOpinionTitle);

var _ComplaintOpinionButtom = __webpack_require__(104);

var _ComplaintOpinionButtom2 = _interopRequireDefault(_ComplaintOpinionButtom);
...
exports.default = {
  ...
  methods: {
    goDetails: function goDetails(id) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/ComplaintOpinion/details.js?id=' + id);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    getComplaintListByUserId: function getComplaintListByUserId() {
      var _this2 = this;

      _api2.default.getComplaintListByUserId({
        ...
        _this2.$emit('close');
        if (ret.body) {
          var complaintList = ret.body.complaintList;
          for (var i = 0; i < complaintList.length; i++) {
            complaintList[i].createTime = _global2.default.formatTime(new Date(complaintList[i].createTime));
          }
          if (_this2.index === 1) {
            _this2.lists = complaintList;
          } else {
            _this2.lists = _this2.lists.concat(complaintList);
          }
        } else {
          toast.showMessage("获取列表失败！");
        }
      });
    },
  ...
  components: {
    ComplaintOpinionTitle: _ComplaintOpinionTitle2.default,
    ComplaintOpinionButtom: _ComplaintOpinionButtom2.default,
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/ComplaintOpinionTitle.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0899e332"
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/ComplaintOpinionButtom.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-07593a9c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.goDetails(list.comId)
        }
      }
    }, [_c('ComplaintOpinionTitle', {
      attrs: {
        "icon": _vm.dun,
        "status": list.status
      }
      ...
      staticClass: ["address"]
    }, [_vm._v(_vm._s(list.createTime))])]), _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("意见描述")]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(list.content))])])]), _c('ComplaintOpinionButtom', {
      attrs: {
        "list": list
      },
      on: {
        "refeshList": _vm.onrefresh
      }
    })], 1)
  })], 2)], 1)
},staticRenderFns: []}
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/ComplaintOpinion/list.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-54b27347"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _ComplaintOpinionList = __webpack_require__(190);

var _ComplaintOpinionList2 = _interopRequireDefault(_ComplaintOpinionList);
...
exports.default = {
  ...
  components: {
    ...
    ComplaintOpinionList: _ComplaintOpinionList2.default
  },
  data: function data() {
    return {
      tabs: [{
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/ComplaintOpinionList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6b2471a5"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("待处理")]) : _vm._e(), (_vm.status === 2) ? _c('text', {
    staticClass: ["rightBox"]
  }, [_vm._v("处理中")]) : _vm._e(), (_vm.status === 3) ? _c('text', {
    staticClass: ["rightBox", "four"]
  }, [_vm._v("已结束")]) : _vm._e(), (_vm.status === 4) ? _c('text', {
    staticClass: ["rightBox", "four"]
  }, [_vm._v("已取消")]) : _vm._e()])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
module.exports = {
  ...
  "dpj": {
    ...
    "fontSize": "24",
    "marginLeft": "20",
    "borderTopColor": "#f6be36",
    "borderLeftColor": "#f6be36",
    "borderRightColor": "#f6be36",
    "borderBottomColor": "#f6be36",
    "color": "#f6be36"
  },
  "ypj": {
    "width": "128",
...
exports.default = {
  ...
  methods: {
    postscript: function postscript() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/ComplaintOpinion/postscript.js?id=' + this.list.comId);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    evaluate: function evaluate() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/evaluate/evaluate.js?id=' + this.list.comId + '&come=4&marketId=' + this.list.marketId + '&referenceNo=' + this.list.complaintNo);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    viewEvaluation: function viewEvaluation() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/evaluate/viewEvaluation.js?id=' + this.list.comId + '&come=4&marketId=' + this.list.marketId + '&referenceNo=' + this.list.complaintNo);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    cancel: function cancel() {
      ...
      modal.confirm({
        ...
        if (value === '确定') {
          var weexParams = weex.config.params;
          _api2.default.updateComStatusById({
            "marketId": weexParams.marketId,
            "userId": weexParams.userId,
            "comId": _this.list.comId,
            "type": 1,
            "status": 3
          }, function (ret) {
            _this.refeshList();
    ...
    refeshList: function refeshList() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["rightBox"],
    on: {
      "click": _vm.postscript
    }
  }, [_vm._v("留言")]), (_vm.list.status === 3 && _vm.list.hasTemp && _vm.list.isEvaluate == 0) ? _c('text', {
    staticClass: ["rightBox"],
    on: {
      "click": _vm.evaluate
    }
  }, [_vm._v("评价")]) : _vm._e(), (_vm.list.status === 3 && _vm.list.hasTemp && _vm.list.isEvaluate) ? _c('text', {
    staticClass: ["rightBox"],
    on: {
      "click": _vm.viewEvaluation
    }
  }, [_vm._v("查看评价")]) : _vm._e(), (_vm.list.status === 1) ? _c('text', {
    staticClass: ["ypj"],
    on: {
      "click": _vm.cancel
    }
