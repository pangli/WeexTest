...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/ComplaintOpinion/details.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5ef901ae"
...
module.exports = {
  ...
  "white": {
    ...
    "backgroundColor": "#ffffff",
    "borderTopWidth": "10",
    "borderTopColor": "#1eb9ef",
    "borderLeftWidth": "10",
    "borderLeftColor": "#1eb9ef",
    "borderRightWidth": "10",
    "borderRightColor": "#1eb9ef",
    "borderBottomWidth": "10",
    "borderBottomColor": "#1eb9ef",
    "borderRadius": "30"
  },
  "blueBox": {
    "height": "120",
    "width": "10",
    "backgroundColor": "#1eb9ef"
  },
  "status": {
    "fontSize": "24",
    "color": "#1eb9ef",
...
exports.default = {
  ...
  methods: {
    ...
    getComplaintById: function getComplaintById() {
      var _this2 = this;

      var that = this;
      toast.showLoadingMessage("获取投诉中...");
      _api2.default.getComplaintById({
        comId: that.id
      }, function (ret) {
        toast.close();
        if (ret.body) {
          that.details = ret.body.complaint;
          _this2.comDetail = ret.body.comDetail;
          _this2.details.createTime = _global2.default.formatTime(new Date(ret.body.complaint.createTime));
          _this2.details.operationTime = _global2.default.formatTime(new Date(ret.body.complaint.operationTime));
          for (var key in ret.body.complaint.complaintImg) {
            _this2.imageList.push(ret.body.complaint.complaintImg[key]);
          }
          for (var key in ret.body.complaint.communicateOutputList) {
            _this2.details.communicateOutputList[key].createTime = _global2.default.formatTime(new Date(ret.body.complaint.communicateOutputList[key].createTime));
            if (ret.body.complaint.communicateOutputList[key].communicateImg) {
              for (var index in ret.body.complaint.communicateOutputList[key].communicateImg) {
                _this2.imageList.push(ret.body.complaint.communicateOutputList[key].communicateImg[index]);
              }
            }
          }
        } else {
          toast.showMessage("获取投诉失败！");
        }
      });
    },
    postscript: function postscript() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/ComplaintOpinion/postscript.js?id=' + this.id);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    imagePreview: function imagePreview(index) {
      ...
      for (var key in imageList) {
        params.push(imageList[key].imgPath);
      }
  ...
  filters: {
    ...
    statusString: function statusString(value) {
      if (value === 2) {
        return '处理中';
      } else {
        return '已结束';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), (_vm.details.tenant) ? _c('repairMsg', {
    attrs: {
      "label2": "所属公司",
      "label3": "提交时间",
      "label4": "意见描述",
      "date": _vm.details.tenant,
      "id": _vm.details.createTime,
      "details": _vm.details.content
    }
  }) : _c('repairMsg', {
    attrs: {
      "label3": "提交时间",
  ...
  }, [_vm._v(_vm._s(_vm.details.createTime))])])]), _vm._l((_vm.comDetail), function(item) {
    return (_vm.comDetail.length !== 0 && item.status !== 1) ? _c('div', {
      staticClass: ["jindu"]
    }, [_vm._m(1, true), _c('div', {
      staticClass: ["jinduright"]
    }, [_c('text', {
      staticClass: ["status"]
    }, [_vm._v(_vm._s(_vm._f("statusString")(item.status)))]), _c('text', {
      staticClass: ["jinduDate"]
    }, [_vm._v(_vm._s(_vm._f("date")(item.createTime)))])])]) : _vm._e()
  }), _c('div', {
    staticClass: ["border10"]
  }), (_vm.details.compResult) ? _c('div', {
    staticClass: ["title"]
  }, [_c('text', {
    staticClass: ["leftBox"]
  }, [_vm._v("结果反馈")])]) : _vm._e(), (_vm.details.compResult) ? _c('div', {
    staticClass: ["cell"]
  }, [_c('text', {
    staticClass: ["date"]
  }, [_vm._v(_vm._s(_vm.details.operationTime))]), _c('text', {
    staticClass: ["liuyan"]
  }, [_vm._v(_vm._s(_vm.details.compResult))])]) : _vm._e(), _c('div', {
    staticClass: ["border10"]
  }), _c('div', {
    staticClass: ["title"]
  }, [_c('text', {
  ...
  }, [_vm._v("留言")])]), _vm._l((_vm.details.communicateOutputList), function(item) {
    return _c('div', {
      staticClass: ["cell"]
    }, [_c('text', {
      staticClass: ["date"]
      ...
      staticClass: ["liuyan"]
    }, [_vm._v(_vm._s(item.communicateContent))])])
  }), _c('div', {
    staticClass: ["border10"]
  }), _c('repairTitle', {
    attrs: {
