...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/ComplaintOpinion/postscript.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-130e9658"
...
exports.default = {
  ...
  methods: {
    ...
    addComplaintCommunicate: function addComplaintCommunicate() {
      toast.showLoadingMessage("上传留言中...");
      _api2.default.addComplaintCommunicate({
        "marketId": weexParams.marketId,
        "userId": weexParams.userId,
        "communicateContent": this.miaoshu,
        "comId": this.id,
      ...
      if (this.photos.length === 0) {
        ...
        (0, _uploadService2.default)(params, function (ret) {
          if (ret.res && ret.returnJson && ret.returnJson.res && ret.returnJson.res.code == 10000 && ret.returnJson.body) {
            if (_this3.updatePic === '') {
              _this3.updatePic = ret.returnJson.body.imgId;
            } else {
              _this3.updatePic = _this3.updatePic + ',' + ret.returnJson.body.imgId;
            }
            _this3.count = _this3.count + 1;
            if (_this3.count >= _this3.photos.length) {
              _this3.addComplaintCommunicate();
            } else {
              _this3.uploadImage();
            }
          } else {
