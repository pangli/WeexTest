...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myOrder/orderDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7beff003"
...
exports.default = {
  ...
  methods: {
    ...
    confirmPay: function confirmPay() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/myOrder/orderResult.js');
      navigator.push({
        url: url,
        animated: 'true'
      });
      ...
      _api2.default.getUnpaidOrderInfoByOrderId(params, function (ret) {
        ...
        if(ret.res.code=='10000' && ret.body){
          if(ret.body.orderList) {
            this.orderArr = this.orderArr.concat(ret.body.orderList);
          }else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._m(0), _vm._m(1), _c('div', [_c('div', {
    staticClass: ["pay_box"]
  }, [_c('text', {
  ...
  return _c('div', [_c('div', {
    ...
    attrs: {
      "src": "data:image/png;base64,"
    }
  })]), _c('div', {
  ...
  }, [_vm._v("虹桥万科中心——15人会议室")]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("面积12m²")]), _c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("座位15人")])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
  ...
  }, [_vm._v("上海市虹桥万科中心")])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("参会时间")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v("20:00-23:00        20:00-23:00")])]), _c('div', {
    staticClass: ["list_detail_box"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("联系人名")]), _c('text', {
