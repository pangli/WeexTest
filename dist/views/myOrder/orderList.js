...
var inputSearch = function inputSearch() {
  //input框内的放大镜
  return 'data:image/png;base64,';
};
...
//check每人可领张数
var checkMbBondNumPerson = function checkMbBondNumPerson(params, callback) {
  var url = serverIp + 'member.api/mbBondApi/checkMbBondNumPerson';
  return (0, _service2.default)(url, 'POST', params, callback);
};
...
exports.default = {
  ...
  addMbBond: addMbBond,
  checkMbBondNumPerson: checkMbBondNumPerson,
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myOrder/orderList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b9a38f60"
...
exports.default = {
  ...
  methods: {
    ...
    goDetail: function goDetail(orderId, actId, status, orderType) {
      var jumpPage = '';
      if (orderType == 0) {
        jumpPage = 'views/activity/activityPay.js';
      } else {
        jumpPage = 'views/myOrder/orderDetail.js';
      }
      var url = _global2.default.getUrl(weex.config.bundleUrl, jumpPage + '?orderId=' + orderId + '&actId=' + actId + '&status=' + status);
      navigator.push({
        url: url,
        animated: 'true'
      });
    ...
    getActOrderListByUserId: function getActOrderListByUserId() {
      ...
      toast.showLoadingMessage("加载列表中...");
      var params = {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.goDetail(item.id, item.actId, item.status, item.orderType)
        }
      }
    }, [_c('div', {
    ...
    }, [_vm._v(_vm._s(item.actAddress))]), _c('div', {
      staticClass: ["center_right_time"]
    }, [_c('text', {
      staticClass: ["time_date"]
    }, [_vm._v(_vm._s(_vm._f("toTime")(item.actBegTime)))]), _c('text', {
      staticClass: ["time_hour"]
    }, [_vm._v(_vm._s(_vm._f("toTime")(item.actEndTime)))])])])]), _c('div', {
    ...
    }, [_vm._v(_vm._s(item.expiryTime) + "分钟")])]), _c('div', {
  ...
  }, [_c('text', [_vm._v(_vm._s(_vm.result))])])], 2)], 1)
  ...
  return _c('div', {
    ...
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
