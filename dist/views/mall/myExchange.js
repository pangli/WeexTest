...
var addMbAddress = function addMbAddress(params, callback) {
  var url = serverIp + 'mbActiveApi/addMbAddress';
  return (0, _service2.default)(url, 'POST', params, callback);
};
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/mall/myExchange.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-01cc08ca"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(item.changeVal))]), (item.actStatus == 1) ? _c('text', {
      staticClass: ["again"],
      on: {
    ...
    }, [_vm._v("再兑一次")]) : _vm._e()])]), _c('div', {
      staticClass: ["openAddressBox"],
      on: {
        "click": function($event) {
          index === _vm.activeIndex ? _vm.activeIndex = '' : _vm.activeIndex = index
        }
      }
    }, [_c('text', {
      staticClass: ["openAddressText"]
    }, [_vm._v("收货信息")]), (index === _vm.activeIndex) ? _c('image', {
    ...
    })]), (index === _vm.activeIndex) ? _c('div', {
      staticClass: ["addressBox"]
    }, [_c('text', {
      staticClass: ["addressText"]
    }, [_vm._v("收件人: " + _vm._s(item.sendeeName))]), _c('text', {
      staticClass: ["addressText"]
    }, [_vm._v("联系方式: " + _vm._s(item.sendeeTel))]), _c('text', {
      staticClass: ["addressText"]
    }, [_vm._v("收货地址: " + _vm._s(item.sendeeAddress))])]) : _vm._e()])])
  }))], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
