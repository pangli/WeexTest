...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/mall/shopList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-69b826e0"
...
exports.default = {
  ...
  created: function created() {
    if (_global2.default.getParams(weex.config.bundleUrl).independent == 'true') {
      this.independent = true;
    }
    this.getMbActiveList();
  },
  ...
  methods: {
    ...
    getMbActiveList: function getMbActiveList() {
      var _this = this;

      _api2.default.getMbActiveList({
        "marketId": weexParams.marketId,
        "memberCode": weexParams.memberCode
      }, function (res) {
        if (res.res.code === 10000) {
          _this.integrationSum = res.body.integrationSum;
          _this.mbActiveList = res.body.mapData;
          console.log(_this.mbActiveList);
        }
      });
    },
    ...
    goTaskCenter: function goTaskCenter() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/member/taskCenter.js');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }) : _vm._e(), (JSON.stringify(_vm.mbActiveList) === '{}') ? _c('scroller', {
  ...
  }, [_c('loading-indicator')]), _c('div', {
    staticClass: ["myIndicatorBox"]
  }, [_c('div', {
    staticClass: ["indicatorBox"]
  }, [_c('text', {
    staticClass: ["indicatorLabel"]
  }, [_vm._v("当前积分 ")]), _c('text', {
    staticClass: ["indicatorNum"]
  }, [_vm._v(_vm._s(_vm.integrationSum))])]), _c('text', {
    staticClass: ["getIndicator"],
    on: {
      "click": _vm.goTaskCenter
    }
  }, [_vm._v("赚积分")])]), _c('loading', {
    staticClass: ["loading"],
    attrs: {
    ...
    staticClass: ["list"]
  }, [_vm._l((_vm.mbActiveList), function(list, key) {
    return _c('div', {
      staticClass: ["typeBox"]
    }, [_c('div', {
      staticClass: ["typeTitleBox"]
    }, [_c('text', {
      staticClass: ["typeTitle"]
    }, [_vm._v(_vm._s(key))])]), _c('div', {
      staticClass: ["activeList"]
      ...
      }), (item.convertibility == 1) ? _c('text', {
        staticClass: ["titleBottomRight"]
      }, [_vm._v("剩余:" + _vm._s(_vm._f("toTime")(item.actEndTime)))]) : _vm._e(), _c('text', {
        staticClass: ["shopTitle"]
      }, [_vm._v(_vm._s(item.actName))]), _c('div', {
        staticClass: ["bottomBox"]
      }, [_c('div', {
        staticClass: ["titleBottomLeft"]
      }, [_c('text', {
        staticClass: ["indicatorNub"]
      }, [_vm._v(_vm._s(item.exchangeValue) + " 积分")])])])])
    }))])
  }), _c('text', {
  ...
  return _c('div', {
    ...
    attrs: {
      "src": "data:image/png;base64,"
    }
  }), _c('text', {
