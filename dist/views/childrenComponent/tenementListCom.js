...
exports.default = {
  ...
  props: {
    type: {
      type: String,
      default: 'noNetwork' //noNetwork, noData, noSearchResult
    }
  },
  created: function created() {
    if (this.type == 'noNetwork') {
      this.text = '轻触屏幕重新加载';
    } else if (this.type == 'noData') {
      this.text = '暂无数据';
    } else {
      this.text = '暂无相关搜索结果';
    }
    ...
    getUserTenantListByUserId: function getUserTenantListByUserId() {
      ...
      _api2.default.getUserTenantListByUserId({
        ...
        if (ret.body) {
          ...
          for (var i = _this2.lists.length; i--;) {
            if (_this2.lists[i].isDeafult) {
              _this2.activeId = _this2.lists[i].id;
              return;
            }
          }
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('loading-indicator')]), _vm._l((_vm.lists), function(list, index) {
    return _c('cell', {
      staticClass: ["cell"],
      appendAsTree: true,
      attrs: {
      ...
      on: {
        "click": function($event) {
          _vm.setActive(list.id)
        }
      }
    }, [(_vm.activeId === list.id) ? _c('image', {
      staticClass: ["butn_img"],
      attrs: {
        "src": _vm.icon.selectIcon
      }
    }) : _vm._e()]) : _vm._e(), _c('image', {
      staticClass: ["leftBox"],
      attrs: {
        "src": list.photoPath || _vm.icon.compangLogo
      }
    }), _c('div', {
      ...
      staticClass: ["status"]
    }, [_vm._v(_vm._s(_vm._f("activeTab")(_vm.activeTab)))])]), _c('view', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [(_vm.type == 'noNetwork') ? _c('div', [(_vm.isAndroid) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "file:///android_asset/dist/views/images/none.png"
    }
  }) : _c('image', {
    staticClass: ["icon"],
    attrs: {
  ...
  })]) : (_vm.type == 'noData') ? _c('div', [(_vm.isAndroid) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "file:///android_asset/dist/views/images/listNone.png"
    }
  }) : _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "../images/listNone.png"
    }
  })]) : _c('div', [(_vm.isAndroid) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "file:///android_asset/dist/views/images/searchNone.png"
    }
  }) : _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "../images/searchNone.png"
    }
  })]), _c('text', {
    staticClass: ["text"]
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/tenementListCom.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c69995c6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
