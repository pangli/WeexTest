...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/investmentCenter/noticeDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1a39f442"
...
module.exports = {
  ...
  "leaveMessageRightTitleBox": {
    "width": "600",
    "flexDirection": "row",
    "justifyContent": "space-between"
  },
  "leaveMessageRightTitle": {
    "fontSize": "28",
    "color": "#888888"
  },
  "leaveMessageRightMain": {
    "fontSize": "28",
    "color": "#999999"
  },
  "author": {
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      notice2: {
        ...
        image: 'http://www.xinhuanet.com/photo/2018-04/18/1122704373_15240653272481n.jpg',
        noticeDetails: '习近平主席将于4月12日考察上海万科各个园区！习近平主席将于4月12日考察上海万科各个园区！'
      },
      result: '',
      pageShow: false,
      pageType: 'noData',
  ...
  created: function created() {
    ...
    // this.result = weex.config;
    this.getNoticeDetailById();
    this.getCommentList();
    console.log(weexParams);
    ...
    Stack.onmessage = function () {
      _this.getCommentList();
    };
  },

  methods: {
    openAct: function openAct() {
      var $actionSheet = this.$refs.actionSheet;
      if ($actionSheet) {
        $actionSheet.showPage(true);
      }
    },
    ...
    getNoticeDetailById: function getNoticeDetailById() {
      var _this2 = this;
      ...
      _api2.default.getNoticeDetailById(params, function (ret) {
        _toast2.default.close();
        // this.notice.noticeDetails = JSON.stringify(ret);
        ...
        if (ret.res.code == '10000' && ret.body) {
          //this.notice = ret.body.notice;
          if (ret.body) {
            _this2.notice = ret.body;
            _this2.html = ret.body.noticeDetails;
            // this.html = "<span style=\"color: rgb(204, 0, 0); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);\">城市乐跑<\/span><span style=\"color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);\">赛是由万科主办,联合城市有影响力的企事业单位参与,以<\/span><span style=\"font-size: 24px;\"><strong><span style=\"font-family: arial; background-color: rgb(255, 255, 255); color: rgb(255, 0, 0);\">快乐、健康、友谊<\/span><\/strong><\/span><span style=\"color: rgb(51, 51, 51); font-family: arial; font-size: 13px; background-color: rgb(255, 255, 255);\">为宗旨的非商业性、非竞技性群众体育活动。< img src=\"group1\/M00\/00\/00\/CgCKXVrzqcKAUCavAAAU5Mscx_U1034063\" title=\"87.png\" alt=\"87.png\"\/><\/span><\/p>";
          } else _toast2.default.showMessage('暂无数据');
        } else {
    ...
    goLeaveMessage: function goLeaveMessage() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/investmentCenter/leaveMessage.js?title=' + encodeURI(this.notice.noticeLabel) + '&id=' + _global2.default.getParams(weex.config.bundleUrl).id);
      navigator.push({
        url: url,
        animated: 'true'
      });
    },
    savePraise: function savePraise(status) {
      var _this3 = this;

      _api2.default.savePraise({
        "userId": weexParams.userId,
        "praiseType": "1",
        "bussinessId": _global2.default.getParams(weex.config.bundleUrl).id,
        "isDrop": status
      }, function (res) {
        if (res.res.code === 10000) {
          if (Number(status)) {
            _this3.notice.isPraise = false;
            _this3.notice.praiseCount = Number(_this3.notice.praiseCount) - 1;
          } else {
            _this3.notice.isPraise = true;
            _this3.notice.praiseCount = Number(_this3.notice.praiseCount) + 1;
          }
        }
      });
    ...
    getCommentList: function getCommentList() {
      ...
      _api2.default.getCommentList({
        ...
        console.log(res);
        if (res.res.code === 10000) {
          _this4.userCommentOutputList = res.body.userCommentOutputList;
        }
      });
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), (_vm.notice.noticeDetails) ? _c('scroller', {
    ...
    staticClass: ["icon"],
    attrs: {
      "src": _vm._f("checkIcon")(_vm.notice.noticeLabel)
    }
  }), _c('text', {
    staticClass: ["type"]
  }, [_vm._v(_vm._s(_vm.notice.noticeLabel))]), _c('text', {
    staticClass: ["time"]
  }, [_vm._v(_vm._s(_vm._f("formatTime")(_vm.notice.createTime)))])]), (_vm.notice.image) ? _c('image', {
    staticClass: ["image"],
    attrs: {
      "src": _vm.notice.image
    },
    on: {
      "click": _vm.openAct
    }
  }) : _vm._e(), (_vm.isWeb) ? _c('text', {
    staticClass: ["text"]
  }, [_vm._v(_vm._s(_vm.notice.noticeDetails))]) : _vm._e(), _c('vk-wx-richtext', {
    ref: "richtext",
    style: {
      width: _vm.width,
      height: _vm.height
    ...
    staticClass: ["readNumBox"]
  }, [_c('text', {
    staticClass: ["read"]
  }, [_vm._v("阅读 " + _vm._s(_vm.notice.browseCount))]), (_vm.userId !== '') ? _c('div', {
    staticClass: ["likeBox"]
  }, [(_vm.notice.isPraise) ? _c('image', {
    staticClass: ["like"],
    attrs: {
      "src": "data:image/png;base64,"
    },
    on: {
    ...
    staticClass: ["read"]
  }, [_vm._v(_vm._s(_vm.notice.praiseCount))])]) : _vm._e()]), (_vm.notice.commentType) ? _c('div', {
    staticClass: ["leaveMessageBox"]
  }, [_c('div', {
    staticClass: ["leaveMessageTitleBox"]
  }, [_c('text', {
    staticClass: ["choice"]
  }, [_vm._v("精选留言")]), (_vm.userId !== '') ? _c('text', {
    staticClass: ["leaving"],
    on: {
      "click": _vm.goLeaveMessage
    }
  }, [_vm._v("写留言")]) : _vm._e()]), _c('div', {
    staticClass: ["leaveMessageList"]
  }, _vm._l((_vm.userCommentOutputList), function(item) {
    return _c('div', {
      staticClass: ["leaveMessageCell"]
    }, [(item.photoPath) ? _c('image', {
      staticClass: ["leftImg"],
      attrs: {
        "src": item.photoPath
      }
      ...
      staticClass: ["leaveMessageRight"]
    }, [_c('div', {
      staticClass: ["leaveMessageRightTitleBox"]
    }, [_c('text', {
      staticClass: ["leaveMessageRightTitle"]
    }, [_vm._v(_vm._s(item.userName))])]), _c('text', {
      staticClass: ["leaveMessageRightMain"]
    }, [_vm._v(_vm._s(item.commentContent))]), (item.returnContent) ? _c('text', {
      staticClass: ["author"]
    }, [_vm._v("作者")]) : _vm._e(), _c('text', {
      staticClass: ["leaveMessageRightMain"]
    }, [_vm._v(_vm._s(item.returnContent))])])])
  }))]) : _vm._e()]) : (_vm.pageShow) ? _c('defaultView', {
    attrs: {
      "type": _vm.pageType
    },
    on: {
