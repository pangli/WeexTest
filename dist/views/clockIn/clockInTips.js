...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/clockIn/clockInTips.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-22c33980"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  name: 'bill',
  components: {
    myHeader: _header2.default, actionSheet: _actionSheet2.default
  },
  filters: {},
  data: function data() {
    return {
  ...
  created: function created() {
    ...
    this.currentAddress = decodeURI(decodeURI(param.currentAddress));
    this.currentAddressName = decodeURI(decodeURI(param.currentAddressName));
    this.longitude = decodeURI(decodeURI(param.longitude));
    this.latitude = decodeURI(decodeURI(param.latitude));
  },
  ...
  methods: {
    ...
    backBack: function backBack() {

      var self = this;
      _toast2.default.close();
      _toast2.default.showLoadingMessage("正在签到…");
      ...
      var params = {
        ...
        "signAddress": self.currentAddressName,
        "content": self.content
      };
      _api2.default.clockIn(params, function (ret) {
        _toast2.default.close();
        if (!ret.res) {
        ...
        if (ret.res.code == '10000') {
          _toast2.default.showMessage(ret.res.msg, 2);
          setTimeout(function () {
            var gMessage = new BroadcastChannel("currentAddress");
            gMessage.postMessage(encodeURI(encodeURI(this.currentAddress)));
            navigator.pop({
              closeLevel: 2
            });
          }, 1500);
    ...
    selectPic: function selectPic(res) {
      if (this.photos === '') {
        this.photos = res.src;
      } else {
        this.photos = this.photos.concat(res.src);
      }
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["top-text1"]
  }, [_c('text', {
    staticClass: ["text1-txt"]
  }, [_vm._v(_vm._s(_vm.currentAddressName))])]), _c('div', {
    staticClass: ["top-text2"]
  }, [_c('text', {
    staticClass: ["text2-txt"]
    ...
    ref: "childMethod",
    attrs: {
      "picLength": _vm.photos.length
    },
    on: {
      "selected": _vm.selectPic
    }
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
