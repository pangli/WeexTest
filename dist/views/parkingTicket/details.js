...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/parkingTicket/details.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-537740b0"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      // 
      showDialog: false,
      couponDate: "", // number  true  券周期
      sumCount: "", //  number  true  券总数
      assignCount: "", // number  true  已指派
      useCount: "", //  number  true  已使用
      //使用详情
      couponDetailList: "",
      zhipaiMounth: ""
    };
  ...
  created: function created() {
    ...
    this.couponDate = param.couponDate; // number  true  券周期
    this.sumCount = param.sumCount; //  number  true  券总数
    this.assignCount = param.assignCount; // number  true  已指派
    this.useCount = param.useCount; //  number  true  已使用
    this.parkId = param.parkId;
    this.moveGuangBiao();
    this.myCompanyCouponDetail(param.parkId);
  },
  ...
  methods: {
    ...
    onrefresh: function onrefresh() {
      var self = this;
      this.myCompanyCouponDetail(self.parkId);
    },
    ...
    myCompanyCouponDetail: function myCompanyCouponDetail(parkId) {
      var _this = this;
      ...
      var params = {
        ...
        "parkId": self.parkId,
        "couponDate": self.couponDate
      };
      _api2.default.myCompanyCouponDetail(params, function (ret) {
        toast.close();
        //下拉复位
        var $refresh = _this.$refs.refresh;
        var $refresh2 = _this.$refs.refresh2;
        if ($refresh) $refresh.update(false);
        if ($refresh2) $refresh2.update(false);
        if (!ret.success) {
          self.couponDetailList = '';
          toast.showErrorMessage(ret.message);
          return;
        }
        if (ret.code == '10000' && ret.success) {
          self.couponDetailList = ret.body.couponDetailList;
          var arr1 = [];
          for (var i = 0; i < ret.body.couponDetailList.length; i++) {
            if (ret.body.couponDetailList[i].status == 3) {
              arr1.push(ret.body.couponDetailList[i]);
            }
          }
          self.couponDetailListT = arr1;
        } else {
          self.couponDetailList = '';
    ...
    assignCoupon: function assignCoupon(parkId) {
      ...
      _api2.default.AssignCoupon(params, function (ret) {
        ...
        if (ret.code == '10000' && ret.success) {
          ...
          self.inputText2 = '请输入车牌号';
          self.isShow = false;
          self.myCompanyCouponDetail(self.parkId);
          var assignCoupon = new BroadcastChannel("assignCoupon");
          assignCoupon.postMessage(encodeURI(encodeURI('1')));
          self.assignCount = parseInt(self.assignCount) + 1;
          // setTimeout(function () {
          //     navigator.pop({
          //       closeLevel: 2
          //     });
  ...
  filters: {
    bindDate: function bindDate(data) {
      return _global2.default.formatTime(data, '-', 'yyyymmdd');
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("总券数：" + _vm._s(_vm.sumCount))])]), _c('div', {
    staticClass: ["item_top11"]
  }, [_c('text', {
    staticClass: ["item_top11_icon"],
    staticStyle: {
    ...
    staticClass: ["item_top11_text"]
  }, [_vm._v("已指派：" + _vm._s(_vm.assignCount))])]), _c('div', {
    staticClass: ["item_top11"]
  }, [_c('text', {
    staticClass: ["item_top11_icon"],
    staticStyle: {
    ...
    staticClass: ["item_top11_text"]
  }, [_vm._v("已使用：" + _vm._s(_vm.useCount))])])]), _c('div', {
    ...
    staticClass: ["line2"],
    style: {
      'width': (560 / _vm.sumCount) * _vm.assignCount + 'px'
    }
  }, [_c('div', {
    staticClass: ["line3"],
    style: {
      'width': (560 / _vm.sumCount) * _vm.useCount + 'px'
    }
  })])])])]), _c('div', {
  ...
  }, [_vm._v("（" + _vm._s(_vm.couponDate) + "）")])]), ((_vm.sumCount - _vm.assignCount) > 0) ? _c('div', {
    staticClass: ["bottom3"],
    on: {
      "click": function($event) {
        _vm.buttonClicked(_vm.couponDate)
      }
    }
  }, [_c('text', {
    ...
    style: {
      left: _vm.activeTab * (710 / _vm.tabs.length + 1) + 'px'
    }
  }, [_c('div', {
  ...
  }, [(_vm.couponDetailList.length == 0) ? _c('div', {
  ...
  }, [_vm._v("暂无数据")])])]) : _vm._e(), (_vm.couponDetailList.length != 0) ? _c('div', {
    staticClass: ["pageOne"]
  }, [_c('div', {
    staticClass: ["pageOne_wrap"]
  }, _vm._l((_vm.couponDetailList), function(item, index) {
    return _c('div', {
      staticClass: ["oneItem"]
    }, [_c('div', {
      staticClass: ["oneItem_top"]
    }, [_c('text', {
      staticClass: ["top_left"]
    }, [_vm._v(_vm._s(item.plateNo))]), _c('text', {
      class: ['top_right', item.status == 3 ? 'top_rightActive' : '']
    }, [_vm._v(_vm._s(_vm._f("status")(item.status)))])]), _c('div', {
      staticClass: ["oneItem_Bottom"]
    }, [_c('text', {
      staticClass: ["bottonm_right"]
    }, [_vm._v("派发日期" + _vm._s(_vm._f("bindDate")(item.bindDate)))]), (item.status == 3) ? _c('text', {
      staticClass: ["bottonm_right2"]
    }, [_vm._v("使用日期" + _vm._s(_vm._f("bindDate")(item.useDate)))]) : _vm._e()])])
  }))]) : _vm._e()])], 1), _c('list', {
    staticClass: ["list"],
    attrs: {
      "showScrollbar": false
  ...
  }, [(_vm.couponDetailListT.length == 0) ? _c('div', {
    staticClass: ["thisDefault"]
  }, [_c('div', {
    staticClass: ["defaultBox"],
    on: {
    ...
    staticClass: ["pageOne_wrap"]
  }, _vm._l((_vm.couponDetailListT), function(item, index) {
    return _c('div', {
      staticClass: ["oneItem"]
    }, [_c('div', {
      staticClass: ["oneItem_top"]
