...
exports.default = {
  ...
  methods: {
    goDetail: function goDetail(orderId, actId, status, orderType, orderNo) {
      var jumpPage = '';
      if (status === 2) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["thisDefault_text"]
  }, [_vm._v("暂无历史记录")])])])])]) : _vm._e(), (_vm.couponList.length != 0) ? _c('list', {
    staticClass: ["scrollerList"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    return _c('div', {
      ...
      staticClass: ["bottom2_text"]
    }, [_vm._v("（" + _vm._s(item.couponDate) + "）")])]), _c('div', {
      staticClass: ["bottom3"],
      on: {
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/parkingTicket/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0b852c90"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _available = __webpack_require__(626);
...
exports.default = {
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      isiOS7: false,
      isiPhoneX: false
    }, _defineProperty(_ref, 'back', (0, _base64ParkingTicket.back)()), _defineProperty(_ref, 'downIcon', (0, _base64ParkingTicket.downIcon)()), _defineProperty(_ref, 'park', (0, _base64ParkingTicket.park)()), _defineProperty(_ref, 'dateListPark', ''), _defineProperty(_ref, 'dateListParkId', ''), _defineProperty(_ref, 'showParkName', ""), _defineProperty(_ref, 'showParkId', ""), _ref;
  },
  created: function created() {
    var _this = this;
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/parkingTicket/history.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6465d8fa"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
