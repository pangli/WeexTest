...
exports.default = {
  ...
  data: function data() {
    return {
      weChatImg: (0, _base.weChatImg)(),
      alipayImg: (0, _base.alipayImg)()
    };
  },
  ...
  methods: {
    changeChoosePay: function changeChoosePay(param) {
      this.$emit('changeChoosePay', param);
    },
    insertRequestOrder: function insertRequestOrder() {
      this.$emit('insertRequestOrder');
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["nub"]
  }, [_vm._v(_vm._s(_vm.payAmount))]), _c('text', {
    staticClass: ["nub2"]
  }, [_vm._v(_vm._s('.00'))])])]), _c('div', {
    staticClass: ["pay_box"]
  }, [_c('div', {
    ...
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _vm._e()])]), _c('div', {
...
/* styles */
__vue_styles__.push(__webpack_require__(630)
)

/* script */
__vue_exports__ = __webpack_require__(631)
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/payForParking/payCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-f5f3e254"
...
var _payCenter = __webpack_require__(632);

var _payCenter2 = _interopRequireDefault(_payCenter);
...
exports.default = {
  ...
  created: function created() {
    ...
    self.payAmount = param.payAmount;
    self.orderNo = param.orderNo;
    self.id = param.id;
  },
  ...
  methods: {
    ...
    insertRequestOrder: function insertRequestOrder() {
      ...
      _api2.default.insertRequestOrder({
        ...
        if (ret.res.code == '10000' && ret.body) {
          self.orderNoPay = ret.body.orderNo;
          self.getActivePayOrder();
        } else {
    ...
    getActivePayOrder: function getActivePayOrder() {
      ...
      _api2.default.getActivePayOrder(params, function (ret) {
        ...
        if (ret.res.code == '10000' && ret.body) {
          toast.close();
          if (_this2.choosePay === '0') {
            pay.wxPay(ret.body, function (result) {
              if (result.status == 1) {
                self.getOrderStatusByOrderNo();
              } else {
                toast.showMessage(result.message);
              }
            });
          } else if (_this2.choosePay === '1') {
    ...
    getOrderStatusByOrderNo: function getOrderStatusByOrderNo() {
      var self = this;
      _api2.default.getOrderStatusByOrderNo({
        'orderNo': self.orderNoPay
      }, function (ret) {
        if (!ret.res) {
          toast.showErrorMessage('服务异常');
          return;
        ...
        if (ret.res.code == '10000' && ret.body) {
          if (ret.body.status == 2) {
            toast.showMessage('支付成功', 2);
            setTimeout(function () {
              var paySuccess = new BroadcastChannel("paySuccess");
              paySuccess.postMessage(encodeURI(encodeURI('1')));
              navigator.pop();
            }, 1500);
          } else {
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/parkingModule/payCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3ea0ad50"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "payAmount": _vm.payAmount,
      "choosePay": _vm.choosePay
    },
    on: {
      "changeChoosePay": _vm.changeChoosePay,
      "insertRequestOrder": _vm.insertRequestOrder
    }
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
