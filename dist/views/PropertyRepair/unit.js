...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/PropertyRepair/unit.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a5df933c"
...
exports.default = {
  ...
  created: function created() {
    ...
    this.storeList = JSON.parse(decodeURI(_global2.default.getParams(weex.config.bundleUrl).storeList));
  ...
  methods: {
    ...
    goSearch: function goSearch() {
      ...
      _BroadcastChannel2.default.unitSend(storeList);
      navigator.pop();
    },
    activeType: function activeType(index) {
      if (this.storeList[index].mallId == true) {
        this.storeList[index].mallId = false;
      } else {
        this.storeList[index].mallId = true;
      }
    }
  }
};
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.activeType(index)
        }
      }
    }, [_c('text', {
      staticClass: ["leftBox"]
    }, [_vm._v(_vm._s(item.storeName))]), _c('div', {
      staticClass: ["rightBox"]
    }, [(item.mallId == true) ? _c('image', {
      staticClass: ["duihao"],
      attrs: {
        "src": _vm.duihao
      }
