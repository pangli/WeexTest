...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/PropertyRepair/type.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-d39bbdd0"
  ...
  methods: {
    ...
    getTpye: function getTpye() {
      ...
      _api2.default.repairTypeList({
        ...
        toast.close();
        if (res.code === 10000) {
          _this2.data = res.body.resultList;
        } else {
    ...
    activeType: function activeType(id, name) {
      this.active = id + ',' + name;
    }
  }
};
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.activeType(item.repair_type_id, item.repair_type_name)
        }
      }
    }, [_c('text', {
      staticClass: ["leftBox"]
    }, [_vm._v(_vm._s(item.repair_type_name))]), _c('div', {
      staticClass: ["rightBox"]
    }, [(item.repair_type_id + ',' + item.repair_type_name === _vm.active) ? _c('image', {
      staticClass: ["duihao"],
      attrs: {
        "src": _vm.duihao
      }
