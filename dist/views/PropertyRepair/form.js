...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/pickTimeBox.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-f27b03ba"
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/components/pickItemBox.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3cfc9b1d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/PropertyRepair/form.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4a846cbc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _pickTimeBox = __webpack_require__(100);

var _pickTimeBox2 = _interopRequireDefault(_pickTimeBox);

var _cellBox = __webpack_require__(79);

var _cellBox2 = _interopRequireDefault(_cellBox);

var _actionSheet = __webpack_require__(29);

var _actionSheet2 = _interopRequireDefault(_actionSheet);

var _pickItemBox = __webpack_require__(106);

var _pickItemBox2 = _interopRequireDefault(_pickItemBox);
...
exports.default = {
  ...
  components: {
    ...
    pickTimeBox: _pickTimeBox2.default,
    cellBox: _cellBox2.default,
    actionSheet: _actionSheet2.default,
    pickItemBox: _pickItemBox2.default
  },
  data: function data() {
    return {
      yjt: (0, _base.yjt)(),
      add: (0, _base.add)(),
      imageDelete: (0, _base.imageDelete)(),
      shop: '',
      showe: '',
      value: '请选择类型',
      lianxiRenValue: '',
      ...
      endTime: '22:00',
      hopeTime: 30,
      msg: '尊敬的客户您好，我们的常规工程维修服务时间为9点～22点。',
      setProps: {
        "year": 0,
        "month": 1,
        "day": 1,
  ...
  created: function created() {
    ...
    if (weexParams.companyId) {
      this.getStoreListByWhere();
    }
    var Stack = new BroadcastChannel('Avengers');
    Stack.onmessage = function (event) {
      _this.value = event.data.split(',')[1];
      _this.active = event.data.split(',')[0];
    };
    _BroadcastChannel2.default.unitGet(function (event) {
      _this.storeList = event.data;
      _this.units = '';
      for (var i = event.data.length; i--;) {
        if (event.data[i].mallId == true) {
          if (_this.units) {
            _this.units = _this.units + ',' + event.data[i].storeName;
          } else {
            _this.units = event.data[i].storeName;
          }
        }
      }
    });
    this.nowDate();
    this.lianxiRenValue = weexParams.userTrueName;
    this.tel = weexParams.phone;
    this.tenant = weexParams.tenant;
    this.getServiceTime();
  ...
  methods: {
    ...
    getDate: function getDate() {
      this.shop = this.$refs.pickDateItem.value;
      var activeDate = myDate.getFullYear() + '/' + this.shop.replace(new RegExp(/-/gm), "/") + ':00',
          startDate = activeDate.split(' ')[0] + " " + this.startTime + ':00',
          endDate = activeDate.split(' ')[0] + " " + this.endTime + ':00';
      if (new Date(startDate).valueOf() <= new Date(activeDate).valueOf() && new Date(activeDate).valueOf() <= new Date(endDate).valueOf()) {
        if (new Date(activeDate).valueOf() - new Date().valueOf() < Number(this.hopeTime) * 60 * 1000) {
          toast.showMessage("请选择至少" + this.hopeTime + "分钟后的报修时间");
          this.shop = '';
          this.$refs.pickDateItem.value = '';
        }
      } else {
        toast.showMessage(this.msg);
        this.shop = '';
        this.$refs.pickDateItem.value = '';
      }
    },
    getShowE: function getShowE() {
      this.showe = this.$refs.showEValue.value;
    },
    getLianXiRen: function getLianXiRen() {
      this.lianxiRenValue = this.$refs.LianXi.value;
    },
    getTel: function getTel() {
      this.tel = this.$refs.telBox.value;
    },
    photo: function photo() {
      this.$refs.childMethod.showPage(true);
    },
    goType: function goType() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/PropertyRepair/type.js');
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    goUnit: function goUnit() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/PropertyRepair/unit.js?storeList=' + encodeURI(JSON.stringify(this.storeList)));
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    addMsg: function addMsg() {
      var activeDate = myDate.getFullYear() + '/' + this.shop.replace(new RegExp(/-/gm), "/") + ':00',
          ...
          faultImages = [],
          updatePicList = this.updatePic;
      for (var i = updatePicList.length; i--;) {
        faultImages.push({
          "fileId": updatePicList[i].fileId
        });
      }
      for (var i = storeList.length; i--;) {
        if (storeList[i].mallId == true) {
          if (unitId) {
            unitId = unitId + ',' + storeList[i].storeNo;
          } else {
            unitId = storeList[i].storeNo;
          }
        }
      }
      _api2.default.insertPropertyRepair({
        "hopeTime": new Date(activeDate).valueOf(),
        "marketId": weexParams.marketId,
        "unitId": unitId,
        "repairAddress": this.showe,
        "repairType": this.active,
        "userName": this.lianxiRenValue,
        "phoneNum": this.tel,
        "repairDetail": this.details,
    ...
    goNext: function goNext() {
      var panduan = true;
      var isnub = /^[1-9]\d*$/.test(this.tel);
      for (var key in this._data) {
        if (this._data[key] === '') {
          if (key !== 'updatePic' && key !== 'photos' && key !== 'units') {
            panduan = false;
          }
        } else if (this._data.details.length < 3) {
          panduan = false;
        } else if (this._data.value === '请选择类型') {
          panduan = false;
        } else if (this.tel.length !== 11 || !isnub) {
          panduan = false;
        }
      }
      this.addTrue = panduan;
    },
      ...
      if (flag) {
        if (this.photos.length === 0) {
          ...
          var params = {
            ...
            'file': this.photos[this.count],
            'IBP': true
          };
          (0, _uploadService2.default)(params, function (ret) {
            if (ret.returnJson.code == 10000) {
              _this2.updatePic.push(ret.returnJson.body);
              if (_this2.updatePic.length >= _this2.photos.length) {
                _this2.addMsg();
              } else {
    ...
    nowDate: function nowDate() {
      ...
      if (PropertyRepairMinutes + Number(this.hopeTime) < 60) {
        PropertyRepairMinutes = PropertyRepairMinutes + Number(this.hopeTime);
      } else {
        PropertyRepairMinutes = PropertyRepairMinutes + Number(this.hopeTime) - 60;
        if (PropertyRepairHours + 1 < 24) {
          PropertyRepairHours = PropertyRepairHours + 1;
        }
      }
      this.setProps.setMonth = _global2.default.formatNumber(PropertyRepairMonth);
      this.setProps.setDay = _global2.default.formatNumber(PropertyRepairDay);
      this.setProps.setHours = _global2.default.formatNumber(PropertyRepairHours);
      this.setProps.setMinute = _global2.default.formatNumber(PropertyRepairMinutes);
      this.setProps.beginMonth = _global2.default.formatNumber(PropertyRepairMonth);
      this.setProps.beginDay = _global2.default.formatNumber(PropertyRepairDay);
      this.setProps.beginHours = _global2.default.formatNumber(PropertyRepairHours);
      this.setProps.beginMinute = _global2.default.formatNumber(PropertyRepairMinutes);
    },
    getStoreListByWhere: function getStoreListByWhere() {
      var _this3 = this;

      _api2.default.getStoreListByWhere({
        "userId": weexParams.userId,
        "marketId": weexParams.marketId,
        "companyId": weexParams.companyId
      }, function (res) {
        if (res.res.code === 10000) {
          res.body.storeList[0].mallId = true;
          _this3.storeList = res.body.storeList;
          _this3.units = res.body.storeList[0].storeName;
        }
      });
    },
    getServiceTime: function getServiceTime() {
      var _this4 = this;

      _api2.default.getServiceTime({
        "mallId": weexParams.marketId
      }, function (res) {
        _this4.startTime = res.body.startTime;
        _this4.endTime = res.body.endTime;
        _this4.msg = res.body.msg;
        _this4.hopeTime = res.body.hopeTime;
      });
    }
  },
  watch: {
    ...
    lianxiRenValue: function lianxiRenValue() {
      this.goNext();
    },
    tel: function tel() {
      this.goNext();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "label": "上门维修时间",
      "placeholder": "请选择维修时间",
      "setProps": _vm.setProps
    },
    on: {
      "changeValue": _vm.getDate
    }
  }), (_vm.storeList.length !== 0) ? _c('div', {
    staticClass: ["pickItemBox"],
    on: {
      "click": _vm.goUnit
    }
    ...
    staticClass: ["active"]
  }, [_vm._v(_vm._s(_vm.units))]), _c('image', {
    staticClass: ["yjt"],
    attrs: {
      "src": _vm.yjt
    }
    ...
    on: {
      "changeValue": _vm.getShowE
    }
  }), _c('div', {
    staticClass: ["lianxiRen"]
  }, [_c('cellBox', {
    ref: "LianXi",
    attrs: {
      "label": "联系人",
      "getValue": _vm.lianxiRenValue,
      "placeholder": "请输入联系人姓名"
    },
    on: {
      "changeValue": _vm.getLianXiRen
    }
  }), _c('cellBox', {
    ref: "telBox",
    attrs: {
    ...
    attrs: {
      "placeholder": "请输入不少于3个字描述",
      "maxlength": "200",
      "value": (_vm.details)
    },
    on: {
      "input": function($event) {
        _vm.details = $event.target.attr.value
      }
    }
  }), _c('text', {
    staticClass: ["tishi"]
  }, [_vm._v(_vm._s(_vm.details.length) + "/200")])]), _c('text', {
    staticClass: ["h2"]
  }, [_vm._v("上传照片")]), _c('div', {
    staticClass: ["picBox"]
  ...
  })]) : _vm._e()], 2)], 1), (_vm.addTrue) ? _c('text', {
...
exports.default = {
  ...
  methods: {
    pickItem: function pickItem() {
      ...
      if (normalPicker) {
        var params = { "options": ["1", "2", "3", "全部"] };
        params.options = this.items;
      ...
      picker.pick({
        ...
        if (ret.result === 'success') {
          _this.value = _this.items[ret.data];
          _this.$emit('changeValue');
        }
      });
    }
