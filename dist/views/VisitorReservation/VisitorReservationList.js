...
exports.default = {
  ...
  methods: {
    goDetails: function goDetails(id, status) {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/VisitorReservation/VisitorReservationDetails.js?id=' + id);
      this.currentUrl = url;
      if (status !== 6) {
        navigator.push({
          url: url,
    ...
    getVisitorListByMarketId: function getVisitorListByMarketId() {
      var _this3 = this;

      _api2.default.getVisitorListByMarketId({
        ...
        if (res.res.code === 10000) {
          var visitorList = res.body.visitorList;
          if (_this3.index === 1) {
            _this3.visitorList = visitorList;
          } else {
            _this3.visitorList = _this3.visitorList.concat(visitorList);
          }
        }
      });
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["list"]
  }, [(_vm.visitorList.length === 0 && _vm.visitorList !== '') ? _c('myDefault', {
    attrs: {
      "type": "noData"
    },
    on: {
  ...
  }, [_c('loading-indicator')]), _vm._l((_vm.visitorList), function(item) {
    return _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      on: {
        "click": function($event) {
          _vm.goDetails(item.id, item.status)
        }
      }
    }, [_c('div', {
      staticClass: ["cell"]
      ...
      staticClass: ["address"]
    }, [_vm._v(_vm._s(item.visitorDate))])]), (item.status === 1) ? _c('text', {
      staticClass: ["rightBox"]
    }, [_vm._v("已发预约")]) : _vm._e(), (item.status === 2) ? _c('text', {
      staticClass: ["rightBox"]
    }, [_vm._v("预约成功")]) : _vm._e(), (item.status === 3) ? _c('text', {
      staticClass: ["rightBox", "three"]
    }, [_vm._v("审批未通过")]) : _vm._e(), (item.status === 4) ? _c('text', {
      staticClass: ["rightBox", "four"]
    }, [_vm._v("已取消")]) : _vm._e(), (item.status === 5) ? _c('text', {
      staticClass: ["rightBox", "four"]
    }, [_vm._v("拜访结束")]) : _vm._e(), (item.status === 6) ? _c('text', {
      staticClass: ["rightBox", "four"]
    }, [_vm._v("已失效")]) : _vm._e()]), (item.examineName) ? _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("拜访人名")]), _c('text', {
      staticClass: ["address"]
    }, [_vm._v(_vm._s(item.examineName))])]) : _vm._e(), (item.marketName) ? _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("项目名称")]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(item.marketName))])]) : _vm._e(), _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("拜访公司")]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(item.visitorCompany))])])])])
  })], 2)], 1)
},staticRenderFns: []}
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/VisitorReservation/VisitorReservationList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2b8c58fe"
...
var _VisitorReservationListComponent = __webpack_require__(244);

var _VisitorReservationListComponent2 = _interopRequireDefault(_VisitorReservationListComponent);
...
exports.default = {
  ...
  components: {
    ...
    VisitorReservationListComponent: _VisitorReservationListComponent2.default
  },
  data: function data() {
    return {
      tabs: [{
  ...
  methods: {
    ...
    addVisitorReservation: function addVisitorReservation() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/VisitorReservation/addVisitorReservation.js');
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/childrenComponent/VisitorReservationListComponent.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-74492b41"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('VisitorReservationListComponent', {
    attrs: {
      "activeTab": "0"
    }
  }), _c('VisitorReservationListComponent', {
    ...
    on: {
      "click": _vm.addVisitorReservation
    }
  }, [_vm._v("新建预约")])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
