...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/VisitorReservation/companyList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-59dc4e09"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    selected: function selected(index) {
      ...
      Steve.postMessage(this.companyList[index]);
      this.goBack();
    },
    ...
    getCompanyList: function getCompanyList() {
      ...
      _api2.default.queryCompanyTenant(params, function (ret) {
        //下拉复位
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("搜索结果")]), (_vm.companyList.length !== 0) ? _c('list', {
    ...
    }, [_vm._v(_vm._s(item.companyName))])]) : _vm._e()
  })], 2) : _vm._e(), (_vm.companyList.length === 0 && _vm.searchData !== '') ? _c('text', {
