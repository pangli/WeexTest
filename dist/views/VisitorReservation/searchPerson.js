...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/VisitorReservation/searchPerson.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4d941bbf"
  ...
  methods: {
    goBack: function goBack(index) {
      ...
      if (index != undefined) {
        ...
        Steve.postMessage(lists[index]);
      }
    },
    keyB: function keyB() {
      this.queryExamineTenant();
    },
    ...
    queryExamineTenant: function queryExamineTenant() {
      var _this3 = this;

      _api2.default.queryExamineTenant({
        "examineUserName": this.searchData,
        "marketId": weexParams.marketId
      }, function (res) {
        _this3.lists = res.body.tenantList;
      });
    }
  },
  components: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("搜索结果")]), (_vm.lists.length !== 0) ? _c('list', {
    ...
    return _c('cell', {
      ...
      staticClass: ["title"]
    }, [_vm._v(_vm._s(item.userName) + "(" + _vm._s(item.phone) + ")")]), _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("公司")]), _c('text', {
      staticClass: ["date"]
    }, [_vm._v(_vm._s(item.company))])]), _c('div', {
      staticClass: ["buttom"]
    }, [_c('text', {
      staticClass: ["label"]
    }, [_vm._v("地址")]), _c('text', {
  ...
  })) : _vm._e(), (_vm.lists.length === 0 && _vm.searchData !== '') ? _c('text', {
    staticClass: ["nonePerson"]
  }, [_vm._v("未搜索到受访人")]) : _vm._e()], 1)
},staticRenderFns: []}
