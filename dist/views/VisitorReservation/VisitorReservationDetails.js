...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/VisitorReservation/VisitorReservationDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4776aa12"
...
module.exports = {
  ...
  "activeIcon": {
    ...
    "boxShadow": "0px 6px 16px 0px #0097cc",
...
exports.default = {
  ...
  methods: {
    ...
    getQRCode: function getQRCode() {
      ...
      this.result = this.activeId;
      wxQRCode.createQRCode(param, function (res) {
        _this3.QRCode = res.path;
      });
    },
    cancelVisitorById: function cancelVisitorById() {
      var _this4 = this;

      _api2.default.cancelVisitorById({
        "visitorId": this.id
      }, function (res) {
        if (res.res.code === 10000) {
          var Steve = new BroadcastChannel('Avengers');
          Steve.postMessage(true);
          _this4.details.status = 4;
        }
      });
    },
    evaluate: function evaluate() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/evaluate/evaluate.js?id=' + this.id + '&marketId=' + this.details.marketId + '&come=5' + '&referenceNo=' + this.details.reserveNo);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
    ...
    viewEvaluation: function viewEvaluation() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/evaluate/viewEvaluation.js?id=' + this.id + '&marketId=' + this.details.marketId + '&come=5' + '&referenceNo=' + this.details.reserveNo);
      this.currentUrl = url;
      navigator.push({
        url: url,
        animated: 'true'
  ...
  filters: {
    errText: function errText(value) {
      switch (value) {
        case 4:
          return '预约已取消';
          break;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.details.status == 1 || _vm.details.status == 2 || _vm.details.status == 5) ? _c('div', {
    staticClass: ["statusBox"]
  }, [_c('div', {
    staticClass: ["statusTop"]
  }, [(_vm.details.status == 1 || _vm.details.status == 2 || _vm.details.status == 5) ? _c('image', {
    staticClass: ["activeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _vm._e(), (_vm.details.status == 2 || _vm.details.status == 5) ? _c('div', {
    staticClass: ["activeBorder"]
  }) : _c('div', {
    staticClass: ["statusBorder"]
  }), (_vm.details.status == 2 || _vm.details.status == 5) ? _c('image', {
    staticClass: ["activeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
    ...
    staticClass: ["Icon"]
  }), (_vm.details.status == 5) ? _c('div', {
    staticClass: ["activeBorder"]
  }) : _c('div', {
    staticClass: ["statusBorder"]
  }), (_vm.details.status == 5) ? _c('image', {
    staticClass: ["activeIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  ...
  }, [(_vm.details.status == 1 || _vm.details.status == 2 || _vm.details.status == 5) ? _c('text', {
    staticClass: ["statusText", "activeText"]
  }, [_vm._v("已发预约")]) : _c('text', {
    staticClass: ["statusText"]
  }, [_vm._v("已发预约")]), (_vm.details.status == 2 || _vm.details.status == 5) ? _c('text', {
    staticClass: ["statusText", "activeText"]
  }, [_vm._v("预约成功")]) : _c('text', {
    staticClass: ["statusText"]
  }, [_vm._v("预约成功")]), (_vm.details.status == 5) ? _c('text', {
    staticClass: ["statusText", "activeText"]
  }, [_vm._v("拜访结束")]) : _c('text', {
    staticClass: ["statusText"]
  }, [_vm._v("拜访结束")])])]) : _c('div', {
    staticClass: ["errBox"]
  }, [(_vm.details.status == 4) ? _c('image', {
    staticClass: ["cancelIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _vm._e(), (_vm.details.status == 3) ? _c('image', {
    staticClass: ["cancelIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  }) : _vm._e(), _c('text', {
    staticClass: ["errText"]
  }, [_vm._v(_vm._s(_vm._f("errText")(_vm.details.status)))])]), (_vm.details.status == 2 || _vm.details.status == 5) ? _c('div', {
    staticClass: ["entranceGuard"]
  }, [_c('text', {
    staticClass: ["entranceGuardTitle"]
  }, [_vm._v("拜访门禁卡")]), _c('image', {
    staticClass: ["erwei"],
    attrs: {
      "src": _vm.QRCode
    }
    ...
    staticClass: ["nub"]
  }, [_vm._v("预约编号：" + _vm._s(_vm.details.reserveNo))])]) : _vm._e(), _c('div', {
    staticClass: ["msgBox"],
    style: {
      'borderTopLeftRadius': _vm.details.status == 3 || _vm.details.status == 4 ? 0 : '16px',
      'borderTopRightRadius': _vm.details.status == 3 || _vm.details.status == 4 ? 0 : '16px'
    }
  }, [_c('text', {
    ...
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.visitorDate))])]), (_vm.details.examineName) ? _c('div', {
    staticClass: ["top"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("拜访人名")]), _c('text', {
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.examineName))])]) : _vm._e(), (_vm.details.tenantOutput) ? _c('div', {
    staticClass: ["top"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("项目名称")]), _c('text', {
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.tenantOutput.marketName))])]) : _vm._e(), _c('div', {
    staticClass: ["top"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("拜访公司")]), _c('text', {
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.visitorCompany))])]), _c('div', {
    staticClass: ["top"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("拜访地址")]), _c('text', {
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.visitorFloor))])])]), _c('text', {
    staticClass: ["msgTitle"]
  }, [_vm._v("访客信息")]), _c('div', {
    staticClass: ["msgMain"]
  }, [_c('div', {
    ...
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.visitorMobile))])]), (_vm.details.visitorId) ? _c('div', {
    staticClass: ["top"]
  }, [_c('text', {
    staticClass: ["label"]
  }, [_vm._v("证件号码")]), _c('text', {
    staticClass: ["address"]
  }, [_vm._v(_vm._s(_vm.details.visitorId))])]) : _vm._e()])])]), (_vm.details.status == 1 || _vm.details.status == 2) ? _c('div', {
    staticClass: ["bottomButton"]
  }, [_c('text', {
    staticClass: ["bottomButtonActive"],
    on: {
      "click": _vm.cancelVisitorById
    }
  }, [_vm._v("取消预约")])]) : _vm._e(), (_vm.details.status == 5 && _vm.details.isEvaluate === 0 && _vm.details.hasTemp) ? _c('div', {
    staticClass: ["bottomButton"]
  }, [_c('text', {
    staticClass: ["bottomButtonActive"],
    on: {
  ...
  }, [_vm._v("评价")])]) : _vm._e(), (_vm.details.status == 5 && _vm.details.isEvaluate === 1 && _vm.details.hasTemp) ? _c('div', {
    staticClass: ["bottomButton"]
  }, [_c('text', {
    staticClass: ["bottomButtonActive"],
    on: {
