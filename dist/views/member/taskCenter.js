...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/member/taskCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e7ad1640"
...
exports.default = {
  ...
  data: function data() {
    return {
      Shape: (0, _base.Shape)(),
      taskGrow: (0, _base.taskGrow)(),
      mbIntegrationTaskList: []
    };
  },
  ...
  methods: {
    ...
    getMbIntegrationTask: function getMbIntegrationTask() {
      var _this2 = this;

      _api2.default.getMbIntegrationTask({
        "cityId": weexParams.cityId,
        "marketId": weexParams.marketId
      }, function (res) {
        if (res.res.code === 10000) {
          _this2.mbIntegrationTaskList = res.body.mbIntegrationTaskList;
        }
      });
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.mbIntegrationTaskList), function(item) {
    return _c('div', {
      staticClass: ["taskListBox"]
    }, [_c('image', {
      staticClass: ["taskGrow"],
      attrs: {
        "src": _vm.taskGrow
      }
    }), _c('div', {
      staticClass: ["taskDetailBox"]
    }, [_c('text', {
      staticClass: ["taskTitle"]
    }, [_vm._v(_vm._s(item.taskName))]), _c('div', {
      staticClass: ["taskNumBox"]
    }, [(item.detailType) ? _c('text', {
      staticClass: ["taskNumBoxText"]
    }, [_vm._v("奖励")]) : _c('text', {
      staticClass: ["taskNumBoxText"]
    }, [_vm._v("每" + _vm._s(item.perAmount) + "元返")]), _c('text', {
      staticClass: ["taskNumBoxNum"]
    }, [_vm._v(_vm._s(item.integration))]), _c('text', {
      staticClass: ["taskNumBoxText"]
    }, [_vm._v("积分")])])]), _c('div', {
      staticClass: ["zhanwei"]
    })])
