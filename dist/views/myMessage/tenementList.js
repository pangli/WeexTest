...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/tenementList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-28d81117"
...
module.exports = {
  ...
  "noneIconbg": {
    "width": "200",
    "height": "200",
    "backgroundColor": "rgba(212,250,246,1)",
    "borderRadius": 100,
    "justifyContent": "center",
    "alignItems": "center",
    "marginTop": "248"
  ...
  "success": {
    "width": "124",
    "height": "44",
    "backgroundColor": "rgba(22,188,132,0.1)",
    "borderRadius": "8",
    "fontSize": "24",
    "fontFamily": "PingFangSC-Regular",
    "fontWeight": "400",
    "color": "rgba(22,188,132,1)",
    "lineHeight": "44",
    "textAlign": "center"
  },
  "error": {
    "width": "124",
    "height": "44",
    "backgroundColor": "rgba(254,235,238,1)",
    "borderRadius": "8",
    "fontSize": "24",
    "fontFamily": "PingFangSC-Regular",
    "fontWeight": "400",
...
exports.default = {
  ...
  created: function created() {
    ...
    _BroadcastChannel2.default.tenementGet(function (event) {
      _this.getUserTenantListByUserId();
    });
    this.getUserTenantListByUserId();
  },
  ...
  methods: {
    ...
    addTenement: function addTenement() {
      var url = _global2.default.getUrl(weex.config.bundleUrl, 'views/myMessage/tenementForm.js');
      navigator.push({
        url: url,
        animated: 'true'
      });
    },
    getUserTenantListByUserId: function getUserTenantListByUserId() {
      var _this2 = this;

      toast.showLoadingMessage("获取列表中...");
      _api2.default.getUserTenantListByUserId({
        userId: weexParams.userId
      }, function (ret) {
        toast.close();
        if (ret.body) {
          _this2.lists = ret.body.userTenantList;
        } else {
          toast.showMessage("获取失败！");
          setTimeout(function () {
            navigator.pop();
          }, 2000);
        }
    ...
    edit: function edit() {
      ...
      for (var i = this.lists.length; i--;) {
        this.lists[i].isDeafult = false;
        if (this.lists[i].id === this.activeId) {
          this.lists[i].isDeafult = true;
          params.companyId = this.lists[i].companyId;
          params.company = this.lists[i].company;
          params.department = this.lists[i].department;
          params.email = this.lists[i].email;
        }
      }
      _api2.default.updateUserTenant({
        userId: weexParams.userId,
        id: this.activeId
      }, function (res) {
        wxBack.setParams(params); //通知native更新资料
        _this3.activeId = '';
      });
    },
    cancelUserTenant: function cancelUserTenant(status, index) {
      var _this4 = this;

      //"isDrop": 0为解除认证、1为删除认证
      _api2.default.cancelUserTenant({
        "userId": weexParams.userId,
        "id": this.activeId,
        "isDrop": status
      }, function (res) {
        if (res.res.code === 10000) {
          if (status) {
            ...
            var lists = _this4.lists,
                params = {};
            lists[index].status = 3;
            if (lists[index].id === _this4.activeId) {
              lists[index].isDeafult = false;
              for (var i = 0; i < lists.length; i++) {
                if (lists[i].status == 1) {
                  lists[i].isDeafult = true;
                  params.companyId = lists[i].companyId;
                  params.company = lists[i].company;
                  params.department = lists[i].department;
                  params.email = lists[i].email;
                  i = lists.length;
                }
              }if (params === {}) {
                params.companyId = "";
                ...
                //当解绑数据为默认数据时，后端会将默认给到最新的认证成功，及列表最顶部的认证成功
                wxBack.setParams(params); //通知native更新资料
              }
            }
            _this4.lists = lists;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["noneTenement"]
  }, [_vm._m(0), _c('text', {
    staticClass: ["noneText"]
  }, [_vm._v("暂无认证企业")]), _c('text', {
    staticClass: ["noneAdd"],
    on: {
      "click": _vm.addTenement
    }
  }, [_vm._v("新增企业")])]) : _c('div', {
    staticClass: ["tenementList"]
  }, [_c('list', {
    staticClass: ["list"]
    ...
    return _c('cell', {
      ...
      staticClass: ["cardBox"],
      style: {
        'left': _vm.activeId === list.id && list.status == 1 ? '-322px' : (((_vm.activeId === list.id && list.status == 2) || (_vm.activeId === list.id && list.status == 3)) ? '-168px' : 0),
        width: _vm.activeId === list.id && list.status == 1 ? '1032px' : (((_vm.activeId === list.id && list.status == 2) || (_vm.activeId === list.id && list.status == 3)) ? '878px' : 0)
      }
    }, [_c('div', {
      staticClass: ["card"]
    }, [_c('div', {
    ...
    }, [(list.isDeafult) ? _c('text', {
      staticClass: ["pretermission"]
    }, [_vm._v("默认")]) : _vm._e(), _c('text', {
      staticClass: ["cardTitle"]
    }, [_vm._v(_vm._s(list.company))])]), _c('div', {
      staticClass: ["userInfo"]
    }, [_c('text', {
      staticClass: ["userName"]
    }, [_vm._v(_vm._s(list.userName))]), _c('text', {
      staticClass: ["tel"]
    }, [_vm._v(_vm._s(list.phone))])]), _c('text', {
      staticClass: ["email"]
    }, [_vm._v(_vm._s(list.email))])]), _c('div', {
      staticClass: ["rightCard"]
    }, [(list.status == 0) ? _c('text', {
      staticClass: ["loading"]
    }, [_vm._v("认证中")]) : _vm._e(), (list.status == 1) ? _c('text', {
      staticClass: ["success"]
    }, [_vm._v("审核通过")]) : _vm._e(), (list.status == 2) ? _c('text', {
      staticClass: ["error"]
    }, [_vm._v("认证失败")]) : _vm._e(), (list.status == 3) ? _c('text', {
      staticClass: ["UntieText"]
    }, [_vm._v("已解绑")]) : _vm._e(), (list.status != 0) ? _c('image', {
      staticClass: ["edit"],
      attrs: {
        "src": "data:image/png;base64,"
      },
      on: {
        "click": function($event) {
          _vm.activeId = list.id
        }
      }
    }) : _vm._e()])]), (list.status == 1) ? _c('text', {
      staticClass: ["setPretermission"],
      on: {
        "click": _vm.edit
      }
    }, [_vm._v("设为默认")]) : _vm._e(), (list.status == 1) ? _c('text', {
      staticClass: ["Untie"],
      on: {
        "click": function($event) {
          _vm.cancelUserTenant(0, index)
        }
      }
    }, [_vm._v("解绑认证")]) : _vm._e(), (list.status == 2 || list.status == 3) ? _c('text', {
      staticClass: ["delete"],
      on: {
        "click": function($event) {
          _vm.cancelUserTenant(1, index)
        }
      }
    }, [_vm._v("删除")]) : _vm._e()])])
  })), _c('div', {
  ...
  return _c('div', {
    staticClass: ["noneIconbg"]
  }, [_c('image', {
    staticClass: ["noneIcon"],
    attrs: {
      "src": "data:image/png;base64,"
    }
  })])
}]}
