...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/tenementStatus.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e9d89baa"
...
exports.default = (_filters$data$compone = {
  filters: {
  ...
  data: function data() {
    return {
      title: '标题',
      iconSuccess: 'rz-success.png',
      iconOngoing: 'rz-ongoing.png',
      status: 1, //0认证中，1已认证
      userInfo: {
        userName: '',
        email: '',
...
}, _defineProperty(_filters$data$compone, 'filters', {
  imageHandle: function imageHandle(val) {
    var img = '';
    if (WXEnvironment.osName == 'iOS') {
      img = '../images/' + val;
    } else if (WXEnvironment.osName == 'android') {
      img = 'file:///android_asset/dist/views/images/' + val;
    } else {
      img = '../../../images/' + val;
    }
    return img;
  }
}), _defineProperty(_filters$data$compone, 'created', function created() {
  var _this = this;

  var param = _global2.default.getParams(weex.config.bundleUrl);
  var weexParams = weex.config.params || {};
  this.userInfo = weexParams;
  this.userInfo.userName = weexParams.userTrueName || weexParams.userName;
  this.userInfo.phone = weexParams.tenantPhone || weexParams.phone;
  this.status = weexParams.tenementStatus || param.tenementStatus || 0;
  // this.userInfo.toString = this.status+'-'+JSON.stringify(weexParams);

  globalEvent.addEventListener("clickEvent", function (e) {
    if (e.backKey && e.backKey == 'keyPress') _this.goBack();
  });
}), _defineProperty(_filters$data$compone, 'methods', {
  goBack: function goBack() {
    navigator.pop();
  }
}), _filters$data$compone);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm._f("imageHandle")(_vm.iconOngoing)
    }
  })]), _c('text', {
    staticClass: ["status_title"]
  }, [_vm._v("正在认证中")]), _c('text', {
    staticClass: ["status_hint"]
  }, [_vm._v("若认证过程较慢，请联系企业管理员!")])])]) : _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    attrs: {
      "src": _vm._f("imageHandle")(_vm.iconSuccess)
    }
  })]), _c('text', {
    staticClass: ["status_title"]
  }, [_vm._v("认证成功")])])]), _c('cell', {
    ...
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm._f("phoneSymbol")(_vm.userInfo.phone)))])]), _c('div', {
    staticClass: ["message_list"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("邮箱")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.userInfo.email))])]), _c('div', {
    staticClass: ["message_list"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("公司")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.userInfo.company))])]), _c('div', {
    staticClass: ["message_list"]
  }, [_c('text', {
    staticClass: ["list_key"]
  }, [_vm._v("部门")]), _c('text', {
    staticClass: ["list_val"]
  }, [_vm._v(_vm._s(_vm.userInfo.department))])])])])])], 1)
},staticRenderFns: []}
