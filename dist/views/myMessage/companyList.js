...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/companyList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7453d2f8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    clickOk: function clickOk() {
      if (this.companyName) {
        var Steve = new BroadcastChannel('getCompanyList');
        Steve.postMessage(this.companyName + ',' + this.id);
      }
      this.goBack();
    },
    selected: function selected(companyName, id, index) {
    ...
    keyB: function keyB(e) {
      this.result = e;
      if (e.value) {
        _toast2.default.showLoadingMessage("搜索中…");
        this.getCompanyList();
      }
    },
    ...
    getCompanyList: function getCompanyList() {
      ...
      _api2.default.getCompanyList(params, function (ret) {
        //下拉复位
        ...
        if (ret.res.code == '10000' && ret.body) {
          ...
          var data = ret.body;
          _this2.result = data;
          _this2.companyList = data.companyList;
          _toast2.default.close();
          storage.setItem('companyList', JSON.stringify(data.companyList));
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return (_vm.companyList.length > 0) ? _c('cell', {
      staticClass: ["cell"],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      on: {
        "click": function($event) {
          _vm.selected(item.companyName, item.id, index)
        }
      }
    }, [_c('text', {
      staticClass: ["cell-text"]
    }, [_vm._v(_vm._s(item.companyName))]), (index == _vm.selectIndex) ? _c('image', {
      staticClass: ["icon"],
      attrs: {
        "src": _vm.icon
      }
