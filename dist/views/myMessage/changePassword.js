...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/changePassword.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-8ef64384"
...
var _md = __webpack_require__(530);
...
exports.default = {
  ...
  created: function created() {
    ...
    this.oldPhone = weex.config.params.phone;
    this.oldPassword = weex.config.params.password;
  },
  mounted: function mounted() {},

  watch: {
    inputPhone: function inputPhone(newVal, oldVal) {
      if (newVal.length >= 11) {
        ...
        if (newVal == '') {
          ...
          if (myreg.test(newVal)) {
            if (newVal == this.oldPhone) {
              this.isPhoneOk = true;
              this.showPhoneWarn = false;
            } else {
              this.isPhoneOk = false;
              this.phoneWarnMess = '该手机号与当前绑定的手机号不同';
              this.showPhoneWarn = true;
            }
          } else {
            this.isPhoneOk = false;
            this.phoneWarnMess = '手机号格式不正确请重新输入';
            this.showPhoneWarn = true;
          }
        }
      } else {
    ...
    regCode: function regCode(newVal, oldVal) {
      if (newVal.length >= 4) {
        var myreg = /^\d{4,6}$/;
        if (newVal == '') {
          this.isMsgCodeTrue = false;
          this.regCodeWarn = false;
        } else {
          if (myreg.test(newVal)) {
            this.isMsgCodeTrue = true;
            this.regCodeWarn = false;
          } else {
            this.isMsgCodeTrue = false;
            this.regCodeWarn = true;
          }
        }
      } else {
        this.isMsgCodeTrue = false;
    ...
    newInputPassword: function newInputPassword(newVal, oldVal) {
      if (newVal.length >= 6) {
        var myreg = /^[A-Za-z0-9]{6,20}$/;
        if (newVal == '') {
          this.isNewPasswordOk = false;
          this.showNewPasswordWarn = false;
        } else {
          if (myreg.test(newVal)) {
            ...
            this.isNewPasswordOk = false;
            this.newPasswordWarnMess = '密码格式不正确请重新输入';
            this.showNewPasswordWarn = true;
          }
        }
      } else {
        this.isNewPasswordOk = false;
  ...
  methods: {
    ...
    init: function init() {
      ...
      if (param.page == 0) {
        this.forgetOrChange = false;
        this.title = '忘记密码';
      } else if (param.page == 1) {
        this.forgetOrChange = true;
        this.title = '更改密码';
      }
    },
    clearOldPhone: function clearOldPhone() {
      this.inputPhone = '';
    },
    checkPhone: function checkPhone(event) {
      ...
      if (event.value == '') {
        ...
        if (myreg.test(event.value)) {
          if (event.value == this.oldPhone) {
            this.isPhoneOk = true;
            this.showPhoneWarn = false;
          } else {
            this.isPhoneOk = false;
    ...
    /*checkPassword: function (event){
      ...
      if (event.value == '') {
        ...
        if (myreg.test(event.value)) {
          if (event.value == this.oldPassword) {
            this.isPasswordOk = true;
            this.showPasswordWarn = false;
          }else {
            this.isPasswordOk = false;
            this.passwordWarnMess = '该密码与原来密码不同';
            this.showPasswordWarn = true;
          }
        }else {
          this.isPasswordOk = false;
          this.passwordWarnMess = '密码格式不正确请重新输入';
          this.showPasswordWarn = true;
        }
      }
    },*/
    sendMsgCode: function sendMsgCode() {
      ...
      var param = _global2.default.getParams(weex.config.bundleUrl);
      var params = {
        'account': this.oldPhone,
        'type': 2
      };

      if (this.isCodeText) {
        _api2.default.sendMsgCode(params, function (ret) {
          if (!ret.res) {
          ...
          if (ret.res.code == '10000') {
            ...
            _this3.isCodeText = false;
            var second = 59;
            var timer = setInterval(function () {
              if (second > 0) {
                second--;
                _this.codeText = '重新发送(' + second + 's)';
              } else {
                _this.isCodeText = true;
    ...
    regCodeChange: function regCodeChange(event) {
      var myreg = /^\d{4,6}$/;
      if (event.value == '') {
        this.isMsgCodeTrue = false;
        this.regCodeWarn = false;
    ...
    checkNewPassword: function checkNewPassword(event) {
      var myreg = /^[A-Za-z0-9]{6,20}$/;
      if (event.value == '') {
        this.isNewPasswordOk = false;
        this.showNewPasswordWarn = false;
    ...
    updateUserPassword: function updateUserPassword() {
      ...
      var params = {
        'account': this.oldPhone,
        'password': _global2.default.encode64(this.newInputPassword),
        'regCode': this.regCode,
        "pwdType": "1"
      };
      // modal.alert({
      //   message:"params11"+JSON.stringify('vanke-huge'+this.newInputPassword)
      // })
      // modal.alert({
      //   message:"params"+JSON.stringify(params)
      // })
      _api2.default.updateUserPassword(params, function (ret) {
        _this4.result = ret;
        ...
        if (ret.res.code == '10000') {
          ...
          toast.showMessage(ret.res.msg);
          wxBack.setParams({
            password: _this4.newInputPassword
          });
          navigator.pop();
        } else {
          // modal.toast({message: ret.res.msg,duration: 1});
...
exports.default = { md5Encode: hex_md5 };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("请输入手机号码")]), _c('div', {
    staticClass: ["phone_num_box"]
  }, [_c('input', {
    class: ['phone_num', _vm.showPhoneWarn ? 'red_warn' : ''],
    attrs: {
      "type": "number",
      "maxlength": "11",
      "placeholder": "请输入",
    ...
    on: {
      "change": _vm.checkPhone,
      "input": [function($event) {
        _vm.inputPhone = $event.target.attr.value
      }, _vm.onInput]
    }
  }), (_vm.showClear) ? _c('text', {
    staticClass: ["phone_butn"],
    on: {
      "click": _vm.clearOldPhone
    }
  }, [_vm._v("×")]) : _vm._e(), (_vm.showPhoneWarn) ? _c('text', {
    staticClass: ["warn_message"]
  }, [_vm._v(_vm._s(_vm.phoneWarnMess))]) : _vm._e()])])]), _c('div', [_c('div', {
    staticClass: ["code_box"]
  }, [_c('input', {
    class: ['code_num', _vm.regCodeWarn ? 'red_warn' : ''],
    attrs: {
      "type": "number",
      "placeholder": "请输入验证码",
      "maxlength": "6",
    ...
    on: {
      "change": _vm.regCodeChange,
      "input": function($event) {
        _vm.regCode = $event.target.attr.value
      }
    }
  }), (_vm.regCodeWarn) ? _c('text', {
    staticClass: ["code_warn_message"]
  }, [_vm._v("验证码格式输入错误")]) : _vm._e(), (_vm.isPhoneOk) ? _c('text', {
    staticClass: ["code_butn"],
    on: {
      "click": _vm.sendMsgCode
    }
  }, [_vm._v(_vm._s(_vm.codeText))]) : _vm._e(), (!_vm.isPhoneOk) ? _c('text', {
    staticClass: ["code_butn", "code_butn_gray"]
  }, [_vm._v("获取验证码")]) : _vm._e()])]), _c('div', [_c('div', {
    staticClass: ["password_box"]
  }, [_c('input', {
    class: ['password_num', _vm.showNewPasswordWarn ? 'red_warn' : ''],
    attrs: {
      "type": "password",
      "placeholder": "请输入新密码",
      "value": (_vm.newInputPassword)
    },
    on: {
      "change": _vm.checkNewPassword,
      "input": function($event) {
        _vm.newInputPassword = $event.target.attr.value
      }
    }
  }), (_vm.showNewPasswordWarn) ? _c('text', {
    staticClass: ["warn_message"]
  }, [_vm._v(_vm._s(_vm.newPasswordWarnMess))]) : _vm._e()])])]), _c('div', {
    staticClass: ["bottom_box"]
  }, [(_vm.isPhoneOk && _vm.isMsgCodeTrue && _vm.isNewPasswordOk) ? _c('text', {
    staticClass: ["bottom_butn"],
    on: {
      "click": _vm.updateUserPassword
    }
  }, [_vm._v("提交")]) : _vm._e(), (!_vm.isPhoneOk || !_vm.isMsgCodeTrue || !_vm.isNewPasswordOk) ? _c('text', {
