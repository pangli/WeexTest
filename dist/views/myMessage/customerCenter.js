...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/customerCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-32fbc1a6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    if (WXEnvironment.platform == "Web") {
      this.telList = this.telList0;
    }
    // this.params = JSON.parse(weex.config.params || '{}');
  ...
  methods: {
    ...
    callPhone: function callPhone() {
      var num = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '021-88888888';

      // this.showModal = true;
      // this.phoneNum = num;
      general.call(num);
    },
    getServiceTelList: function getServiceTelList() {
      var _this2 = this;
      ...
      _api2.default.getServiceTelList(params, function (ret) {
        //下拉复位
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), (_vm.telList.length > 0) ? _c('list', [_c('downLoading', {
    ref: "refresh",
    on: {
      "onrefresh": _vm.onrefresh
    }
  }), _vm._l((_vm.telList), function(item) {
    return _c('cell', {
      key: "item.id",
      appendAsTree: true,
      attrs: {
    ...
    }, [_vm._v(_vm._s(item.serviceType))]), _c('text', {
      staticClass: ["list_val"]
    }, [_vm._v(_vm._s(item.serviceTel))]), _c('image', {
      ...
      attrs: {
        "src": "data:image/png;base64,"
      },
      on: {
        "click": function($event) {
          _vm.callPhone(item.serviceTel)
        }
      }
    })])])
