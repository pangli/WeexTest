...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/myMessage/changePhone.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7b90534a"
...
exports.default = {
  data: function data() {
    return {
      ...
      isOldPhoneTrue: false,
      isNewPhoneTrue: false,
      isMsgCodeTrue: false,
  ...
  created: function created() {
    ...
    this.getOldPhone = weex.config.params.phone;
  },
  ...
  watch: {
    oldPhone: function oldPhone(newVal, oldVal) {
      if (newVal.length >= 11) {
        if (newVal != this.getOldPhone) {
          this.isOldPhoneTrue = false;
          this.differentOld = true;
        } else {
          this.isOldPhoneTrue = true;
          this.differentOld = false;
        }
      } else {
        this.isOldPhoneTrue = true;
        this.differentOld = false;
    ...
    newPhone: function newPhone(newVal, oldVal) {
      if (newVal.length >= 11) {
        var myreg = /^[1][3,4,5,7,8][0-9]{9}$/;
        if (newVal == "") {
          this.isNewPhoneTrue = false;
          this.differentNew = false;
        } else {
          if (myreg.test(newVal)) {
            if (newVal == this.getOldPhone) {
              this.isNewPhoneTrue = false;
              this.newPhoneMessage = '该手机号与当前绑定的手机号相同';
              this.differentNew = true;
            } else {
              this.isNewPhoneTrue = true;
              this.differentNew = false;
            }
          } else {
            this.isNewPhoneTrue = false;
            this.newPhoneMessage = '手机号格式不正确请重新输入';
            this.differentNew = true;
          }
        }
      } else {
  ...
  methods: {
    ...
    newPhoneChange: function newPhoneChange(event) {
      var myreg = /^[1][3,4,5,7,8][0-9]{9}$/;
      if (event.value == "") {
        this.isNewPhoneTrue = false;
        this.differentNew = false;
        ...
        if (myreg.test(event.value)) {
          if (event.value == this.getOldPhone) {
            this.isNewPhoneTrue = false;
            this.newPhoneMessage = '该手机号与当前绑定的手机号相同';
            this.differentNew = true;
          } else {
    ...
    oldPhoneChange: function oldPhoneChange(event) {
      if (event.value != this.getOldPhone) {
        this.isOldPhoneTrue = false;
        this.differentOld = true;
      } else {
    ...
    updateUserAccountById: function updateUserAccountById() {
      var _this4 = this;
      ...
      _api2.default.updateUserAccountById(params, function (ret) {
        _this4.result = ret;
        ...
        if (ret.res.code == '10000') {
          ...
          toast.showMessage(ret.res.msg);
          wxBack.setParams({
            phone: _this4.newPhone
          });
          var broadcast = new BroadcastChannel('userInforUpdate');
          broadcast.postMessage(_this4.newPhone);
          navigator.pop();
        } else {
          // modal.toast({message: ret.res.msg,duration: 1});
          toast.showMessage(ret.res.msg);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["warnBox"]
  }, [(_vm.differentNew) ? _c('text', {
    staticClass: ["warn_box_message"]
  }, [_vm._v(_vm._s(_vm.newPhoneMessage))]) : _vm._e()]), _c('div', {
    staticClass: ["phone_box"]
  }, [_c('text', {
    staticClass: ["phone_title"]
  }, [_vm._v("当前手机号")]), _c('text', {
    staticClass: ["phone_num"]
  }, [_vm._v(_vm._s(_vm._f("phoneSymbol")(_vm.getOldPhone)))]), _c('text', {
    staticClass: ["phone_hint"]
  }, [_vm._v("更换手机后，下次登录可使用新手机号登录")])])]), _c('div', [_c('div', {
    staticClass: ["old_phone_box"]
  }, [_c('input', {
    class: ['old_phone_num', _vm.differentOld ? 'red_warn' : ''],
    attrs: {
      "type": "number",
      "placeholder": "请输入原手机号",
      "maxlength": "11",
    ...
    on: {
      "change": _vm.oldPhoneChange,
      "input": function($event) {
        _vm.oldPhone = $event.target.attr.value
      }
    }
  }), (_vm.differentOld) ? _c('text', {
    staticClass: ["warn_message"]
  }, [_vm._v("该手机号与当前绑定的手机号不同")]) : _vm._e()])]), _c('div', [_c('div', {
    staticClass: ["new_phone_box"]
  }, [_c('input', {
    class: ['new_phone_num', _vm.differentNew ? 'red_warn' : ''],
    attrs: {
      "type": "number",
      "placeholder": "请输入新手机号",
      "maxlength": "11",
    ...
    on: {
      "change": _vm.newPhoneChange,
      "input": function($event) {
        _vm.newPhone = $event.target.attr.value
      }
    }
  })])]), _c('div', [_c('div', {
  ...
  }, [_vm._v("验证码格式输入错误")]) : _vm._e(), (_vm.isOldPhoneTrue && _vm.isNewPhoneTrue) ? _c('text', {
    staticClass: ["code_butn"],
    on: {
      "click": _vm.sendMsgCode
    }
  }, [_vm._v(_vm._s(_vm.codeText))]) : _vm._e(), (!_vm.isOldPhoneTrue || !_vm.isNewPhoneTrue) ? _c('text', {
    staticClass: ["code_butn", "code_butn_gray"]
  }, [_vm._v("获取验证码")]) : _vm._e()])])]), _c('div', {
    staticClass: ["bottom_box"]
  }, [(_vm.isOldPhoneTrue && _vm.isNewPhoneTrue && _vm.isMsgCodeTrue) ? _c('text', {
    staticClass: ["bottom_butn"],
    on: {
      "click": _vm.updateUserAccountById
    }
  }, [_vm._v("提交")]) : _c('text', {
