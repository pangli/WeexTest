...
__vue_options__.__file = "/Users/denya/Desktop/workspace/weex/h5/src/views/Feedback/type.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-40709d75"
...
exports.default = {
  ...
  methods: {
    ...
    getTpye: function getTpye() {
      ...
      _api2.default.getDictionaryByType({
        "marketId": weexParams.marketId,
        "type": "com_type"
      }, function (ret) {
        toast.close();
        if (ret.body) {
          _this2.data = ret.body.dictionaryList;
        } else {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.activeType(item.id, item.dictName)
        }
      }
    }, [_c('text', {
      staticClass: ["leftBox"]
    }, [_vm._v(_vm._s(item.dictName))]), _c('div', {
      staticClass: ["rightBox"]
    }, [(item.id + ',' + item.dictName === _vm.active) ? _c('image', {
      staticClass: ["duihao"],
      attrs: {
        "src": _vm.duihao
      }
